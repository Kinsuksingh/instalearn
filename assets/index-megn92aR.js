...
`,p4=b.div`
  display: grid;
  gap: 8px;
`,h4=b.button.withConfig({shouldForwardProp:a=>a!=="$state"})`
  text-align: left;
  font-size: 13px;
...
`,kg=b.button`
  ...
  cursor: pointer;
  font-size: 12px;
`;async function g4(a){const s=await(await fetch(a,{mode:"cors"})).blob(),o=s.type||"image/jpeg",f=await s.arrayBuffer(),d=new Uint8Array(f);let h="";for(let g=0;g<d.byteLength;g++)h+=String.fromCharCode(d[g]);return{base64:btoa(h),mime:o}}function x4({title:a,description:l,username:s}){return`
...
- Caption: "${l}"
- Author: "${s}"
`.trim()}async function y4(a){const{title:l,description:s,username:o,imageUrl:f}=a,d="AIzaSyDYGHcNYuuk43rrYSBVBIQGegzOGVtjGrw",{base64:h,mime:y}=await g4(f),m={contents:[{parts:[{text:x4({title:l,description:s,username:o})},{inline_data:{mime_type:y,data:h}}]}],generationConfig:{temperature:.6,topK:32,topP:.9,maxOutputTokens:1200,response_mime_type:"application/json"}},S="https://generativelanguage.googleapis.com/v1beta",w=["gemini-2.5-flash","gemini-2.0-flash"];let T;for(const z of w)try{const A=`${S}/models/${z}:generateContent?key=${encodeURIComponent(d)}`,k=await fetch(A,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(m)});if(!k.ok)throw new Error(`Gemini error (${k.status}): ${await k.text()}`);const B=(await k.json())?.candidates?.[0]?.content?.parts?.[0]?.text;if(!B)throw new Error("Empty response from Gemini");let q;try{q=JSON.parse(B)}catch{const L=String(B).replace(/^```json\s*/i,"").replace(/^```\s*/i,"").replace(/```$/i,"").trim();q=JSON.parse(L)}const Y=Array.isArray(q.bullets)?q.bullets.slice(0,5):[],Z=Array.isArray(q.mcqs)?q.mcqs.slice(0,5):[];if(!Y.length||!Z.length)throw new Error("Malformed AI content");const J=Z.map(L=>({question:String(L.question||"").slice(0,140),options:Array.isArray(L.options)&&L.options.length?L.options.slice(0,5):["Not present"],correctIndex:Number.isInteger(L.correctIndex)?L.correctIndex:0,explanation:L.explanation?String(L.explanation).slice(0,140):void 0}));return{bullets:Y,mcqs:J}}catch(A){T=A}throw T||new Error("Gemini request failed")}function v4({avatarSrc:a=Il.teacherProfilePic,title:l,description:s,imgSrc:o,username:f,postUrl:d,onLikeChange:h,onBookmarkChange:y,onShare:g}){const[m,S]=v.useState(!1),[w,T]=v.useState(!1),[z,A]=v.useState(!1),[k,$]=v.useState(!1),[B,q]=v.useState(null),[Y,Z]=v.useState(null),[J,L]=v.useState(0);v.useEffect(()=>{const te=Y?.mcqs?.length||0;te!==0&&L(me=>Math.max(0,Math.min(me,te-1)))},[Y?.mcqs?.length]);const V=m?"Unlike":"Like",Q=w?"Remove bookmark":"Bookmark",W=()=>{const te=!m;S(te),h&&h(te)},ce=()=>{const te=!w;T(te),y&&y(te)},de=v.useMemo(()=>({title:l,text:`${f} on Infographics — ${l}`,url:d}),[l,f,d]),Ye=async()=>{try{navigator.share?await navigator.share(de):navigator.clipboard&&de.url&&(await navigator.clipboard.writeText(de.url),alert("Link copied to clipboard")),g&&g(de)}catch(te){console.error("Share failed:",te)}},ee=async()=>{$(!0),q(null);try{const te=await y4({title:l,description:s,username:f,imageUrl:o});Z(te),L(0)}catch(te){console.error(te),q(te?.message||"Failed to generate content")}finally{$(!1)}},ae=()=>{const te=!z;A(te),te&&!Y&&!k&&ee()},xe=Y?.mcqs?.length||0,_=xe?Y.mcqs[J]:null,K=J===xe-1,P=()=>L(te=>Math.min(te+1,xe-1));return u.jsxs(W5,{role:"article","aria-label":`${l} instagram-style post`,children:[u.jsxs(I5,{children:[u.jsxs(P5,{children:[u.jsx(e4,{src:a,alt:"avatar"}),u.jsxs(t4,{children:[u.jsx(n4,{children:l}),u.jsx(a4,{children:s})]})]}),u.jsx(i4,{"aria-label":z?"Close learn mode":"Open learn mode",title:z?"Close learn mode":"Learn more & quiz",onClick:ae,children:u.jsx(F5,{size:18})})]}),z?u.jsxs(c4,{"aria-live":"polite",children:[u.jsxs(D1,{children:[u.jsx($1,{children:"Know more (5 quick points)"}),k?u.jsxs("div",{style:{display:"grid",gap:8},children:[u.jsx(on,{}),u.jsx(on,{}),u.jsx(on,{}),u.jsx(on,{}),u.jsx(on,{})]}):B?u.jsxs(B1,{children:[u.jsx("span",{style:{flex:1,minWidth:0},children:B}),u.jsx(L1,{onClick:ee,"aria-label":"Retry generating content",children:"Retry"})]}):u.jsx(u4,{children:Y?.bullets?.map((te,me)=>u.jsx("li",{children:te},me))})]}),u.jsxs(D1,{children:[u.jsxs(Og,{children:[u.jsx($1,{style:{margin:0},children:"Test your knowledge"}),xe?u.jsxs(qo,{children:[J+1," / ",xe]}):null]}),k?u.jsxs("div",{style:{display:"grid",gap:10},children:[u.jsx(on,{h:16}),u.jsx(on,{h:40}),u.jsx(on,{h:40}),u.jsx(on,{h:40}),u.jsx(on,{h:40})]}):B?u.jsxs(B1,{children:[u.jsx("span",{style:{flex:1,minWidth:0},children:"Can’t load questions."}),u.jsx(L1,{onClick:ee,children:"Retry"})]}):_?u.jsx(b4,{mcq:_,index:J+1,total:xe,isLast:K,onNext:K?void 0:P,onFinish:K?()=>A(!1):void 0},J):null,!k&&!B&&_&&!K?u.jsx("div",{style:{marginTop:6},children:u.jsx(qo,{children:"Tip: You can change your choice before tapping Next."})}):null]}),u.jsxs(m4,{children:[u.jsx(qo,{children:"AI stays within the infographic; short, clear answers only."}),u.jsx(kg,{onClick:()=>A(!1),"aria-label":"Back to image",title:"Back to image",children:"Back to image"})]})]}):u.jsx(l4,{children:u.jsx(r4,{src:o,alt:l})}),u.jsxs(o4,{children:[u.jsxs(s4,{children:[u.jsx(wo,{onClick:W,"aria-label":V,title:V,children:m?u.jsx(Gf,{size:22}):u.jsx(Xf,{size:22})}),u.jsx(wo,{"aria-label":"Comment",title:"Comment",children:u.jsx(Zf,{size:20})}),u.jsx(wo,{onClick:Ye,"aria-label":"Share",title:"Share",children:u.jsx(Kf,{size:20})})]}),u.jsx(wo,{onClick:ce,"aria-label":Q,title:Q,children:w?u.jsx(Vf,{size:20}):u.jsx(Qf,{size:20})})]})]})}function b4({mcq:a,index:l,total:s,isLast:o,onNext:f,onFinish:d}){const[h,y]=v.useState(null),g=m=>h===null?"idle":m===a.correctIndex?"correct":m===h&&h!==a.correctIndex?"wrong":"idle";return u.jsxs(f4,{"aria-label":`Question ${l}`,children:[u.jsxs(d4,{children:[l,". ",a.question]}),u.jsx(p4,{children:a.options.map((m,S)=>u.jsx(h4,{onClick:()=>y(S),$state:g(S),"aria-pressed":h===S,"aria-label":`Option ${S+1}`,children:m},S))}),h!==null&&u.jsxs("div",{style:{display:"grid",gap:8},children:[u.jsxs(qo,{children:[h===a.correctIndex?"✅ Correct.":"❌ Not quite.",a.explanation?` — ${a.explanation}`:""]}),o?u.jsxs(Og,{children:[u.jsx(U1,{onClick:d,"aria-label":"Finish quiz",children:"Finish"}),u.jsx(kg,{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"Back to top"})]}):u.jsxs(U1,{onClick:f,"aria-label":"Next question",disabled:h===null,children:["Next question (",l+1,"/",s,")"]})]})]})}const S4=b.div``,w4=b.div`
  display: flex;
  overflow-x: auto;
  padding: 24px 0;
...
`,Ng=`
  ...
  margin-left: 20px;
`,E4=b.img`${Ng}`,C4=b.video`${Ng}`,T4=b.div`
  position: fixed;
  inset: 0;
...
`,M4=b.img`${_g}`,O4=b.video`${_g}`,k4=b.button`
  position: absolute;
  top: 24px;
  right: 24px;
...
`,B4=b.video`
  ...
  border-radius: 8px;
  display: block;
`,H1=(a,l,s)=>Math.max(l,Math.min(s,a));function L4(a){const l=(a.type||"img").toLowerCase(),s=a.src||a.imgSrc||a.videoClipSrc,o=a.poster||a.thumb||a.thumbnail,f=a.name||a.title||"";return{type:l,src:s,poster:o,name:f,id:a.id}}class U4 extends ke.Component{state={hasError:!1};static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(l,s){console.error("Carousel error:",l,s)}render(){return this.state.hasError?u.jsx("div",{style:{color:"#fff",padding:16,textAlign:"center"},children:"Something went wrong while rendering the carousel."}):this.props.children}}function H4({items:a=[],className:l}){const s=v.useRef(null),o=v.useRef(!1),f=v.useRef(0),d=v.useRef(0),h=v.useRef(0),[y,g]=v.useState(!1),[m,S]=v.useState(0),[w,T]=v.useState(!0),z=v.useRef(null),A=v.useMemo(()=>(a||[]).map(L4).filter(ee=>!!ee.src),[a]),k=v.useRef([]);k.current.length!==A.length&&(k.current=A.map((ee,ae)=>k.current[ae]??ke.createRef()));const $=typeof window<"u"&&typeof document<"u";v.useEffect(()=>{if(!$)return;const ee=document.body.style.overflow;return y&&(document.body.style.overflow="hidden"),()=>{document.body.style.overflow=ee||""}},[y,$]),v.useEffect(()=>{y&&(k.current[m]?.current?.scrollIntoView({block:"nearest",inline:"center",behavior:"auto"}),T(!0))},[y,m]),v.useEffect(()=>{if(!y||!$)return;const ee=ae=>{ae.key==="Escape"&&g(!1),ae.key==="ArrowRight"&&Y(m+1),ae.key==="ArrowLeft"&&Y(m-1),ae.key.toLowerCase()==="h"&&T(xe=>!xe)};return window.addEventListener("keydown",ee),()=>window.removeEventListener("keydown",ee)},[y,m,$]);const B=v.useMemo(()=>{if(typeof window>"u"||!z.current)return 0;const ee=window.getComputedStyle(z.current),ae=parseFloat(ee.gap)||0;return(z.current.clientWidth||0)+ae},[y]),q=()=>{if(!z.current||B===0)return;const{scrollLeft:ee}=z.current,ae=Math.round(ee/B),xe=H1(ae,0,A.length-1);xe!==m&&S(xe)},Y=ee=>{const ae=H1(ee,0,Math.max(0,A.length-1));if(S(ae),!z.current)return;const xe=B*ae;z.current.scrollTo({left:xe,behavior:"smooth"})},Z=ee=>{const ae=Number(ee.target.value);Y(ae)},L={"--filled":`${A.length>1?m/(A.length-1)*100:0}%`},V=ee=>{if(ee.pointerType==="mouse"&&s.current){o.current=!0,h.current=0,f.current=ee.clientX,d.current=s.current.scrollLeft||0;try{s.current.setPointerCapture?.(ee.pointerId)}catch{console.log("error")}}},Q=ee=>{if(ee.pointerType!=="mouse"||!o.current||!s.current)return;const ae=ee.clientX-f.current;h.current=Math.max(h.current,Math.abs(ae)),s.current.scrollLeft=d.current-ae},W=()=>{o.current=!1},ce=6,de=ee=>{h.current>ce||(S(ee),T(!0),g(!0))},Ye=ee=>{const ae=ee.target,xe=ae.tagName&&ae.tagName.toLowerCase(),_=xe==="img"||xe==="video",K=ae.closest?.('[data-interactive="true"]');_||K||T(P=>!P)};return v.useEffect(()=>{if(!y)return;(z.current?.querySelectorAll("video[data-slide-video='true']")||[]).forEach((ae,xe)=>{xe===m?(ae.muted=!0,ae.play().catch(()=>{})):(ae.pause(),ae.currentTime=0)})},[y,m]),!A||A.length===0?null:u.jsxs(S4,{className:l,children:[u.jsx(w4,{ref:s,onPointerDown:V,onPointerMove:Q,onPointerUp:W,onPointerLeave:W,children:A.map((ee,ae)=>u.jsx(j4,{onClick:()=>de(ae),children:ee.type==="video"?u.jsx(C4,{src:ee.src,poster:ee.poster,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-label":ee.name||`Video ${ae+1}`}):u.jsx(E4,{src:ee.src,alt:ee.name??`Item ${ae+1}`,draggable:!1})},ee.id??ae))}),y&&u.jsx(T4,{role:"dialog","aria-modal":"true","aria-label":"Media lightbox",children:u.jsxs(z4,{onClick:Ye,children:[u.jsxs(q4,{$show:w,children:[m+1," / ",A.length]}),u.jsx(k4,{$show:w,onClick:()=>g(!1),"aria-label":"Close","data-interactive":"true",children:u.jsx(L5,{})}),u.jsx(R4,{ref:z,onScroll:q,children:A.map((ee,ae)=>u.jsx(A4,{ref:k.current[ae],children:ee.type==="video"?u.jsx(O4,{"data-slide-video":"true",src:ee.src,poster:ee.poster,controls:!0,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto","aria-label":ee.name??`Video ${ae+1}`}):u.jsx(M4,{src:ee.src,alt:ee.name??`Image ${ae+1}`})},ee.id??ae))}),u.jsx(N4,{$show:w,"data-interactive":"true",children:u.jsx(_4,{min:0,max:Math.max(0,A.length-1),step:1,value:m,onChange:Z,style:L,"aria-label":"Media scrubber"})}),u.jsx(D4,{$show:w,"aria-label":"Thumbnails","data-interactive":"true",children:A.map((ee,ae)=>u.jsx(Dg,{$active:ae===m,onClick:()=>Y(ae),"aria-label":`Go to item ${ae+1}`,children:ee.type==="video"?u.jsx(B4,{src:ee.src,poster:ee.poster,muted:!0,loop:!0,playsInline:!0,preload:"metadata"}):u.jsx($4,{src:ee.src,alt:ee.name??`Thumbnail ${ae+1}`})},ee.id??ae))})]})})]})}function Y4(a){return u.jsx(U4,{children:u.jsx(H4,{...a})})}const q4=b.div`
  position: absolute;
  top: 24px;
  left: 24px;
...
`,a3=(a=1)=>({display:"-webkit-box",WebkitBoxOrient:"vertical",overflow:"hidden",WebkitLineClamp:a});function i3({expanded:a=!1,lines:l=1,children:s,innerRef:o}){const f={fontSize:"13px",color:"#334155",margin:0,whiteSpace:"pre-wrap",...a?{}:a3(l)};return u.jsx("p",{style:f,ref:o,children:s})}function l3({avatarSrc:a=Il.teacherProfilePic,data:l,onLikeChange:s,onBookmarkChange:o,onShare:f}){const{title:d="Carousel Title",description:h="",detailedDescription:y="",carouselMetaData:g=[]}=l||{},[m,S]=v.useState(!1),[w,T]=v.useState(!1),[z,A]=v.useState(!1),[k,$]=v.useState(!1),B=v.useRef(null);v.useEffect(()=>{const Q=B.current;if(Q){if(z){$(!0);return}requestAnimationFrame(()=>{if(!Q)return;const W=Q.scrollHeight-Q.clientHeight>1;$(W)})}},[y,z]);const q=m?"Unlike post":"Like post",Y=w?"Remove bookmark":"Bookmark",Z=()=>{const Q=!m;S(Q),s&&s(Q)},J=()=>{const Q=!w;T(Q),o&&o(Q)},L=v.useMemo(()=>({title:d,text:`${d}`,url:typeof window<"u"?window.location.href:""}),[d]),V=async()=>{try{navigator.share?await navigator.share(L):navigator.clipboard&&(await navigator.clipboard.writeText(L.url),alert("Link copied to clipboard")),f&&f(L)}catch(Q){console.error("Share failed:",Q)}};return!g||g.length===0?null:u.jsxs(X4,{role:"article","aria-label":`${d} – Instagram multi-image post`,children:[u.jsxs(K4,{children:[u.jsxs(J4,{children:[u.jsxs(F4,{children:[u.jsx(W4,{src:a,alt:"avatar"}),u.jsxs(I4,{children:[u.jsx(P4,{children:d}),u.jsx(t3,{children:h})]})]}),u.jsx(Z4,{"aria-label":"Post menu",title:"More",children:u.jsx(zg,{size:18})})]}),y?u.jsxs(e3,{children:[u.jsx(i3,{expanded:z,lines:1,innerRef:B,children:y}),(k||z)&&u.jsx(n3,{type:"button","aria-expanded":z,onClick:()=>A(Q=>!Q),children:z?u.jsx(_5,{size:14}):"more"})]}):null]}),u.jsx(G4,{}),u.jsx(Y4,{items:g,duration:3e3}),u.jsxs(V4,{children:[u.jsxs(Q4,{children:[u.jsx(jo,{onClick:Z,"aria-label":q,title:q,children:m?u.jsx(Gf,{size:22}):u.jsx(Xf,{size:22})}),u.jsx(jo,{"aria-label":"Comment",title:"Comment",children:u.jsx(Zf,{size:20})}),u.jsx(jo,{onClick:V,"aria-label":"Share",title:"Share",children:u.jsx(Kf,{size:20})})]}),u.jsx(jo,{onClick:J,"aria-label":Y,title:Y,children:w?u.jsx(Vf,{size:20}):u.jsx(Qf,{size:20})})]})]})}const r3=b.article`
  width: 100%;
  max-width: 1000px;
  margin: 20px auto;
  border-radius: 12px;
...
`;function _3({currentItem:a,isOpen:l,slideIndex:s,setSlideIndex:o,onClose:f,duration:d=3e3}){const h=a?.slides?.length||0,{resetTimer:y,getProgressValue:g}=b3({isOpen:l,activeIndex:s,setActiveIndex:o,total:h,onClose:f,duration:d}),m=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,[,S]=v.useState(0);v.useEffect(()=>{if(!l||m)return;let A;const k=()=>{S($=>$+1),A=requestAnimationFrame(k)};return A=requestAnimationFrame(k),()=>cancelAnimationFrame(A)},[l,m]);const w=v.useCallback(()=>{a&&(s<h-1?(o(A=>A+1),y()):f())},[a,s,h,y,f,o]),T=v.useCallback(()=>{a&&(s>0?(o(A=>A-1),y()):f())},[a,s,y,f,o]);v.useEffect(()=>{const A=k=>{l&&(k.key==="Escape"&&f(),k.key==="ArrowRight"&&w(),k.key==="ArrowLeft"&&T())};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[l,w,T,f]),v.useEffect(()=>(l?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[l]);const z=A=>A<s?1:A>s?0:g();return!l||!a?null:u.jsx(S3,{onClick:f,"aria-label":"Story overlay",children:u.jsx(w3,{onClick:A=>A.stopPropagation(),children:u.jsxs(j3,{children:[u.jsx(E3,{"aria-label":"Story progress",children:a.slides.map((A,k)=>u.jsx(C3,{"aria-label":`Progress track ${k+1}`,children:u.jsx(T3,{style:{width:`${z(k)*100}%`}})},k))}),u.jsxs(z3,{children:[u.jsx(R3,{src:a.img,alt:a.name}),u.jsxs(A3,{children:[u.jsx(M3,{children:a.name}),u.jsx(O3,{children:"Chapter highlight"})]}),u.jsx(k3,{"aria-label":"Close story",onClick:f,title:"Close",children:u.jsx(v3,{})})]}),a.slides.map((A,k)=>u.jsx(N3,{src:A,alt:`Slide ${k+1}`,$active:k===s,draggable:!1},k)),u.jsx(Y1,{$side:"left",onClick:T,"aria-label":"Previous slide"}),u.jsx(Y1,{$side:"right",onClick:w,"aria-label":"Next slide"})]})})})}const D3=b.div``,$3=b.div`
...
`;function G3({items:a,duration:l=3e3,onOpen:s,onClose:o,className:f}){const d=v.useRef(null),h=v.useRef(!1),y=v.useRef(0),g=v.useRef(0),[m,S]=v.useState(a||[]),[w,T]=v.useState(null),[z,A]=v.useState(0),k=m.find(L=>L.id===w)||null,$=!!w,B=L=>{A(0),T(L),S(V=>V.map(Q=>Q.id===L?{...Q,hasNew:!1}:Q)),s&&s(L)},q=()=>{T(null),o&&o()},Y=L=>{h.current=!0,y.current=L.clientX,g.current=d.current?.scrollLeft||0,L.target.setPointerCapture?.(L.pointerId)},Z=L=>{if(!h.current||!d.current)return;const V=L.clientX-y.current;d.current.scrollLeft=g.current-V},J=()=>{h.current=!1};return u.jsxs(D3,{className:f,children:[u.jsx($3,{children:u.jsx(B3,{ref:d,onPointerDown:Y,onPointerMove:Z,onPointerUp:J,onPointerLeave:J,"aria-label":"Stories scroller",children:m.map(L=>u.jsxs(L3,{onClick:()=>B(L.id),"aria-label":`Open story ${L.name}`,title:L.name,children:[u.jsx(U3,{$hasNew:L.hasNew,children:u.jsx(H3,{children:u.jsx(Y3,{src:L.img,alt:L.name,draggable:!1})})}),u.jsx(q3,{children:L.name})]},L.id))})}),u.jsx(_3,{currentItem:k,isOpen:$,slideIndex:z,setSlideIndex:A,onClose:q,duration:l})]})}const X3=[{id:1,type:"infografic",title:"Sense of Collective Identity - Overview",description:"An overview of how shared history, culture, and values shape collective identity in society.",detailedDescription:"Collective identity is the shared sense of belonging among individuals who associate themselves with a larger group or community. It is shaped by shared language, culture, traditions, and values that connect people to a collective purpose. Understanding this helps explain how societies maintain unity and continuity over time.",imgSrc:An.Slide1},{id:2,type:"carousel",title:"Understanding Collective Identity",description:"Exploring the roots and importance of collective identity in social cohesion.",detailedDescription:"This section examines how collective identity emerges from shared experiences, beliefs, and cultural narratives. It plays a crucial role in fostering social solidarity, promoting cooperation, and helping individuals find meaning through group affiliation.",carouselMetaData:[{id:1,type:"img",src:An.Slide3},{id:2,type:"gif",src:An.Slide10},{id:3,type:"video",src:An.Slide11},{id:4,type:"img",src:An.Slide6}]},{id:3,type:"carousel",title:"Symbols and Shared Culture",description:"How flags, festivals, and traditions represent unity and belonging.",detailedDescription:"Symbols such as national flags, anthems, and cultural rituals embody the essence of collective identity. These shared symbols reinforce emotional ties, transmit values, and sustain collective memory.",carouselMetaData:[{id:1,type:"img",src:An.Slide7},{id:2,type:"gif",src:An.Slide10},{id:3,type:"video",src:An.Slide11}]},{id:5,type:"videoClip",title:"Collective Identity in Action",description:"A short video summarizing real-world examples of collective identity shaping societies.",detailedDescription:"This video highlights real-world scenarios where collective identity has influenced social and political movements.",videoClipSrc:_1.videoClip1},{id:6,type:"infografic",title:"Evolution of Collective Identity",description:"Tracing the historical development of group identity across civilizations.",detailedDescription:"Collective identity has evolved alongside human societies — from tribal affiliations and religious communities to modern national and digital identities.",imgSrc:An.Slide5},{id:7,type:"videoClip",title:"Evolution of Collective Identity",description:"Tracing the historical development of group identity across civilizations.",detailedDescription:"Collective identity has evolved alongside human societies — from tribal affiliations and religious communities to modern national and digital identities.",videoClipSrc:_1.videoClip1}],V3=b.div`
  ...
  background: radial-gradient(
    ...
    #f8fafc;
`;function Q3(){return v.useEffect(()=>{window.scrollTo({top:0,left:0,behavior:"auto"})},[]),u.jsxs(u.Fragment,{children:[u.jsx(G3,{items:y3,duration:3e3,onOpen:a=>console.log("opened:",a),onClose:()=>console.log("closed")}),u.jsx(V3,{children:u.jsx("div",{className:"d-flex gap-3 flex-column align-items-center mt-3",children:X3.map(a=>u.jsx("div",{style:{width:"100%"},children:a.type==="infografic"?u.jsx(v4,{title:a.title,description:a.description,imgSrc:a.imgSrc,badge:a.badge}):a.type==="carousel"?u.jsx(l3,{data:a}):a.type==="videoClip"?u.jsx(x3,{data:a}):null},a.id))})})]})}/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Z3=a=>a.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),K3=a=>a.replace(/^([A-Z])|[\s-_]+(\w)/g,(l,s,o)=>o?o.toUpperCase():s.toLowerCase()),q1=a=>{const l=K3(a);return l.charAt(0).toUpperCase()+l.slice(1)},$g=(...a)=>a.filter((l,s,o)=>!!l&&l.trim()!==""&&o.indexOf(l)===s).join(" ").trim(),J3=a=>{for(const l in a)if(l.startsWith("aria-")||l==="role"||l==="title")return!0};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W3=v.forwardRef(({color:a="currentColor",size:l=24,strokeWidth:s=2,absoluteStrokeWidth:o,className:f="",children:d,iconNode:h,...y},g)=>v.createElement("svg",{ref:g,...F3,width:l,height:l,stroke:a,strokeWidth:o?Number(s)*24/Number(l):s,className:$g("lucide",f),...!d&&!J3(y)&&{"aria-hidden":"true"},...y},[...h.map(([m,S])=>v.createElement(m,S)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mt=(a,l)=>{const s=v.forwardRef(({className:o,...f},d)=>v.createElement(W3,{ref:d,iconNode:l,className:$g(`lucide-${Z3(q1(a))}`,`lucide-${a}`,o),...f}));return s.displayName=q1(a),s};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I3=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]],P3=mt("arrow-right",I3);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const e6=[["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}],["path",{d:"M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z",key:"1l2ple"}],["path",{d:"M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z",key:"1wam0m"}]],t6=mt("atom",e6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const n6=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],Wo=mt("book-open",n6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a6=[["path",{d:"m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z",key:"1fy3hk"}]],i6=mt("bookmark",a6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l6=[["rect",{width:"16",height:"20",x:"4",y:"2",rx:"2",key:"1nb95v"}],["line",{x1:"8",x2:"16",y1:"6",y2:"6",key:"x4nwl0"}],["line",{x1:"16",x2:"16",y1:"14",y2:"18",key:"wjye3r"}],["path",{d:"M16 10h.01",key:"1m94wz"}],["path",{d:"M12 10h.01",key:"1nrarc"}],["path",{d:"M8 10h.01",key:"19clt8"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M8 14h.01",key:"6423bh"}],["path",{d:"M12 18h.01",key:"mhygvu"}],["path",{d:"M8 18h.01",key:"lrp35t"}]],r6=mt("calculator",l6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const o6=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],Bg=mt("check",o6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const s6=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],Jf=mt("chevron-left",s6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c6=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Lg=mt("chevron-right",c6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u6=[["path",{d:"m16 18 6-6-6-6",key:"eg8j8"}],["path",{d:"m8 6-6 6 6 6",key:"ppft3o"}]],f6=mt("code",u6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const d6=[["path",{d:"M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2",key:"18mbvz"}],["path",{d:"M6.453 15h11.094",key:"3shlmq"}],["path",{d:"M8.5 2h7",key:"csnxdl"}]],G1=mt("flask-conical",d6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p6=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]],X1=mt("globe",p6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h6=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M3 15h18",key:"5xshup"}],["path",{d:"M9 3v18",key:"fh3hqa"}],["path",{d:"M15 3v18",key:"14nvp0"}]],m6=mt("grid-3x3",h6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g6=[["path",{d:"m5 8 6 6",key:"1wu5hv"}],["path",{d:"m4 14 6-6 2-3",key:"1k1g8d"}],["path",{d:"M2 5h12",key:"or177f"}],["path",{d:"M7 2h1",key:"1t2jsx"}],["path",{d:"m22 22-5-10-5 10",key:"don7ne"}],["path",{d:"M14 18h6",key:"1m8k6r"}]],x6=mt("languages",g6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y6=[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]],Co=mt("lock",y6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v6=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],qu=mt("x",v6),b6=b.div`
  padding: 35px;
  text-align: center;
  display: grid;
  gap: 16px;
...
`;function z6({onStart:a}){return u.jsxs(b6,{children:[u.jsx(S6,{children:u.jsx(w6,{src:"https://th.bing.com/th/id/OIP.uSFDPMfkxTDmRZEJvOe_lAHaHa?w=108&h=108&c=1&bgcl=e66538&r=0&o=7&dpr=1.1&pid=ImgRC&rm=3",alt:"PW Logo"})}),u.jsxs(j6,{children:[u.jsx(E6,{children:"Welcome to Pi learn"}),u.jsx(C6,{children:"Your personalized learning journey starts here. Connect with expert teachers and unlock your full potential."})]}),u.jsxs(T6,{onClick:a,"aria-label":"Get started",children:["Get Started ",u.jsx(P3,{size:18})]})]})}const R6=b.div`
padding: 35px;
position: relative;
overflow: visible;
`,A6=b.button`
...
`;function U6({options:a,value:l,onChange:s,onNext:o}){const d=ke.useRef(null),h=g=>{const m=a.indexOf(g);if(m===-1)return;const S=d.current.clientHeight/2-48/2;d.current.scrollTo({top:S+m*48,behavior:"smooth"}),s(g),o&&o()},y={height:`calc(50% - ${48/2}px)`};return u.jsx(N6,{children:u.jsxs(_6,{ref:d,children:[u.jsx(D6,{}),u.jsxs($6,{children:[u.jsx(V1,{$height:y.height}),a.map((g,m)=>u.jsx(B6,{$height:48,$delay:`${m*.02}s`,$isSelected:g===l,onClick:()=>h(g),children:g},g)),u.jsx(V1,{$height:y.height})]})]})})}function H6({grades:a,selectedGrade:l,onSelect:s,onBack:o,onNext:f}){const d=Object.keys(a);return ke.useEffect(()=>{!l&&d.length>0&&s(d[0])},[l,d,s]),u.jsxs(R6,{children:[u.jsx(A6,{onClick:o,"aria-label":"Go back",children:u.jsx(Jf,{size:24})}),u.jsxs(M6,{children:[u.jsx(O6,{children:"Choose your Grade"}),u.jsx(k6,{children:"Swipe or tap to select a grade."})]}),u.jsx(U6,{options:d,value:l||d[0],onChange:s,onNext:f})]})}const Y6={English:Wo,Mathematics:r6,Science:G1,Physics:t6,Chemistry:G1,Biology:X1,"Social Studies":X1,Hindi:x6,"Computer Science":f6},q6=b.div`
padding: 3px;
position: relative;
overflow: visible;
`,G6=b.button`
...
`;function I6({grades:a,selectedGrade:l,selectedSubject:s,onSelectSubject:o,onBack:f,onNext:d}){const h=l?Object.keys(a[l].subjects):[];return u.jsxs(q6,{children:[u.jsx(G6,{onClick:f,"aria-label":"Go back",children:u.jsx(Jf,{size:24})}),u.jsxs(X6,{children:[u.jsx(V6,{children:"Pick a Subject"}),u.jsx(Q6,{children:l?`You chose ${l}. Now select a subject.`:"Choose a grade first."})]}),u.jsx(Z6,{children:h.map((y,g)=>{const m=Y6[y]||Wo,S=s===y;return u.jsxs(K6,{$isSelected:S,$delay:`${g*.03}s`,"aria-pressed":S,onClick:()=>o(y),children:[u.jsxs(J6,{children:[u.jsx(W6,{children:u.jsx(m,{size:18})}),u.jsx(F6,{children:y})]}),u.jsx(Lg,{size:18,onClick:d,disabled:!s})]},y)})})]})}const P6=b.div`
  padding: 3px;
  position: relative;
  overflow: visible;
`,e8=b.button`
...
`,y8=b.div`
  ...
  padding: 16px;
  background: ${en.bg};
  animation: ${m8} 0.42s ease-out both;
`,v8=b.div`
  width: 100%;
  max-width: 720px;
`,b8=b.div`
  ...
  animation: ${x8} .18s ease-out both;
`,S8=b.div`
  display: flex;
  gap: 6px;
  justify-content: center;
  margin-bottom: 12px;
  animation: ${g8} 0.4s ease-out both;
`,w8=b.div`
  height: 8px;
  width: 12px;
  border-radius: 999px;
...
`,Mo=b.div`
  ...
  margin-bottom: 10px;
  opacity: 0.3;
  animation: ${Pl?"none":M8} 3s ease-in-out infinite;
`,Oo=b.h3`
  color: ${le.text};
...
`,Qu=b.div`
  ...
  border-radius: 50%;
  background: rgba(255, 255, 255, 0.1);
  animation: ${rS} 20s infinite ease-in-out;
...
`;function cm(){const[a,l]=v.useState(!1),s=()=>{l(!0),setTimeout(()=>{l(!1)},2e3)};return u.jsxs(uS,{children:[u.jsxs(fS,{children:[u.jsx(Qu,{}),u.jsx(Qu,{}),u.jsx(Qu,{})]}),u.jsxs(dS,{children:[u.jsx(pS,{children:u.jsx(hS,{children:"🚧"})}),u.jsx(mS,{children:"Building Something Amazing"}),u.jsx(gS,{children:"We're working hard to bring you an incredible new feature. Stay tuned!"}),u.jsx(xS,{children:u.jsx(yS,{})}),u.jsxs(vS,{children:[u.jsxs(Zu,{children:[u.jsx(Ku,{children:"⚡"}),u.jsx(Ju,{children:"Lightning Fast"})]}),u.jsxs(Zu,{children:[u.jsx(Ku,{children:"🎨"}),u.jsx(Ju,{children:"Beautiful Design"})]}),u.jsxs(Zu,{children:[u.jsx(Ku,{children:"🔒"}),u.jsx(Ju,{children:"Secure & Private"})]})]}),u.jsx(bS,{onClick:s,$notified:a,children:a?"✓ You'll be notified!":"Notify Me When Ready"})]})]})}var Fu={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var um;function SS(){return um||(um=1,(function(a){(function(){var l={}.hasOwnProperty;function s(){for(var d="",h=0;h<arguments.length;h++){var y=arguments[h];y&&(d=f(d,o(y)))}return d}function o(d){if(typeof d=="string"||typeof d=="number")return d;if(typeof d!="object")return"";if(Array.isArray(d))return s.apply(null,d);if(d.toString!==Object.prototype.toString&&!d.toString.toString().includes("[native code]"))return d.toString();var h="";for(var y in d)l.call(d,y)&&d[y]&&(h=f(h,y));return h}function f(d,h){return h?d?d+" "+h:d+h:d}a.exports?(s.default=s,a.exports=s):window.classNames=s})()})(Fu)),Fu.exports}var wS=SS();const it=Zl(wS);function Cf(){return Cf=Object.assign?Object.assign.bind():function(a){for(var l=1;l<arguments.length;l++){var s=arguments[l];for(var o in s)({}).hasOwnProperty.call(s,o)&&(a[o]=s[o])}return a},Cf.apply(null,arguments)}function qg(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)!==-1)continue;s[o]=a[o]}return s}function fm(a){return"default"+a.charAt(0).toUpperCase()+a.substr(1)}function jS(a){var l=ES(a,"string");return typeof l=="symbol"?l:String(l)}function ES(a,l){if(typeof a!="object"||a===null)return a;var s=a[Symbol.toPrimitive];if(s!==void 0){var o=s.call(a,l);if(typeof o!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(a)}function CS(a,l,s){var o=v.useRef(a!==void 0),f=v.useState(l),d=f[0],h=f[1],y=a!==void 0,g=o.current;return o.current=y,!y&&g&&d!==l&&h(l),[y?a:d,v.useCallback(function(m){for(var S=arguments.length,w=new Array(S>1?S-1:0),T=1;T<S;T++)w[T-1]=arguments[T];s&&s.apply(void 0,[m].concat(w)),h(m)},[s])]}function Gg(a,l){return Object.keys(l).reduce(function(s,o){var f,d=s,h=d[fm(o)],y=d[o],g=qg(d,[fm(o),o].map(jS)),m=l[o],S=CS(y,h,a[m]),w=S[0],T=S[1];return Cf({},g,(f={},f[o]=w,f[m]=T,f))},a)}function Tf(a,l){return Tf=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(s,o){return s.__proto__=o,s},Tf(a,l)}function TS(a,l){a.prototype=Object.create(l.prototype),a.prototype.constructor=a,Tf(a,l)}const zS=["xxl","xl","lg","md","sm","xs"],RS="xs",Xg=v.createContext({prefixes:{},breakpoints:zS,minBreakpoint:RS}),{Consumer:X9,Provider:V9}=Xg;function jt(a,l){const{prefixes:s}=v.useContext(Xg);return a||s[l]||l}function Ff(a){return a&&a.ownerDocument||document}function AS(a){var l=Ff(a);return l&&l.defaultView||window}function MS(a,l){return AS(a).getComputedStyle(a,l)}var OS=/([A-Z])/g;function kS(a){return a.replace(OS,"-$1").toLowerCase()}var NS=/^ms-/;function _o(a){return kS(a).replace(NS,"-ms-")}var _S=/^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i;function DS(a){return!!(a&&_S.test(a))}function _n(a,l){var s="",o="";if(typeof l=="string")return a.style.getPropertyValue(_o(l))||MS(a).getPropertyValue(_o(l));Object.keys(l).forEach(function(f){var d=l[f];!d&&d!==0?a.style.removeProperty(_o(f)):DS(f)?o+=f+"("+d+") ":s+=_o(f)+": "+d+";"}),o&&(s+="transform: "+o+";"),a.style.cssText+=";"+s}var Wu={exports:{}},Iu,dm;function $S(){if(dm)return Iu;dm=1;var a="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return Iu=a,Iu}var Pu,pm;function BS(){if(pm)return Pu;pm=1;var a=$S();function l(){}function s(){}return s.resetWarningCache=l,Pu=function(){function o(h,y,g,m,S,w){if(w!==a){var T=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw T.name="Invariant Violation",T}}o.isRequired=o;function f(){return o}var d={array:o,bigint:o,bool:o,func:o,number:o,object:o,string:o,symbol:o,any:o,arrayOf:f,element:o,elementType:o,instanceOf:f,node:o,objectOf:f,oneOf:f,oneOfType:f,shape:f,exact:f,checkPropTypes:s,resetWarningCache:l};return d.PropTypes=d,d},Pu}var hm;function LS(){return hm||(hm=1,Wu.exports=BS()()),Wu.exports}var US=LS();const ef=Zl(US),mm={disabled:!1},Vg=ke.createContext(null);var HS=function(l){return l.scrollTop},Yl="unmounted",ha="exited",Pt="entering",On="entered",Ql="exiting",Un=(function(a){TS(l,a);function l(o,f){var d;d=a.call(this,o,f)||this;var h=f,y=h&&!h.isMounting?o.enter:o.appear,g;return d.appearStatus=null,o.in?y?(g=ha,d.appearStatus=Pt):g=On:o.unmountOnExit||o.mountOnEnter?g=Yl:g=ha,d.state={status:g},d.nextCallback=null,d}l.getDerivedStateFromProps=function(f,d){var h=f.in;return h&&d.status===Yl?{status:ha}:null};var s=l.prototype;return s.componentDidMount=function(){this.updateStatus(!0,this.appearStatus)},s.componentDidUpdate=function(f){var d=null;if(f!==this.props){var h=this.state.status;this.props.in?h!==Pt&&h!==On&&(d=Pt):(h===Pt||h===On)&&(d=Ql)}this.updateStatus(!1,d)},s.componentWillUnmount=function(){this.cancelNextCallback()},s.getTimeouts=function(){var f=this.props.timeout,d,h,y;return d=h=y=f,f!=null&&typeof f!="number"&&(d=f.exit,h=f.enter,y=f.appear!==void 0?f.appear:h),{exit:d,enter:h,appear:y}},s.updateStatus=function(f,d){if(f===void 0&&(f=!1),d!==null)if(this.cancelNextCallback(),d===Pt){if(this.props.unmountOnExit||this.props.mountOnEnter){var h=this.props.nodeRef?this.props.nodeRef.current:Ai.findDOMNode(this);h&&HS(h)}this.performEnter(f)}else this.performExit();else this.props.unmountOnExit&&this.state.status===ha&&this.setState({status:Yl})},s.performEnter=function(f){var d=this,h=this.props.enter,y=this.context?this.context.isMounting:f,g=this.props.nodeRef?[y]:[Ai.findDOMNode(this),y],m=g[0],S=g[1],w=this.getTimeouts(),T=y?w.appear:w.enter;if(!f&&!h||mm.disabled){this.safeSetState({status:On},function(){d.props.onEntered(m)});return}this.props.onEnter(m,S),this.safeSetState({status:Pt},function(){d.props.onEntering(m,S),d.onTransitionEnd(T,function(){d.safeSetState({status:On},function(){d.props.onEntered(m,S)})})})},s.performExit=function(){var f=this,d=this.props.exit,h=this.getTimeouts(),y=this.props.nodeRef?void 0:Ai.findDOMNode(this);if(!d||mm.disabled){this.safeSetState({status:ha},function(){f.props.onExited(y)});return}this.props.onExit(y),this.safeSetState({status:Ql},function(){f.props.onExiting(y),f.onTransitionEnd(h.exit,function(){f.safeSetState({status:ha},function(){f.props.onExited(y)})})})},s.cancelNextCallback=function(){this.nextCallback!==null&&(this.nextCallback.cancel(),this.nextCallback=null)},s.safeSetState=function(f,d){d=this.setNextCallback(d),this.setState(f,d)},s.setNextCallback=function(f){var d=this,h=!0;return this.nextCallback=function(y){h&&(h=!1,d.nextCallback=null,f(y))},this.nextCallback.cancel=function(){h=!1},this.nextCallback},s.onTransitionEnd=function(f,d){this.setNextCallback(d);var h=this.props.nodeRef?this.props.nodeRef.current:Ai.findDOMNode(this),y=f==null&&!this.props.addEndListener;if(!h||y){setTimeout(this.nextCallback,0);return}if(this.props.addEndListener){var g=this.props.nodeRef?[this.nextCallback]:[h,this.nextCallback],m=g[0],S=g[1];this.props.addEndListener(m,S)}f!=null&&setTimeout(this.nextCallback,f)},s.render=function(){var f=this.state.status;if(f===Yl)return null;var d=this.props,h=d.children;d.in,d.mountOnEnter,d.unmountOnExit,d.appear,d.enter,d.exit,d.timeout,d.addEndListener,d.onEnter,d.onEntering,d.onEntered,d.onExit,d.onExiting,d.onExited,d.nodeRef;var y=qg(d,["children","in","mountOnEnter","unmountOnExit","appear","enter","exit","timeout","addEndListener","onEnter","onEntering","onEntered","onExit","onExiting","onExited","nodeRef"]);return ke.createElement(Vg.Provider,{value:null},typeof h=="function"?h(f,y):ke.cloneElement(ke.Children.only(h),y))},l})(ke.Component);Un.contextType=Vg;Un.propTypes={};function Ti(){}Un.defaultProps={in:!1,mountOnEnter:!1,unmountOnExit:!1,appear:!1,enter:!0,exit:!0,onEnter:Ti,onEntering:Ti,onEntered:Ti,onExit:Ti,onExiting:Ti,onExited:Ti};Un.UNMOUNTED=Yl;Un.EXITED=ha;Un.ENTERING=Pt;Un.ENTERED=On;Un.EXITING=Ql;function YS(a){return a.code==="Escape"||a.keyCode===27}function qS(){const a=v.version.split(".");return{major:+a[0],minor:+a[1],patch:+a[2]}}function Yi(a){if(!a||typeof a=="function")return null;const{major:l}=qS();return l>=19?a.props.ref:a.ref}const us=!!(typeof window<"u"&&window.document&&window.document.createElement);var zf=!1,Rf=!1;try{var tf={get passive(){return zf=!0},get once(){return Rf=zf=!0}};us&&(window.addEventListener("test",tf,tf),window.removeEventListener("test",tf,!0))}catch{}function GS(a,l,s,o){if(o&&typeof o!="boolean"&&!Rf){var f=o.once,d=o.capture,h=s;!Rf&&f&&(h=s.__once||function y(g){this.removeEventListener(l,y,d),s.call(this,g)},s.__once=h),a.addEventListener(l,h,zf?o:d)}a.addEventListener(l,s,o)}function XS(a,l,s,o){var f=o&&typeof o!="boolean"?o.capture:o;a.removeEventListener(l,s,f),s.__once&&a.removeEventListener(l,s.__once,f)}function Io(a,l,s,o){return GS(a,l,s,o),function(){XS(a,l,s,o)}}function VS(a,l,s,o){if(o===void 0&&(o=!0),a){var f=document.createEvent("HTMLEvents");f.initEvent(l,s,o),a.dispatchEvent(f)}}function QS(a){var l=_n(a,"transitionDuration")||"",s=l.indexOf("ms")===-1?1e3:1;return parseFloat(l)*s}function ZS(a,l,s){s===void 0&&(s=5);var o=!1,f=setTimeout(function(){o||VS(a,"transitionend",!0)},l+s),d=Io(a,"transitionend",function(){o=!0},{once:!0});return function(){clearTimeout(f),d()}}function KS(a,l,s,o){s==null&&(s=QS(a)||0);var f=ZS(a,s,o),d=Io(a,"transitionend",l);return function(){f(),d()}}function gm(a,l){const s=_n(a,l)||"",o=s.indexOf("ms")===-1?1e3:1;return parseFloat(s)*o}function Wf(a,l){const s=gm(a,"transitionDuration"),o=gm(a,"transitionDelay"),f=KS(a,d=>{d.target===a&&(f(),l(d))},s+o)}function Ul(...a){return a.filter(l=>l!=null).reduce((l,s)=>{if(typeof s!="function")throw new Error("Invalid Argument Type, must only provide functions, undefined, or null.");return l===null?s:function(...f){l.apply(this,f),s.apply(this,f)}},null)}function Qg(a){a.offsetHeight}const xm=a=>!a||typeof a=="function"?a:l=>{a.current=l};function JS(a,l){const s=xm(a),o=xm(l);return f=>{s&&s(f),o&&o(f)}}function FS(a,l){return v.useMemo(()=>JS(a,l),[a,l])}function WS(a){return a&&"setState"in a?Ai.findDOMNode(a):a??null}const fs=ke.forwardRef(({onEnter:a,onEntering:l,onEntered:s,onExit:o,onExiting:f,onExited:d,addEndListener:h,children:y,childRef:g,...m},S)=>{const w=v.useRef(null),T=FS(w,g),z=L=>{T(WS(L))},A=L=>V=>{L&&w.current&&L(w.current,V)},k=v.useCallback(A(a),[a]),$=v.useCallback(A(l),[l]),B=v.useCallback(A(s),[s]),q=v.useCallback(A(o),[o]),Y=v.useCallback(A(f),[f]),Z=v.useCallback(A(d),[d]),J=v.useCallback(A(h),[h]);return u.jsx(Un,{ref:S,...m,onEnter:k,onEntered:B,onEntering:$,onExit:q,onExited:Z,onExiting:Y,addEndListener:J,nodeRef:w,children:typeof y=="function"?(L,V)=>y(L,{...V,ref:z}):ke.cloneElement(y,{ref:z})})});fs.displayName="TransitionWrapper";const IS={height:["marginTop","marginBottom"],width:["marginLeft","marginRight"]};function PS(a,l){const s=`offset${a[0].toUpperCase()}${a.slice(1)}`,o=l[s],f=IS[a];return o+parseInt(_n(l,f[0]),10)+parseInt(_n(l,f[1]),10)}const ew={[ha]:"collapse",[Ql]:"collapsing",[Pt]:"collapsing",[On]:"collapse show"},Zg=ke.forwardRef(({onEnter:a,onEntering:l,onEntered:s,onExit:o,onExiting:f,className:d,children:h,dimension:y="height",in:g=!1,timeout:m=300,mountOnEnter:S=!1,unmountOnExit:w=!1,appear:T=!1,getDimensionValue:z=PS,...A},k)=>{const $=typeof y=="function"?y():y,B=v.useMemo(()=>Ul(L=>{L.style[$]="0"},a),[$,a]),q=v.useMemo(()=>Ul(L=>{const V=`scroll${$[0].toUpperCase()}${$.slice(1)}`;L.style[$]=`${L[V]}px`},l),[$,l]),Y=v.useMemo(()=>Ul(L=>{L.style[$]=null},s),[$,s]),Z=v.useMemo(()=>Ul(L=>{L.style[$]=`${z($,L)}px`,Qg(L)},o),[o,z,$]),J=v.useMemo(()=>Ul(L=>{L.style[$]=null},f),[$,f]);return u.jsx(fs,{ref:k,addEndListener:Wf,...A,"aria-expanded":A.role?g:null,onEnter:B,onEntering:q,onEntered:Y,onExit:Z,onExiting:J,childRef:Yi(h),in:g,timeout:m,mountOnEnter:S,unmountOnExit:w,appear:T,children:(L,V)=>ke.cloneElement(h,{...V,className:it(d,h.props.className,ew[L],$==="width"&&"collapse-horizontal")})})});Zg.displayName="Collapse";function tw(a){const l=v.useRef(a);return v.useEffect(()=>{l.current=a},[a]),l}function ds(a){const l=tw(a);return v.useCallback(function(...s){return l.current&&l.current(...s)},[l])}const nw=(a=>v.forwardRef((l,s)=>u.jsx("div",{...l,ref:s,className:it(l.className,a)})));function aw(a){const l=v.useRef(a);return v.useEffect(()=>{l.current=a},[a]),l}function kn(a){const l=aw(a);return v.useCallback(function(...s){return l.current&&l.current(...s)},[l])}function iw(){const a=v.useRef(!0),l=v.useRef(()=>a.current);return v.useEffect(()=>(a.current=!0,()=>{a.current=!1}),[]),l.current}function lw(a){const l=v.useRef(null);return v.useEffect(()=>{l.current=a}),l.current}const rw=typeof global<"u"&&global.navigator&&global.navigator.product==="ReactNative",ow=typeof document<"u",ym=ow||rw?v.useLayoutEffect:v.useEffect,sw=["as","disabled"];function cw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function uw(a){return!a||a.trim()==="#"}function Kg({tagName:a,disabled:l,href:s,target:o,rel:f,role:d,onClick:h,tabIndex:y=0,type:g}){a||(s!=null||o!=null||f!=null?a="a":a="button");const m={tagName:a};if(a==="button")return[{type:g||"button",disabled:l},m];const S=T=>{if((l||a==="a"&&uw(s))&&T.preventDefault(),l){T.stopPropagation();return}h?.(T)},w=T=>{T.key===" "&&(T.preventDefault(),S(T))};return a==="a"&&(s||(s="#"),l&&(s=void 0)),[{role:d??"button",disabled:void 0,tabIndex:l?void 0:y,href:s,target:a==="a"?o:void 0,"aria-disabled":l||void 0,rel:a==="a"?f:void 0,onClick:S,onKeyDown:w},m]}const Jg=v.forwardRef((a,l)=>{let{as:s,disabled:o}=a,f=cw(a,sw);const[d,{tagName:h}]=Kg(Object.assign({tagName:s,disabled:o},f));return u.jsx(h,Object.assign({},f,d,{ref:l}))});Jg.displayName="Button";const fw=["onKeyDown"];function dw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function pw(a){return!a||a.trim()==="#"}const Fg=v.forwardRef((a,l)=>{let{onKeyDown:s}=a,o=dw(a,fw);const[f]=Kg(Object.assign({tagName:"a"},o)),d=kn(h=>{f.onKeyDown(h),s?.(h)});return pw(o.href)||o.role==="button"?u.jsx("a",Object.assign({ref:l},o,f,{onKeyDown:d})):u.jsx("a",Object.assign({ref:l},o,{onKeyDown:s}))});Fg.displayName="Anchor";const hw={[Pt]:"show",[On]:"show"},Wg=v.forwardRef(({className:a,children:l,transitionClasses:s={},onEnter:o,...f},d)=>{const h={in:!1,timeout:300,mountOnEnter:!1,unmountOnExit:!1,appear:!1,...f},y=v.useCallback((g,m)=>{Qg(g),o?.(g,m)},[o]);return u.jsx(fs,{ref:d,addEndListener:Wf,...h,onEnter:y,childRef:Yi(l),children:(g,m)=>v.cloneElement(l,{...m,className:it("fade",a,l.props.className,hw[g],s[g])})})});Wg.displayName="Fade";const mw={"aria-label":ef.string,onClick:ef.func,variant:ef.oneOf(["white"])},If=v.forwardRef(({className:a,variant:l,"aria-label":s="Close",...o},f)=>u.jsx("button",{ref:f,type:"button",className:it("btn-close",l&&`btn-close-${l}`,a),"aria-label":s,...o}));If.displayName="CloseButton";If.propTypes=mw;const Ig=v.createContext(null);Ig.displayName="CardHeaderContext";const Pg=v.forwardRef(({bsPrefix:a,fluid:l=!1,as:s="div",className:o,...f},d)=>{const h=jt(a,"container"),y=typeof l=="string"?`-${l}`:"-fluid";return u.jsx(s,{ref:d,...f,className:it(o,l?`${h}${y}`:h)})});Pg.displayName="Container";var gw=Function.prototype.bind.call(Function.prototype.call,[].slice);function Da(a,l){return gw(a.querySelectorAll(l))}function xw(){const[,a]=v.useReducer(l=>l+1,0);return a}function vm(a,l){if(a.contains)return a.contains(l);if(a.compareDocumentPosition)return a===l||!!(a.compareDocumentPosition(l)&16)}const Po=v.createContext(null),Pf=(a,l=null)=>a!=null?String(a):l||null,ed=v.createContext(null);ed.displayName="NavContext";const yw="data-rr-ui-",vw="rrUi";function ps(a){return`${yw}${a}`}function bw(a){return`${vw}${a}`}const e2=v.createContext(us?window:void 0);e2.Provider;function td(){return v.useContext(e2)}const Sw=typeof global<"u"&&global.navigator&&global.navigator.product==="ReactNative",ww=typeof document<"u",jw=ww||Sw?v.useLayoutEffect:v.useEffect,qi=v.createContext(null);qi.displayName="NavbarContext";const bm=a=>!a||typeof a=="function"?a:l=>{a.current=l};function Ew(a,l){const s=bm(a),o=bm(l);return f=>{s&&s(f),o&&o(f)}}function hs(a,l){return v.useMemo(()=>Ew(a,l),[a,l])}const t2=v.createContext(null),Cw=["as","active","eventKey"];function Tw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function n2({key:a,onClick:l,active:s,id:o,role:f,disabled:d}){const h=v.useContext(Po),y=v.useContext(ed),g=v.useContext(t2);let m=s;const S={role:f};if(y){!f&&y.role==="tablist"&&(S.role="tab");const w=y.getControllerId(a??null),T=y.getControlledId(a??null);S[ps("event-key")]=a,S.id=w||o,m=s==null&&a!=null?y.activeKey===a:s,(m||!(g!=null&&g.unmountOnExit)&&!(g!=null&&g.mountOnEnter))&&(S["aria-controls"]=T)}return S.role==="tab"&&(S["aria-selected"]=m,m||(S.tabIndex=-1),d&&(S.tabIndex=-1,S["aria-disabled"]=!0)),S.onClick=kn(w=>{d||(l?.(w),a!=null&&h&&!w.isPropagationStopped()&&h(a,w))}),[S,{isActive:m}]}const a2=v.forwardRef((a,l)=>{let{as:s=Jg,active:o,eventKey:f}=a,d=Tw(a,Cw);const[h,y]=n2(Object.assign({key:Pf(f,d.href),active:o},d));return h[ps("active")]=y.isActive,u.jsx(s,Object.assign({},d,h,{ref:l}))});a2.displayName="NavItem";const zw=["as","onSelect","activeKey","role","onKeyDown"];function Rw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}const Sm=()=>{},wm=ps("event-key"),i2=v.forwardRef((a,l)=>{let{as:s="div",onSelect:o,activeKey:f,role:d,onKeyDown:h}=a,y=Rw(a,zw);const g=xw(),m=v.useRef(!1),S=v.useContext(Po),w=v.useContext(t2);let T,z;w&&(d=d||"tablist",f=w.activeKey,T=w.getControlledId,z=w.getControllerId);const A=v.useRef(null),k=Y=>{const Z=A.current;if(!Z)return null;const J=Da(Z,`[${wm}]:not([aria-disabled=true])`),L=Z.querySelector("[aria-selected=true]");if(!L||L!==document.activeElement)return null;const V=J.indexOf(L);if(V===-1)return null;let Q=V+Y;return Q>=J.length&&(Q=0),Q<0&&(Q=J.length-1),J[Q]},$=(Y,Z)=>{Y!=null&&(o?.(Y,Z),S?.(Y,Z))},B=Y=>{if(h?.(Y),!w)return;let Z;switch(Y.key){case"ArrowLeft":case"ArrowUp":Z=k(-1);break;case"ArrowRight":case"ArrowDown":Z=k(1);break;default:return}Z&&(Y.preventDefault(),$(Z.dataset[bw("EventKey")]||null,Y),m.current=!0,g())};v.useEffect(()=>{if(A.current&&m.current){const Y=A.current.querySelector(`[${wm}][aria-selected=true]`);Y?.focus()}m.current=!1});const q=hs(l,A);return u.jsx(Po.Provider,{value:$,children:u.jsx(ed.Provider,{value:{role:d,activeKey:Pf(f),getControlledId:T||Sm,getControllerId:z||Sm},children:u.jsx(s,Object.assign({},y,{onKeyDown:B,ref:q,role:d}))})})});i2.displayName="Nav";const Aw=Object.assign(i2,{Item:a2});function nf(a){a===void 0&&(a=Ff());try{var l=a.activeElement;return!l||!l.nodeName?null:l}catch{return a.body}}function Mw(a){const l=v.useRef(a);return l.current=a,l}function Ow(a){const l=Mw(a);v.useEffect(()=>()=>l.current(),[])}function kw(a=document){const l=a.defaultView;return Math.abs(l.innerWidth-a.documentElement.clientWidth)}const jm=ps("modal-open");class nd{constructor({ownerDocument:l,handleContainerOverflow:s=!0,isRTL:o=!1}={}){this.handleContainerOverflow=s,this.isRTL=o,this.modals=[],this.ownerDocument=l}getScrollbarWidth(){return kw(this.ownerDocument)}getElement(){return(this.ownerDocument||document).body}setModalAttributes(l){}removeModalAttributes(l){}setContainerStyle(l){const s={overflow:"hidden"},o=this.isRTL?"paddingLeft":"paddingRight",f=this.getElement();l.style={overflow:f.style.overflow,[o]:f.style[o]},l.scrollBarWidth&&(s[o]=`${parseInt(_n(f,o)||"0",10)+l.scrollBarWidth}px`),f.setAttribute(jm,""),_n(f,s)}reset(){[...this.modals].forEach(l=>this.remove(l))}removeContainerStyle(l){const s=this.getElement();s.removeAttribute(jm),Object.assign(s.style,l.style)}add(l){let s=this.modals.indexOf(l);return s!==-1||(s=this.modals.length,this.modals.push(l),this.setModalAttributes(l),s!==0)||(this.state={scrollBarWidth:this.getScrollbarWidth(),style:{}},this.handleContainerOverflow&&this.setContainerStyle(this.state)),s}remove(l){const s=this.modals.indexOf(l);s!==-1&&(this.modals.splice(s,1),!this.modals.length&&this.handleContainerOverflow&&this.removeContainerStyle(this.state),this.removeModalAttributes(l))}isTopModal(l){return!!this.modals.length&&this.modals[this.modals.length-1]===l}}const af=(a,l)=>us?a==null?(l||Ff()).body:(typeof a=="function"&&(a=a()),a&&"current"in a&&(a=a.current),a&&("nodeType"in a||a.getBoundingClientRect)?a:null):null;function Nw(a,l){const s=td(),[o,f]=v.useState(()=>af(a,s?.document));if(!o){const d=af(a);d&&f(d)}return v.useEffect(()=>{},[l,o]),v.useEffect(()=>{const d=af(a);d!==o&&f(d)},[a,o]),o}function _w({children:a,in:l,onExited:s,mountOnEnter:o,unmountOnExit:f}){const d=v.useRef(null),h=v.useRef(l),y=kn(s);v.useEffect(()=>{l?h.current=!0:y(d.current)},[l,y]);const g=hs(d,Yi(a)),m=v.cloneElement(a,{ref:g});return l?m:f||!h.current&&o?null:m}const Dw=["onEnter","onEntering","onEntered","onExit","onExiting","onExited","addEndListener","children"];function $w(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function Bw(a){let{onEnter:l,onEntering:s,onEntered:o,onExit:f,onExiting:d,onExited:h,addEndListener:y,children:g}=a,m=$w(a,Dw);const S=v.useRef(null),w=hs(S,Yi(g)),T=Z=>J=>{Z&&S.current&&Z(S.current,J)},z=v.useCallback(T(l),[l]),A=v.useCallback(T(s),[s]),k=v.useCallback(T(o),[o]),$=v.useCallback(T(f),[f]),B=v.useCallback(T(d),[d]),q=v.useCallback(T(h),[h]),Y=v.useCallback(T(y),[y]);return Object.assign({},m,{nodeRef:S},l&&{onEnter:z},s&&{onEntering:A},o&&{onEntered:k},f&&{onExit:$},d&&{onExiting:B},h&&{onExited:q},y&&{addEndListener:Y},{children:typeof g=="function"?(Z,J)=>g(Z,Object.assign({},J,{ref:w})):v.cloneElement(g,{ref:w})})}const Lw=["component"];function Uw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}const Hw=v.forwardRef((a,l)=>{let{component:s}=a,o=Uw(a,Lw);const f=Bw(o);return u.jsx(s,Object.assign({ref:l},f))});function Yw({in:a,onTransition:l}){const s=v.useRef(null),o=v.useRef(!0),f=kn(l);return ym(()=>{if(!s.current)return;let d=!1;return f({in:a,element:s.current,initial:o.current,isStale:()=>d}),()=>{d=!0}},[a,f]),ym(()=>(o.current=!1,()=>{o.current=!0}),[]),s}function qw({children:a,in:l,onExited:s,onEntered:o,transition:f}){const[d,h]=v.useState(!l);l&&d&&h(!1);const y=Yw({in:!!l,onTransition:m=>{const S=()=>{m.isStale()||(m.in?o?.(m.element,m.initial):(h(!0),s?.(m.element)))};Promise.resolve(f(m)).then(S,w=>{throw m.in||h(!0),w})}}),g=hs(y,Yi(a));return d&&!l?null:v.cloneElement(a,{ref:g})}function Em(a,l,s){return a?u.jsx(Hw,Object.assign({},s,{component:a})):l?u.jsx(qw,Object.assign({},s,{transition:l})):u.jsx(_w,Object.assign({},s))}const Gw=["show","role","className","style","children","backdrop","keyboard","onBackdropClick","onEscapeKeyDown","transition","runTransition","backdropTransition","runBackdropTransition","autoFocus","enforceFocus","restoreFocus","restoreFocusOptions","renderDialog","renderBackdrop","manager","container","onShow","onHide","onExit","onExited","onExiting","onEnter","onEntering","onEntered"];function Xw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}let lf;function Vw(a){return lf||(lf=new nd({ownerDocument:a?.document})),lf}function Qw(a){const l=td(),s=a||Vw(l),o=v.useRef({dialog:null,backdrop:null});return Object.assign(o.current,{add:()=>s.add(o.current),remove:()=>s.remove(o.current),isTopModal:()=>s.isTopModal(o.current),setDialogRef:v.useCallback(f=>{o.current.dialog=f},[]),setBackdropRef:v.useCallback(f=>{o.current.backdrop=f},[])})}const l2=v.forwardRef((a,l)=>{let{show:s=!1,role:o="dialog",className:f,style:d,children:h,backdrop:y=!0,keyboard:g=!0,onBackdropClick:m,onEscapeKeyDown:S,transition:w,runTransition:T,backdropTransition:z,runBackdropTransition:A,autoFocus:k=!0,enforceFocus:$=!0,restoreFocus:B=!0,restoreFocusOptions:q,renderDialog:Y,renderBackdrop:Z=Be=>u.jsx("div",Object.assign({},Be)),manager:J,container:L,onShow:V,onHide:Q=()=>{},onExit:W,onExited:ce,onExiting:de,onEnter:Ye,onEntering:ee,onEntered:ae}=a,xe=Xw(a,Gw);const _=td(),K=Nw(L),P=Qw(J),te=iw(),me=lw(s),[E,H]=v.useState(!s),F=v.useRef(null);v.useImperativeHandle(l,()=>P,[P]),us&&!me&&s&&(F.current=nf(_?.document)),s&&E&&H(!1);const I=kn(()=>{if(P.add(),Et.current=Io(document,"keydown",Ge),Ce.current=Io(document,"focus",()=>setTimeout(ue),!0),V&&V(),k){var Be,Ua;const Gi=nf((Be=(Ua=P.dialog)==null?void 0:Ua.ownerDocument)!=null?Be:_?.document);P.dialog&&Gi&&!vm(P.dialog,Gi)&&(F.current=Gi,P.dialog.focus())}}),re=kn(()=>{if(P.remove(),Et.current==null||Et.current(),Ce.current==null||Ce.current(),B){var Be;(Be=F.current)==null||Be.focus==null||Be.focus(q),F.current=null}});v.useEffect(()=>{!s||!K||I()},[s,K,I]),v.useEffect(()=>{E&&re()},[E,re]),Ow(()=>{re()});const ue=kn(()=>{if(!$||!te()||!P.isTopModal())return;const Be=nf(_?.document);P.dialog&&Be&&!vm(P.dialog,Be)&&P.dialog.focus()}),ye=kn(Be=>{Be.target===Be.currentTarget&&(m?.(Be),y===!0&&Q())}),Ge=kn(Be=>{g&&YS(Be)&&P.isTopModal()&&(S?.(Be),Be.defaultPrevented||Q())}),Ce=v.useRef(),Et=v.useRef(),Jt=(...Be)=>{H(!0),ce?.(...Be)};if(!K)return null;const dt=Object.assign({role:o,ref:P.setDialogRef,"aria-modal":o==="dialog"?!0:void 0},xe,{style:d,className:f,tabIndex:-1});let La=Y?Y(dt):u.jsx("div",Object.assign({},dt,{children:v.cloneElement(h,{role:"document"})}));La=Em(w,T,{unmountOnExit:!0,mountOnEnter:!0,appear:!0,in:!!s,onExit:W,onExiting:de,onExited:Jt,onEnter:Ye,onEntering:ee,onEntered:ae,children:La});let Bt=null;return y&&(Bt=Z({ref:P.setBackdropRef,onClick:ye}),Bt=Em(z,A,{in:!!s,appear:!0,mountOnEnter:!0,unmountOnExit:!0,children:Bt})),u.jsx(u.Fragment,{children:Ai.createPortal(u.jsxs(u.Fragment,{children:[Bt,La]}),K)})});l2.displayName="Modal";const Zw=Object.assign(l2,{Manager:nd});function Kw(a,l){return a.classList?a.classList.contains(l):(" "+(a.className.baseVal||a.className)+" ").indexOf(" "+l+" ")!==-1}function Jw(a,l){a.classList?a.classList.add(l):Kw(a,l)||(typeof a.className=="string"?a.className=a.className+" "+l:a.setAttribute("class",(a.className&&a.className.baseVal||"")+" "+l))}function Cm(a,l){return a.replace(new RegExp("(^|\\s)"+l+"(?:\\s|$)","g"),"$1").replace(/\s+/g," ").replace(/^\s*|\s*$/g,"")}function Fw(a,l){a.classList?a.classList.remove(l):typeof a.className=="string"?a.className=Cm(a.className,l):a.setAttribute("class",Cm(a.className&&a.className.baseVal||"",l))}const zi={FIXED_CONTENT:".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",STICKY_CONTENT:".sticky-top",NAVBAR_TOGGLER:".navbar-toggler"};class r2 extends nd{adjustAndStore(l,s,o){const f=s.style[l];s.dataset[l]=f,_n(s,{[l]:`${parseFloat(_n(s,l))+o}px`})}restore(l,s){const o=s.dataset[l];o!==void 0&&(delete s.dataset[l],_n(s,{[l]:o}))}setContainerStyle(l){super.setContainerStyle(l);const s=this.getElement();if(Jw(s,"modal-open"),!l.scrollBarWidth)return;const o=this.isRTL?"paddingLeft":"paddingRight",f=this.isRTL?"marginLeft":"marginRight";Da(s,zi.FIXED_CONTENT).forEach(d=>this.adjustAndStore(o,d,l.scrollBarWidth)),Da(s,zi.STICKY_CONTENT).forEach(d=>this.adjustAndStore(f,d,-l.scrollBarWidth)),Da(s,zi.NAVBAR_TOGGLER).forEach(d=>this.adjustAndStore(f,d,l.scrollBarWidth))}removeContainerStyle(l){super.removeContainerStyle(l);const s=this.getElement();Fw(s,"modal-open");const o=this.isRTL?"paddingLeft":"paddingRight",f=this.isRTL?"marginLeft":"marginRight";Da(s,zi.FIXED_CONTENT).forEach(d=>this.restore(o,d)),Da(s,zi.STICKY_CONTENT).forEach(d=>this.restore(f,d)),Da(s,zi.NAVBAR_TOGGLER).forEach(d=>this.restore(f,d))}}let rf;function Ww(a){return rf||(rf=new r2(a)),rf}const o2=v.createContext({onHide(){}}),s2=v.forwardRef(({closeLabel:a="Close",closeVariant:l,closeButton:s=!1,onHide:o,children:f,...d},h)=>{const y=v.useContext(o2),g=ds(()=>{y?.onHide(),o?.()});return u.jsxs("div",{ref:h,...d,children:[f,s&&u.jsx(If,{"aria-label":a,variant:l,onClick:g})]})});s2.displayName="AbstractModalHeader";const c2=v.forwardRef(({className:a,bsPrefix:l,as:s="div",...o},f)=>(l=jt(l,"nav-item"),u.jsx(s,{ref:f,className:it(a,l),...o})));c2.displayName="NavItem";const u2=v.forwardRef(({bsPrefix:a,className:l,as:s=Fg,active:o,eventKey:f,disabled:d=!1,...h},y)=>{a=jt(a,"nav-link");const[g,m]=n2({key:Pf(f,h.href),active:o,disabled:d,...h});return u.jsx(s,{...h,...g,ref:y,disabled:d,className:it(l,a,d&&"disabled",m.isActive&&"active")})});u2.displayName="NavLink";const f2=v.forwardRef((a,l)=>{const{as:s="div",bsPrefix:o,variant:f,fill:d=!1,justify:h=!1,navbar:y,navbarScroll:g,className:m,activeKey:S,...w}=Gg(a,{activeKey:"onSelect"}),T=jt(o,"nav");let z,A,k=!1;const $=v.useContext(qi),B=v.useContext(Ig);return $?(z=$.bsPrefix,k=y??!0):B&&({cardHeaderBsPrefix:A}=B),u.jsx(Aw,{as:s,ref:l,activeKey:S,className:it(m,{[T]:!k,[`${z}-nav`]:k,[`${z}-nav-scroll`]:k&&g,[`${A}-${f}`]:!!A,[`${T}-${f}`]:!!f,[`${T}-fill`]:d,[`${T}-justified`]:h}),...w})});f2.displayName="Nav";const Iw=Object.assign(f2,{Item:c2,Link:u2}),d2=v.forwardRef(({bsPrefix:a,className:l,as:s,...o},f)=>{a=jt(a,"navbar-brand");const d=s||(o.href?"a":"span");return u.jsx(d,{...o,ref:f,className:it(l,a)})});d2.displayName="NavbarBrand";const p2=v.forwardRef(({children:a,bsPrefix:l,...s},o)=>{l=jt(l,"navbar-collapse");const f=v.useContext(qi);return u.jsx(Zg,{in:!!(f&&f.expanded),...s,children:u.jsx("div",{ref:o,className:l,children:a})})});p2.displayName="NavbarCollapse";const h2=v.forwardRef(({bsPrefix:a,className:l,children:s,label:o="Toggle navigation",as:f="button",onClick:d,...h},y)=>{a=jt(a,"navbar-toggler");const{onToggle:g,expanded:m}=v.useContext(qi)||{},S=ds(w=>{d&&d(w),g&&g()});return f==="button"&&(h.type="button"),u.jsx(f,{...h,ref:y,onClick:S,"aria-label":o,className:it(l,a,!m&&"collapsed"),children:s||u.jsx("span",{className:`${a}-icon`})})});h2.displayName="NavbarToggle";const Af=new WeakMap,Tm=(a,l)=>{if(!a||!l)return;const s=Af.get(l)||new Map;Af.set(l,s);let o=s.get(a);return o||(o=l.matchMedia(a),o.refCount=0,s.set(o.media,o)),o};function Pw(a,l=typeof window>"u"?void 0:window){const s=Tm(a,l),[o,f]=v.useState(()=>s?s.matches:!1);return jw(()=>{let d=Tm(a,l);if(!d)return f(!1);let h=Af.get(l);const y=()=>{f(d.matches)};return d.refCount++,d.addListener(y),y(),()=>{d.removeListener(y),d.refCount--,d.refCount<=0&&h?.delete(d.media),d=void 0}},[a]),o}function e7(a){const l=Object.keys(a);function s(y,g){return y===g?g:y?`${y} and ${g}`:g}function o(y){return l[Math.min(l.indexOf(y)+1,l.length-1)]}function f(y){const g=o(y);let m=a[g];return typeof m=="number"?m=`${m-.2}px`:m=`calc(${m} - 0.2px)`,`(max-width: ${m})`}function d(y){let g=a[y];return typeof g=="number"&&(g=`${g}px`),`(min-width: ${g})`}function h(y,g,m){let S;typeof y=="object"?(S=y,m=g,g=!0):(g=g||!0,S={[y]:g});let w=v.useMemo(()=>Object.entries(S).reduce((T,[z,A])=>((A==="up"||A===!0)&&(T=s(T,d(z))),(A==="down"||A===!0)&&(T=s(T,f(z))),T),""),[JSON.stringify(S)]);return Pw(w,m)}return h}const t7=e7({xs:0,sm:576,md:768,lg:992,xl:1200,xxl:1400}),m2=v.forwardRef(({className:a,bsPrefix:l,as:s="div",...o},f)=>(l=jt(l,"offcanvas-body"),u.jsx(s,{ref:f,className:it(a,l),...o})));m2.displayName="OffcanvasBody";const n7={[Pt]:"show",[On]:"show"},g2=v.forwardRef(({bsPrefix:a,className:l,children:s,in:o=!1,mountOnEnter:f=!1,unmountOnExit:d=!1,appear:h=!1,...y},g)=>(a=jt(a,"offcanvas"),u.jsx(fs,{ref:g,addEndListener:Wf,in:o,mountOnEnter:f,unmountOnExit:d,appear:h,...y,childRef:Yi(s),children:(m,S)=>v.cloneElement(s,{...S,className:it(l,s.props.className,(m===Pt||m===Ql)&&`${a}-toggling`,n7[m])})})));g2.displayName="OffcanvasToggling";const x2=v.forwardRef(({bsPrefix:a,className:l,closeLabel:s="Close",closeButton:o=!1,...f},d)=>(a=jt(a,"offcanvas-header"),u.jsx(s2,{ref:d,...f,className:it(l,a),closeLabel:s,closeButton:o})));x2.displayName="OffcanvasHeader";const a7=nw("h5"),y2=v.forwardRef(({className:a,bsPrefix:l,as:s=a7,...o},f)=>(l=jt(l,"offcanvas-title"),u.jsx(s,{ref:f,className:it(a,l),...o})));y2.displayName="OffcanvasTitle";function i7(a){return u.jsx(g2,{...a})}function l7(a){return u.jsx(Wg,{...a})}const v2=v.forwardRef(({bsPrefix:a,className:l,children:s,"aria-labelledby":o,placement:f="start",responsive:d,show:h=!1,backdrop:y=!0,keyboard:g=!0,scroll:m=!1,onEscapeKeyDown:S,onShow:w,onHide:T,container:z,autoFocus:A=!0,enforceFocus:k=!0,restoreFocus:$=!0,restoreFocusOptions:B,onEntered:q,onExit:Y,onExiting:Z,onEnter:J,onEntering:L,onExited:V,backdropClassName:Q,manager:W,renderStaticNode:ce=!1,...de},Ye)=>{const ee=v.useRef();a=jt(a,"offcanvas");const[ae,xe]=v.useState(!1),_=ds(T),K=t7(d||"xs","up");v.useEffect(()=>{xe(d?h&&!K:h)},[h,d,K]);const P=v.useMemo(()=>({onHide:_}),[_]);function te(){return W||(m?(ee.current||(ee.current=new r2({handleContainerOverflow:!1})),ee.current):Ww())}const me=(I,...re)=>{I&&(I.style.visibility="visible"),J?.(I,...re)},E=(I,...re)=>{I&&(I.style.visibility=""),V?.(...re)},H=v.useCallback(I=>u.jsx("div",{...I,className:it(`${a}-backdrop`,Q)}),[Q,a]),F=I=>u.jsx("div",{...I,...de,className:it(l,d?`${a}-${d}`:a,`${a}-${f}`),"aria-labelledby":o,children:s});return u.jsxs(u.Fragment,{children:[!ae&&(d||ce)&&F({}),u.jsx(o2.Provider,{value:P,children:u.jsx(Zw,{show:ae,ref:Ye,backdrop:y,container:z,keyboard:g,autoFocus:A,enforceFocus:k&&!m,restoreFocus:$,restoreFocusOptions:B,onEscapeKeyDown:S,onShow:w,onHide:_,onEnter:me,onEntering:L,onEntered:q,onExit:Y,onExiting:Z,onExited:E,manager:te(),transition:i7,backdropTransition:l7,renderBackdrop:H,renderDialog:F})})]})});v2.displayName="Offcanvas";const r7=Object.assign(v2,{Body:m2,Header:x2,Title:y2}),b2=v.forwardRef(({onHide:a,...l},s)=>{const o=v.useContext(qi),f=ds(()=>{o==null||o.onToggle==null||o.onToggle(),a?.()});return u.jsx(r7,{ref:s,show:!!(o!=null&&o.expanded),...l,renderStaticNode:!0,onHide:f})});b2.displayName="NavbarOffcanvas";const S2=v.forwardRef(({className:a,bsPrefix:l,as:s="span",...o},f)=>(l=jt(l,"navbar-text"),u.jsx(s,{ref:f,className:it(a,l),...o})));S2.displayName="NavbarText";const w2=v.forwardRef((a,l)=>{const{bsPrefix:s,expand:o=!0,variant:f="light",bg:d,fixed:h,sticky:y,className:g,as:m="nav",expanded:S,onToggle:w,onSelect:T,collapseOnSelect:z=!1,...A}=Gg(a,{expanded:"onToggle"}),k=jt(s,"navbar"),$=v.useCallback((...Y)=>{T?.(...Y),z&&S&&w?.(!1)},[T,z,S,w]);A.role===void 0&&m!=="nav"&&(A.role="navigation");let B=`${k}-expand`;typeof o=="string"&&(B=`${B}-${o}`);const q=v.useMemo(()=>({onToggle:()=>w?.(!S),bsPrefix:k,expanded:!!S,expand:o}),[k,S,o,w]);return u.jsx(qi.Provider,{value:q,children:u.jsx(Po.Provider,{value:$,children:u.jsx(m,{ref:l,...A,className:it(g,k,o&&B,f&&`${k}-${f}`,d&&`bg-${d}`,y&&`sticky-${y}`,h&&`fixed-${h}`)})})})});w2.displayName="Navbar";const o7=Object.assign(w2,{Brand:d2,Collapse:p2,Offcanvas:b2,Text:S2,Toggle:h2});function s7(a){return Ee({attr:{viewBox:"0 0 15 15",fill:"none"},child:[{tag:"path",attr:{fillRule:"evenodd",clipRule:"evenodd",d:"M1.5 3C1.22386 3 1 3.22386 1 3.5C1 3.77614 1.22386 4 1.5 4H13.5C13.7761 4 14 3.77614 14 3.5C14 3.22386 13.7761 3 13.5 3H1.5ZM1 7.5C1 7.22386 1.22386 7 1.5 7H13.5C13.7761 7 14 7.22386 14 7.5C14 7.77614 13.7761 8 13.5 8H1.5C1.22386 8 1 7.77614 1 7.5ZM1 11.5C1 11.2239 1.22386 11 1.5 11H13.5C13.7761 11 14 11.2239 14 11.5C14 11.7761 13.7761 12 13.5 12H1.5C1.22386 12 1 11.7761 1 11.5Z",fill:"currentColor"},child:[]}]})(a)}function j2(a){return Ee({attr:{viewBox:"0 0 256 256",fill:"currentColor"},child:[{tag:"path",attr:{d:"M236,172a40,40,0,0,1-80,0V76H100V200a12,12,0,0,1-24,0V76H72a36,36,0,0,0-36,36,12,12,0,0,1-24,0A60.07,60.07,0,0,1,72,52H224a12,12,0,0,1,0,24H180v96a16,16,0,0,0,32,0,12,12,0,0,1,24,0Z"},child:[]}]})(a)}const c7=b(o7)`
...
`,x7=b.div`
  ...
  line-height: 1;
`;function y7(){const a=()=>{console.log("Toggled theme")};return u.jsx("div",{className:"topbar-wrapper",children:u.jsx(c7,{className:"shadow-sm d-lg-none",children:u.jsx(Pg,{fluid:!0,className:"px-3",children:u.jsxs(u7,{children:[u.jsx(f7,{children:u.jsxs(m7,{to:"/instalearn/","aria-label":"Go to home",children:[u.jsx("div",{children:u.jsx(g7,{"aria-hidden":"true"})}),u.jsx(x7,{children:"Learn"})]})}),u.jsx(d7,{}),u.jsx(p7,{children:u.jsx(h7,{type:"button",onClick:a,"aria-label":"Toggle",children:u.jsx(s7,{size:20})})})]})})})})}const v7=$t`
...
`,C7=$n`
  ...
  &::before {
    ...
    animation: ${v7} 4s linear infinite;
...
`;function z7(){const{pathname:a}=Ln(),l=[{to:"/instalearn/",icon:u.jsx(Ag,{}),label:"Home"},{to:"/instalearn/teacher",icon:u.jsx(cs,{}),label:"Teacher"},{to:"/instalearn/library",icon:u.jsx(Rg,{}),label:"Library",hasNotification:!0},{to:"/instalearn/notifications",icon:u.jsx(D5,{}),label:"Notifications"},{to:"/instalearn/profile",icon:u.jsx(Mg,{}),label:"Profile"}];return u.jsxs(b7,{children:[u.jsxs(S7,{to:"/instalearn/",children:[u.jsx("div",{children:u.jsx(w7,{"aria-hidden":"true"})}),u.jsx(j7,{children:"Learn"})]}),u.jsxs(E7,{children:[l.slice(0,-1).map(s=>u.jsxs(of,{to:s.to,$active:a===s.to,children:[u.jsx(sf,{children:s.icon}),u.jsx(cf,{children:s.label}),s.hasNotification]},s.to)),u.jsxs(of,{to:l[l.length-1].to,$active:a===l[l.length-1].to,children:[u.jsx(sf,{children:l[l.length-1].icon}),u.jsx(cf,{children:l[l.length-1].label})]})]}),u.jsx(T7,{children:u.jsxs(of,{to:"/instalearn/more",$active:a==="/instalearn/more",children:[u.jsx(sf,{children:u.jsx($5,{})}),u.jsx(cf,{children:"More"})]})})]})}const R7=b.div`
  width: 100%;
  height: 100%;
  padding: 24px 16px;
  overflow-y: auto;
...
`;const Q7=({sidebarWidth:a=360})=>{const l={username:"demo_user",name:"Demo User",initials:"DU"},s=[{icon:N1,gradient:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",title:"New Feature: Dark Mode",description:"Enable dark mode for a better night-time experience.",badge:"New",badgeBg:"linear-gradient(135deg, #667eea, #764ba2)"},{icon:B5,gradient:"linear-gradient(135deg, #f093fb 0%, #f5576c 100%)",title:"Product Tip: Quick Search",description:"Use the search bar to find items faster.",badge:"Tip",badgeBg:"linear-gradient(135deg, #f093fb, #f5576c)"},{icon:N5,gradient:"linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)",title:"Update: Version 2.0",description:"Check out the latest improvements and bug fixes.",badge:"Update",badgeBg:"linear-gradient(135deg, #4facfe, #00f2fe)"}];return u.jsxs(R7,{children:[u.jsx(A7,{children:u.jsxs(E2,{$width:a,children:[u.jsxs(M7,{children:[u.jsx(O7,{$width:a,children:l.initials}),u.jsx(k7,{$width:a})]}),u.jsxs(N7,{$width:a,children:[u.jsx(_7,{$width:a,children:l.username}),u.jsx(D7,{$width:a,children:l.name})]})]})}),u.jsxs($7,{children:[u.jsxs(B7,{$width:a,$iconColor:"#667eea",children:[u.jsx(N1,{}),u.jsx("span",{children:"Highlights"})]}),u.jsx(L7,{$width:a,children:"See All"})]}),u.jsx(U7,{$width:a,children:s.map((o,f)=>{const d=o.icon;return u.jsxs(C2,{$width:a,$glowColor:o.gradient,children:[u.jsx(V7,{$width:a,$bg:o.badgeBg,children:o.badge}),u.jsxs(Y7,{$width:a,children:[u.jsx(H7,{$width:a,$gradient:o.gradient,children:u.jsx(d,{})}),u.jsxs(q7,{children:[u.jsx(G7,{$width:a,children:o.title}),u.jsx(X7,{$width:a,children:o.description})]})]})]},f)})})]})};function Z7(){const{pathname:a}=Ln(),l=[["/instalearn/",u.jsx(Ag,{})],["/instalearn/teacher",u.jsx(cs,{})],["/instalearn/library",u.jsx(Rg,{})],["/instalearn/profile",u.jsx(Mg,{})]];return u.jsxs(u.Fragment,{children:[u.jsx("style",{children:`
        @keyframes shine {
          0% { background-position: 0% 50%; }
          50% { background-position: 100% 50%; }
          100% { background-position: 0% 50%; }
      ...
      `}),u.jsx(Iw,{className:"bottom-nav fixed-bottom d-flex justify-content-around py-2 d-lg-none",children:l.map(([s,o])=>u.jsx(Ui,{to:s,className:`nav-link fs-4 text-white ${a===s?"active":""}`,children:o},s))})]})}const uf="studentProfile",ht=Hg,K7=b.div`
  max-width: 1120px;
  margin: 0 auto;
  background: #fff;
  min-height: 100vh;
...
`,I7=b.div` position: relative; `,P7=b.img`
...
`,o9=b.div`
  ...
  @media (min-width: 768px) { font-size: 1rem; }
`,s9=b.div` display: flex; gap: 0.5rem; margin-bottom: 1.5rem; `,c9=b.button`
...
`,d9=b.div` position: relative; display: inline-block; `,p9=b.div`
...
`,x9=b.div` margin-bottom: 1.5rem; `,y9=b.div`
...
`,E9=b.div` display: flex; border-top: 1px solid #e5e7eb; `,Rm=b.button`
...
`,km=b.h3` margin: 0; font-size: 1rem; font-weight: 700; color: #111827; `,Nm=b.button` border: 1px solid #e5e7eb; background: #fff; border-radius: 8px; padding: 0.25rem; `,A9=b.div`
...
`,k9=b.div` padding: 1rem 1.25rem; display: grid; gap: 0.75rem; `,ff=b.div` display: grid; gap: 0.25rem; `,df=b.label` font-size: 0.85rem; color: #374151; `,pf=b.input`
...
`,N9=b.div` display:flex; justify-content:flex-end; gap:0.5rem; padding:0.75rem 1.25rem 1rem; `;function _9(){v.useEffect(()=>{window.scrollTo({top:0,left:0,behavior:"auto"})},[]);const a=ts(),[l,s]=v.useState(!1),[o,f]=v.useState("basic"),[d,h]=v.useState(!1),[y,g]=v.useState(!1),[m,S]=v.useState(!1),[w,T]=v.useState(!1),[z,A]=v.useState({name:"",email:"",avatar:""}),k=3,$=3,B=`joined:${ht?.id||ht?.name}`;v.useEffect(()=>{const W=localStorage.getItem(B)==="true";g(W);const ce=localStorage.getItem(uf);if(ce){const de=JSON.parse(ce);A({name:de.name||"",email:de.email||"",avatar:de.avatar||""})}},[]),v.useEffect(()=>{localStorage.setItem(B,y?"true":"false")},[y,B]),v.useEffect(()=>{if(!m)return;const W=ce=>{const de=ce.target;de.closest&&(de.closest('[aria-haspopup="menu"]')||de.closest('[role="menu"]'))||S(!1)};return document.addEventListener("click",W),()=>document.removeEventListener("click",W)},[m]);const q=W=>{if(!y&&W>=k){s(!0);return}W===0&&a("/instalearn/library")},Y=()=>{y||s(!0)},Z=async()=>{h(!0),await new Promise(W=>setTimeout(W,1200)),h(!1),s(!1),T(!0)},J=()=>{const W={name:z.name?.trim(),email:z.email?.trim(),avatar:z.avatar?.trim(),createdAt:new Date().toISOString(),plan:o,isPro:!0};if(!W.name||!W.email){alert("Please fill Name and Email to continue.");return}localStorage.setItem(uf,JSON.stringify(W)),g(!0),T(!1)},L=()=>{localStorage.removeItem(B),localStorage.removeItem(uf),g(!1),S(!1)},V=[{key:"basic",name:"Basic",price:"₹0",desc:"Demo access: 3 lessons"},{key:"pro",name:"Pro",price:"₹99",desc:"Monthly: full library"},{key:"team",name:"Team",price:"₹1,99",desc:"Up to 10 students"}],Q=y;return u.jsxs(K7,{children:[u.jsxs(J7,{children:[u.jsxs(F7,{children:[u.jsxs(W7,{children:[u.jsxs(I7,{children:[u.jsx(P7,{src:ht.avatar,alt:ht.name}),!y&&u.jsxs(e9,{"aria-hidden":"true",title:"Pro library locked",children:[u.jsx(Co,{size:12})," LOCKED"]})]}),u.jsxs(t9,{children:[u.jsxs(Ri,{children:[ht.concepts," ",u.jsx("span",{children:"concepts"})]}),u.jsxs(Ri,{children:[ht.students," ",u.jsx("span",{children:"students"})]}),u.jsxs(Ri,{children:[ht.learns," ",u.jsx("span",{children:"learns"})]})]})]}),u.jsxs(a9,{children:[u.jsxs(n9,{children:[u.jsxs(Ri,{children:[ht.concepts," ",u.jsx("span",{children:"concepts"})]}),u.jsxs(Ri,{children:[ht.students," ",u.jsx("span",{children:"students"})]}),u.jsxs(Ri,{children:[ht.learns," ",u.jsx("span",{children:"learns"})]})]}),u.jsx(i9,{children:ht.name}),u.jsx(l9,{children:ht.subject}),u.jsx(r9,{children:ht.bio}),u.jsxs(o9,{children:["🎓 ",ht.experience," years experience"]}),u.jsxs(s9,{children:[u.jsx(c9,{onClick:()=>a("/user/profile"),children:"Follow"}),u.jsx(u9,{onClick:Y,disabled:d,"data-joined":y,"aria-pressed":y,"aria-label":y?"Joined":"Join",title:y?"You're in!":"Join this teacher",children:y?u.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:8},children:[u.jsx(Bg,{size:18})," Joined"]}):d?"Processing…":"Join"}),u.jsxs(d9,{children:[u.jsx(f9,{"aria-haspopup":"menu","aria-expanded":m,"aria-label":"More options",onClick:()=>S(W=>!W),title:"More options",children:"▼"}),m&&u.jsxs(p9,{role:"menu",children:[y&&u.jsxs(zm,{role:"menuitem","data-danger":"true",onClick:L,title:"Cancel your membership",children:[u.jsx(qu,{size:16})," Cancel membership"]}),u.jsx(zm,{role:"menuitem",onClick:()=>S(!1),children:"Close"})]})]})]}),u.jsxs(h9,{hidden:Q,role:"note","aria-live":"polite",children:[u.jsxs(m9,{children:[u.jsx(Co,{size:18})," Pro library locked — get full access to all concepts & posts."]}),u.jsx(g9,{onClick:()=>s(!0),"aria-label":"Unlock full library",children:"Unlock"})]})]})]}),u.jsx(x9,{children:u.jsx(y9,{children:ht.bookList.map((W,ce)=>{const de=!y&&ce>=k;return u.jsxs(v9,{onClick:()=>q(ce),"aria-disabled":de,title:de?"Join to unlock":`Open ${W.title}`,children:[u.jsxs(S9,{$locked:de,children:[u.jsx(w9,{children:u.jsx(Wo,{size:24})}),!y&&de&&u.jsxs(b9,{"aria-hidden":"true",children:[u.jsx(Co,{size:14,style:{marginRight:6}})," Locked"]})]}),u.jsx(j9,{children:W.title})]},ce)})})})]}),u.jsxs(E9,{children:[u.jsx(Rm,{$active:!0,children:u.jsx(m6,{size:20})}),u.jsx(Rm,{children:u.jsx(i6,{size:20})})]}),u.jsx(C9,{"aria-label":"Teacher posts",children:Array(9).fill(null).map((W,ce)=>{const de=!y&&ce>=$;return u.jsxs(T9,{$locked:de,"aria-hidden":!1,children:[u.jsx(Wo,{size:24}),de&&u.jsxs(z9,{children:[u.jsx(Co,{size:16,style:{marginRight:6}})," Join to view"]})]},ce)})}),u.jsx(R9,{hidden:y,onClick:()=>s(!0),"aria-label":"Unlock all posts",children:"Unlock entire library"}),l&&u.jsx(Am,{role:"dialog","aria-modal":"true","aria-labelledby":"pricing-title",children:u.jsxs(Mm,{children:[u.jsxs(Om,{children:[u.jsx(km,{id:"pricing-title",children:"Choose your plan"}),u.jsx(Nm,{onClick:()=>s(!1),"aria-label":"Close pricing",children:u.jsx(qu,{size:18})})]}),u.jsx(A9,{children:V.map(W=>u.jsxs(M9,{onClick:()=>f(W.key),$active:o===W.key,"aria-pressed":o===W.key,children:[u.jsx("h4",{children:W.name}),u.jsx("strong",{children:W.price}),u.jsx("p",{children:W.desc})]},W.key))}),u.jsxs(O9,{children:[u.jsx(Dm,{onClick:()=>s(!1),children:"Not now"}),u.jsx(_m,{onClick:Z,disabled:d,children:d?"Processing payment…":"Demo Pay"})]})]})}),w&&u.jsx(Am,{role:"dialog","aria-modal":"true","aria-labelledby":"profile-form-title",children:u.jsxs(Mm,{children:[u.jsxs(Om,{children:[u.jsx(km,{id:"profile-form-title",children:"Create your student profile"}),u.jsx(Nm,{onClick:()=>T(!1),"aria-label":"Close profile form",children:u.jsx(qu,{size:18})})]}),u.jsxs(k9,{children:[u.jsxs(ff,{children:[u.jsx(df,{htmlFor:"pf-name",children:"Full Name"}),u.jsx(pf,{id:"pf-name",value:z.name,onChange:W=>A(ce=>({...ce,name:W.target.value})),placeholder:"e.g., Priya Sharma"})]}),u.jsxs(ff,{children:[u.jsx(df,{htmlFor:"pf-email",children:"Email"}),u.jsx(pf,{id:"pf-email",type:"email",value:z.email,onChange:W=>A(ce=>({...ce,email:W.target.value})),placeholder:"you@example.com"})]}),u.jsxs(ff,{children:[u.jsx(df,{htmlFor:"pf-avatar",children:"Avatar initials (optional)"}),u.jsx(pf,{id:"pf-avatar",value:z.avatar,onChange:W=>A(ce=>({...ce,avatar:W.target.value})),placeholder:"PS"})]})]}),u.jsxs(N9,{children:[u.jsx(Dm,{onClick:()=>T(!1),children:"Cancel"}),u.jsx(_m,{onClick:J,children:"Save & Finish"})]})]})})]})}const D9=b.div`
  display: flex;
  min-height: 100vh;
...
`;function G9(){const[a,l]=v.useState(360),[s,o]=v.useState(!1),f=v.useRef(null),d=350,h=600,y=g=>{g.preventDefault(),o(!0),f.current={startX:g.clientX,startWidth:a}};return v.useEffect(()=>{const g=(w,T,z)=>Math.min(Math.max(w,T),z),m=w=>{if(!s||!f.current)return;const{startX:T,startWidth:z}=f.current,A=T-w.clientX,k=g(z+A,d,h);l(k)},S=()=>{s&&(o(!1),f.current=null)};return s&&(document.addEventListener("mousemove",m),document.addEventListener("mouseup",S),document.body.style.cursor="ew-resize",document.body.style.userSelect="none"),()=>{document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",S),document.body.style.cursor="",document.body.style.userSelect=""}},[s]),u.jsxs(D9,{children:[u.jsx($9,{children:u.jsx(z7,{})}),u.jsxs(B9,{children:[u.jsxs(L9,{$sidebarWidth:a,$isResizing:s,children:[u.jsx(Y9,{children:u.jsx(y7,{})}),u.jsxs(Zv,{children:[u.jsx(_a,{path:"/instalearn",element:u.jsx(j8,{})}),u.jsx(_a,{path:"/instalearn/teacher",element:u.jsx(_9,{})}),u.jsx(_a,{path:"/instalearn/library",element:u.jsx(Q3,{})}),u.jsx(_a,{path:"/instalearn/notifications",element:u.jsx(cm,{})}),u.jsx(_a,{path:"/instalearn/more",element:u.jsx(cm,{})}),u.jsx(_a,{path:"/instalearn/profile",element:u.jsx(lS,{})})]})]}),u.jsxs(U9,{$width:a,$isResizing:s,children:[u.jsx(H9,{className:s?"active":"",onMouseDown:y,"aria-label":"Resize sidebar"}),u.jsx(Q7,{})]})]}),u.jsx(q9,{children:u.jsx(Z7,{})})]})}av.createRoot(document.getElementById("root")).render(u.jsx(gb,{children:u.jsx(G9,{})}));
