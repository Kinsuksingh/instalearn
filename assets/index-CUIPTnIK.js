 ...
 */var a1;function Ky(){if(a1)return $l;a1=1;var a=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function s(o,f,d){var h=null;if(d!==void 0&&(h=""+d),f.key!==void 0&&(h=""+f.key),"key"in f){d={};for(var y in f)y!=="key"&&(d[y]=f[y])}else d=f;return f=d.ref,{$$typeof:a,type:o,key:h,ref:f!==void 0?f:null,props:d}}return $l.Fragment=l,$l.jsx=s,$l.jsxs=s,$l}var i1;function Jy(){return i1||(i1=1,Mu.exports=Ky()),Mu.exports}var u=Jy(),Ou={exports:{}},fe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 *
 * @license MIT
 */var p1="popstate";function iv(a={}){function l(o,f){let{pathname:d,search:h,hash:y}=o.location;return hf("",{pathname:d,search:h,hash:y},f.state&&f.state.usr||null,f.state&&f.state.key||"default")}function s(o,f){return typeof f=="string"?f:Gl(f)}return rv(l,s,null,a)}function Xe(a,l){if(a===!1||a===null||typeof a>"u")throw new Error(l)}function cn(a,l){if(!a){typeof console<"u"&&console.warn(l);try{throw new Error(l)}catch{}}}function lv(){return Math.random().toString(36).substring(2,10)}function h1(a,l){return{usr:a.state,key:a.key,idx:l}}function hf(a,l,s=null,o){return{pathname:typeof a=="string"?a:a.pathname,search:"",hash:"",...typeof l=="string"?Bi(l):l,state:s,key:l&&l.key||o||lv()}}function Gl({pathname:a="/",search:l="",hash:s=""}){return l&&l!=="?"&&(a+=l.charAt(0)==="?"?l:"?"+l),s&&s!=="#"&&(a+=s.charAt(0)==="#"?s:"#"+s),a}function Bi(a){let l={};if(a){let s=a.indexOf("#");s>=0&&(l.hash=a.substring(s),a=a.substring(0,s));let o=a.indexOf("?");o>=0&&(l.search=a.substring(o),a=a.substring(0,o)),a&&(l.pathname=a)}return l}function rv(a,l,s,o={}){let{window:f=document.defaultView,v5Compat:d=!1}=o,h=f.history,y="POP",g=null,m=S();m==null&&(m=0,h.replaceState({...h.state,idx:m},""));function S(){return(h.state||{idx:null}).idx}function w(){y="POP";let $=S(),B=$==null?null:$-m;m=$,g&&g({action:y,location:k.location,delta:B})}function T($,B){y="PUSH";let q=hf(k.location,$,B);m=S()+1;let Y=h1(q,m),Z=k.createHref(q);try{h.pushState(Y,"",Z)}catch(J){if(J instanceof DOMException&&J.name==="DataCloneError")throw J;f.location.assign(Z)}d&&g&&g({action:y,location:k.location,delta:1})}function z($,B){y="REPLACE";let q=hf(k.location,$,B);m=S();let Y=h1(q,m),Z=k.createHref(q);h.replaceState(Y,"",Z),d&&g&&g({action:y,location:k.location,delta:0})}function A($){return ov($)}let k={get action(){return y},get location(){return a(f,h)},listen($){if(g)throw new Error("A history only accepts one active listener");return f.addEventListener(p1,w),g=$,()=>{f.removeEventListener(p1,w),g=null}},createHref($){return l(f,$)},createURL:A,encodeLocation($){let B=A($);return{pathname:B.pathname,search:B.search,hash:B.hash}},push:T,replace:z,go($){return h.go($)}};return k}function ov(a,l=!1){let s="http://localhost";typeof window<"u"&&(s=window.location.origin!=="null"?window.location.origin:window.location.href),Xe(s,"No window.location.(origin|href) available to create URL");let o=typeof a=="string"?a:Gl(a);return o=o.replace(/ $/,"%20"),!l&&o.startsWith("//")&&(o=s+o),new URL(o,s)}function Bm(a,l,s="/"){return sv(a,l,s,!1)}function sv(a,l,s,o){let f=typeof l=="string"?Bi(l):l,d=Dn(f.pathname||"/",s);if(d==null)return null;let h=Lm(a);cv(h);let y=null;for(let g=0;y==null&&g<h.length;++g){let m=bv(d);y=yv(h[g],m,o)}return y}function Lm(a,l=[],s=[],o="",f=!1){let d=(h,y,g=f,m)=>{let S={relativePath:m===void 0?h.path||"":m,caseSensitive:h.caseSensitive===!0,childrenIndex:y,route:h};if(S.relativePath.startsWith("/")){if(!S.relativePath.startsWith(o)&&g)return;Xe(S.relativePath.startsWith(o),`Absolute route path "${S.relativePath}" nested under path "${o}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),S.relativePath=S.relativePath.slice(o.length)}let w=Nn([o,S.relativePath]),T=s.concat(S);h.children&&h.children.length>0&&(Xe(h.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${w}".`),Lm(h.children,l,T,w,g)),!(h.path==null&&!h.index)&&l.push({path:w,score:gv(w,h.index),routesMeta:T})};return a.forEach((h,y)=>{if(h.path===""||!h.path?.includes("?"))d(h,y);else for(let g of Um(h.path))d(h,y,!0,g)}),l}function Um(a){let l=a.split("/");if(l.length===0)return[];let[s,...o]=l,f=s.endsWith("?"),d=s.replace(/\?$/,"");if(o.length===0)return f?[d,""]:[d];let h=Um(o.join("/")),y=[];return y.push(...h.map(g=>g===""?d:[d,g].join("/"))),f&&y.push(...h),y.map(g=>a.startsWith("/")&&g===""?"/":g)}function cv(a){a.sort((l,s)=>l.score!==s.score?s.score-l.score:xv(l.routesMeta.map(o=>o.childrenIndex),s.routesMeta.map(o=>o.childrenIndex)))}var uv=/^:[\w-]+$/,fv=3,dv=2,pv=1,hv=10,mv=-2,m1=a=>a==="*";function gv(a,l){let s=a.split("/"),o=s.length;return s.some(m1)&&(o+=mv),l&&(o+=dv),s.filter(f=>!m1(f)).reduce((f,d)=>f+(uv.test(d)?fv:d===""?pv:hv),o)}function xv(a,l){return a.length===l.length&&a.slice(0,-1).every((o,f)=>o===l[f])?a[a.length-1]-l[l.length-1]:0}function yv(a,l,s=!1){let{routesMeta:o}=a,f={},d="/",h=[];for(let y=0;y<o.length;++y){let g=o[y],m=y===o.length-1,S=d==="/"?l:l.slice(d.length)||"/",w=Go({path:g.relativePath,caseSensitive:g.caseSensitive,end:m},S),T=g.route;if(!w&&m&&s&&!o[o.length-1].route.index&&(w=Go({path:g.relativePath,caseSensitive:g.caseSensitive,end:!1},S)),!w)return null;Object.assign(f,w.params),h.push({params:f,pathname:Nn([d,w.pathname]),pathnameBase:Ev(Nn([d,w.pathnameBase])),route:T}),w.pathnameBase!=="/"&&(d=Nn([d,w.pathnameBase]))}return h}function Go(a,l){typeof a=="string"&&(a={path:a,caseSensitive:!1,end:!0});let[s,o]=vv(a.path,a.caseSensitive,a.end),f=l.match(s);if(!f)return null;let d=f[0],h=d.replace(/(.)\/+$/,"$1"),y=f.slice(1);return{params:o.reduce((m,{paramName:S,isOptional:w},T)=>{if(S==="*"){let A=y[T]||"";h=d.slice(0,d.length-A.length).replace(/(.)\/+$/,"$1")}const z=y[T];return w&&!z?m[S]=void 0:m[S]=(z||"").replace(/%2F/g,"/"),m},{}),pathname:d,pathnameBase:h,pattern:a}}function vv(a,l=!1,s=!0){cn(a==="*"||!a.endsWith("*")||a.endsWith("/*"),`Route path "${a}" will be treated as if it were "${a.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${a.replace(/\*$/,"/*")}".`);let o=[],f="^"+a.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(h,y,g)=>(o.push({paramName:y,isOptional:g!=null}),g?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return a.endsWith("*")?(o.push({paramName:"*"}),f+=a==="*"||a==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?f+="\\/*$":a!==""&&a!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,l?void 0:"i"),o]}function bv(a){try{return a.split("/").map(l=>decodeURIComponent(l).replace(/\//g,"%2F")).join("/")}catch(l){return cn(!1,`The URL path "${a}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${l}).`),a}}function Dn(a,l){if(l==="/")return a;if(!a.toLowerCase().startsWith(l.toLowerCase()))return null;let s=l.endsWith("/")?l.length-1:l.length,o=a.charAt(s);return o&&o!=="/"?null:a.slice(s)||"/"}function Sv(a,l="/"){let{pathname:s,search:o="",hash:f=""}=typeof a=="string"?Bi(a):a;return{pathname:s?s.startsWith("/")?s:wv(s,l):l,search:Cv(o),hash:Tv(f)}}function wv(a,l){let s=l.replace(/\/+$/,"").split("/");return a.split("/").forEach(f=>{f===".."?s.length>1&&s.pop():f!=="."&&s.push(f)}),s.length>1?s.join("/"):"/"}function $u(a,l,s,o){return`Cannot include a '${a}' character in a manually specified \`to.${l}\` field [${JSON.stringify(o)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function jv(a){return a.filter((l,s)=>s===0||l.route.path&&l.route.path.length>0)}function Hm(a){let l=jv(a);return l.map((s,o)=>o===l.length-1?s.pathname:s.pathnameBase)}function Ym(a,l,s,o=!1){let f;typeof a=="string"?f=Bi(a):(f={...a},Xe(!f.pathname||!f.pathname.includes("?"),$u("?","pathname","search",f)),Xe(!f.pathname||!f.pathname.includes("#"),$u("#","pathname","hash",f)),Xe(!f.search||!f.search.includes("#"),$u("#","search","hash",f)));let d=a===""||f.pathname==="",h=d?"/":f.pathname,y;if(h==null)y=s;else{let w=l.length-1;if(!o&&h.startsWith("..")){let T=h.split("/");for(;T[0]==="..";)T.shift(),w-=1;f.pathname=T.join("/")}y=w>=0?l[w]:"/"}let g=Sv(f,y),m=h&&h!=="/"&&h.endsWith("/"),S=(d||h===".")&&s.endsWith("/");return!g.pathname.endsWith("/")&&(m||S)&&(g.pathname+="/"),g}var Nn=a=>a.join("/").replace(/\/\/+/g,"/"),Ev=a=>a.replace(/\/+$/,"").replace(/^\/*/,"/"),Cv=a=>!a||a==="?"?"":a.startsWith("?")?a:"?"+a,Tv=a=>!a||a==="#"?"":a.startsWith("#")?a:"#"+a;function zv(a){return a!=null&&typeof a.status=="number"&&typeof a.statusText=="string"&&typeof a.internal=="boolean"&&"data"in a}var qm=["POST","PUT","PATCH","DELETE"];new Set(qm);var Rv=["GET",...qm];new Set(Rv);var Li=v.createContext(null);Li.displayName="DataRouter";var es=v.createContext(null);es.displayName="DataRouterState";v.createContext(!1);var Gm=v.createContext({isTransitioning:!1});Gm.displayName="ViewTransition";var Av=v.createContext(new Map);Av.displayName="Fetchers";var Mv=v.createContext(null);Mv.displayName="Await";var un=v.createContext(null);un.displayName="Navigation";var Kl=v.createContext(null);Kl.displayName="Location";var Bn=v.createContext({outlet:null,matches:[],isDataRoute:!1});Bn.displayName="Route";var Of=v.createContext(null);Of.displayName="RouteError";function Ov(a,{relative:l}={}){Xe(Jl(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:o}=v.useContext(un),{hash:f,pathname:d,search:h}=Fl(a,{relative:l}),y=d;return s!=="/"&&(y=d==="/"?s:Nn([s,d])),o.createHref({pathname:y,search:h,hash:f})}function Jl(){return v.useContext(Kl)!=null}function Ln(){return Xe(Jl(),"useLocation() may be used only in the context of a <Router> component."),v.useContext(Kl).location}var Xm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Vm(a){v.useContext(un).static||v.useLayoutEffect(a)}function ts(){let{isDataRoute:a}=v.useContext(Bn);return a?Xv():kv()}function kv(){Xe(Jl(),"useNavigate() may be used only in the context of a <Router> component.");let a=v.useContext(Li),{basename:l,navigator:s}=v.useContext(un),{matches:o}=v.useContext(Bn),{pathname:f}=Ln(),d=JSON.stringify(Hm(o)),h=v.useRef(!1);return Vm(()=>{h.current=!0}),v.useCallback((g,m={})=>{if(cn(h.current,Xm),!h.current)return;if(typeof g=="number"){s.go(g);return}let S=Ym(g,JSON.parse(d),f,m.relative==="path");a==null&&l!=="/"&&(S.pathname=S.pathname==="/"?l:Nn([l,S.pathname])),(m.replace?s.replace:s.push)(S,m.state,m)},[l,s,d,f,a])}v.createContext(null);function Fl(a,{relative:l}={}){let{matches:s}=v.useContext(Bn),{pathname:o}=Ln(),f=JSON.stringify(Hm(s));return v.useMemo(()=>Ym(a,JSON.parse(f),o,l==="path"),[a,f,o,l])}function Nv(a,l){return Qm(a,l)}function Qm(a,l,s,o,f){Xe(Jl(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=v.useContext(un),{matches:h}=v.useContext(Bn),y=h[h.length-1],g=y?y.params:{},m=y?y.pathname:"/",S=y?y.pathnameBase:"/",w=y&&y.route;{let q=w&&w.path||"";Zm(m,!w||q.endsWith("*")||q.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${m}" (under <Route path="${q}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${q}"> to <Route path="${q==="/"?"*":`${q}/*`}">.`)}let T=Ln(),z;if(l){let q=typeof l=="string"?Bi(l):l;Xe(S==="/"||q.pathname?.startsWith(S),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${S}" but pathname "${q.pathname}" was given in the \`location\` prop.`),z=q}else z=T;let A=z.pathname||"/",k=A;if(S!=="/"){let q=S.replace(/^\//,"").split("/");k="/"+A.replace(/^\//,"").split("/").slice(q.length).join("/")}let $=Bm(a,{pathname:k});cn(w||$!=null,`No routes matched location "${z.pathname}${z.search}${z.hash}" `),cn($==null||$[$.length-1].route.element!==void 0||$[$.length-1].route.Component!==void 0||$[$.length-1].route.lazy!==void 0,`Matched leaf route at location "${z.pathname}${z.search}${z.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let B=Lv($&&$.map(q=>Object.assign({},q,{params:Object.assign({},g,q.params),pathname:Nn([S,d.encodeLocation?d.encodeLocation(q.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:q.pathname]),pathnameBase:q.pathnameBase==="/"?S:Nn([S,d.encodeLocation?d.encodeLocation(q.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:q.pathnameBase])})),h,s,o,f);return l&&B?v.createElement(Kl.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...z},navigationType:"POP"}},B):B}function _v(){let a=Gv(),l=zv(a)?`${a.status} ${a.statusText}`:a instanceof Error?a.message:JSON.stringify(a),s=a instanceof Error?a.stack:null,o="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:o},d={padding:"2px 4px",backgroundColor:o},h=null;return console.error("Error handled by React Router default ErrorBoundary:",a),h=v.createElement(v.Fragment,null,v.createElement("p",null,"💿 Hey developer 👋"),v.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",v.createElement("code",{style:d},"ErrorBoundary")," or"," ",v.createElement("code",{style:d},"errorElement")," prop on your route.")),v.createElement(v.Fragment,null,v.createElement("h2",null,"Unexpected Application Error!"),v.createElement("h3",{style:{fontStyle:"italic"}},l),s?v.createElement("pre",{style:f},s):null,h)}var Dv=v.createElement(_v,null),$v=class extends v.Component{constructor(a){super(a),this.state={location:a.location,revalidation:a.revalidation,error:a.error}}static getDerivedStateFromError(a){return{error:a}}static getDerivedStateFromProps(a,l){return l.location!==a.location||l.revalidation!=="idle"&&a.revalidation==="idle"?{error:a.error,location:a.location,revalidation:a.revalidation}:{error:a.error!==void 0?a.error:l.error,location:l.location,revalidation:a.revalidation||l.revalidation}}componentDidCatch(a,l){this.props.unstable_onError?this.props.unstable_onError(a,l):console.error("React Router caught the following error during render",a)}render(){return this.state.error!==void 0?v.createElement(Bn.Provider,{value:this.props.routeContext},v.createElement(Of.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function Bv({routeContext:a,match:l,children:s}){let o=v.useContext(Li);return o&&o.static&&o.staticContext&&(l.route.errorElement||l.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=l.route.id),v.createElement(Bn.Provider,{value:a},s)}function Lv(a,l=[],s=null,o=null,f=null){if(a==null){if(!s)return null;if(s.errors)a=s.matches;else if(l.length===0&&!s.initialized&&s.matches.length>0)a=s.matches;else return null}let d=a,h=s?.errors;if(h!=null){let m=d.findIndex(S=>S.route.id&&h?.[S.route.id]!==void 0);Xe(m>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(h).join(",")}`),d=d.slice(0,Math.min(d.length,m+1))}let y=!1,g=-1;if(s)for(let m=0;m<d.length;m++){let S=d[m];if((S.route.HydrateFallback||S.route.hydrateFallbackElement)&&(g=m),S.route.id){let{loaderData:w,errors:T}=s,z=S.route.loader&&!w.hasOwnProperty(S.route.id)&&(!T||T[S.route.id]===void 0);if(S.route.lazy||z){y=!0,g>=0?d=d.slice(0,g+1):d=[d[0]];break}}}return d.reduceRight((m,S,w)=>{let T,z=!1,A=null,k=null;s&&(T=h&&S.route.id?h[S.route.id]:void 0,A=S.route.errorElement||Dv,y&&(g<0&&w===0?(Zm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),z=!0,k=null):g===w&&(z=!0,k=S.route.hydrateFallbackElement||null)));let $=l.concat(d.slice(0,w+1)),B=()=>{let q;return T?q=A:z?q=k:S.route.Component?q=v.createElement(S.route.Component,null):S.route.element?q=S.route.element:q=m,v.createElement(Bv,{match:S,routeContext:{outlet:m,matches:$,isDataRoute:s!=null},children:q})};return s&&(S.route.ErrorBoundary||S.route.errorElement||w===0)?v.createElement($v,{location:s.location,revalidation:s.revalidation,component:A,error:T,children:B(),routeContext:{outlet:null,matches:$,isDataRoute:!0},unstable_onError:o}):B()},null)}function kf(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Uv(a){let l=v.useContext(Li);return Xe(l,kf(a)),l}function Hv(a){let l=v.useContext(es);return Xe(l,kf(a)),l}function Yv(a){let l=v.useContext(Bn);return Xe(l,kf(a)),l}function Nf(a){let l=Yv(a),s=l.matches[l.matches.length-1];return Xe(s.route.id,`${a} can only be used on routes that contain a unique "id"`),s.route.id}function qv(){return Nf("useRouteId")}function Gv(){let a=v.useContext(Of),l=Hv("useRouteError"),s=Nf("useRouteError");return a!==void 0?a:l.errors?.[s]}function Xv(){let{router:a}=Uv("useNavigate"),l=Nf("useNavigate"),s=v.useRef(!1);return Vm(()=>{s.current=!0}),v.useCallback(async(f,d={})=>{cn(s.current,Xm),s.current&&(typeof f=="number"?a.navigate(f):await a.navigate(f,{fromRouteId:l,...d}))},[a,l])}var g1={};function Zm(a,l,s){!l&&!g1[a]&&(g1[a]=!0,cn(!1,s))}v.memo(Vv);function Vv({routes:a,future:l,state:s,unstable_onError:o}){return Qm(a,void 0,s,o,l)}function _a(a){Xe(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Qv({basename:a="/",children:l=null,location:s,navigationType:o="POP",navigator:f,static:d=!1}){Xe(!Jl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let h=a.replace(/^\/*/,"/"),y=v.useMemo(()=>({basename:h,navigator:f,static:d,future:{}}),[h,f,d]);typeof s=="string"&&(s=Bi(s));let{pathname:g="/",search:m="",hash:S="",state:w=null,key:T="default"}=s,z=v.useMemo(()=>{let A=Dn(g,h);return A==null?null:{location:{pathname:A,search:m,hash:S,state:w,key:T},navigationType:o}},[h,g,m,S,w,T,o]);return cn(z!=null,`<Router basename="${h}"> is not able to match the URL "${g}${m}${S}" because it does not start with the basename, so the <Router> won't render anything.`),z==null?null:v.createElement(un.Provider,{value:y},v.createElement(Kl.Provider,{children:l,value:z}))}function Zv({children:a,location:l}){return Nv(mf(a),l)}function mf(a,l=[]){let s=[];return v.Children.forEach(a,(o,f)=>{if(!v.isValidElement(o))return;let d=[...l,f];if(o.type===v.Fragment){s.push.apply(s,mf(o.props.children,d));return}Xe(o.type===_a,`[${typeof o.type=="string"?o.type:o.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Xe(!o.props.index||!o.props.children,"An index route cannot have child routes.");let h={id:o.props.id||d.join("-"),caseSensitive:o.props.caseSensitive,element:o.props.element,Component:o.props.Component,index:o.props.index,path:o.props.path,middleware:o.props.middleware,loader:o.props.loader,action:o.props.action,hydrateFallbackElement:o.props.hydrateFallbackElement,HydrateFallback:o.props.HydrateFallback,errorElement:o.props.errorElement,ErrorBoundary:o.props.ErrorBoundary,hasErrorBoundary:o.props.hasErrorBoundary===!0||o.props.ErrorBoundary!=null||o.props.errorElement!=null,shouldRevalidate:o.props.shouldRevalidate,handle:o.props.handle,lazy:o.props.lazy};o.props.children&&(h.children=mf(o.props.children,d)),s.push(h)}),s}var Do="get",$o="application/x-www-form-urlencoded";function ns(a){return a!=null&&typeof a.tagName=="string"}function Kv(a){return ns(a)&&a.tagName.toLowerCase()==="button"}function Jv(a){return ns(a)&&a.tagName.toLowerCase()==="form"}function Fv(a){return ns(a)&&a.tagName.toLowerCase()==="input"}function Wv(a){return!!(a.metaKey||a.altKey||a.ctrlKey||a.shiftKey)}function Iv(a,l){return a.button===0&&(!l||l==="_self")&&!Wv(a)}var yo=null;function Pv(){if(yo===null)try{new FormData(document.createElement("form"),0),yo=!1}catch{yo=!0}return yo}var eb=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Bu(a){return a!=null&&!eb.has(a)?(cn(!1,`"${a}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${$o}"`),null):a}function tb(a,l){let s,o,f,d,h;if(Jv(a)){let y=a.getAttribute("action");o=y?Dn(y,l):null,s=a.getAttribute("method")||Do,f=Bu(a.getAttribute("enctype"))||$o,d=new FormData(a)}else if(Kv(a)||Fv(a)&&(a.type==="submit"||a.type==="image")){let y=a.form;if(y==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let g=a.getAttribute("formaction")||y.getAttribute("action");if(o=g?Dn(g,l):null,s=a.getAttribute("formmethod")||y.getAttribute("method")||Do,f=Bu(a.getAttribute("formenctype"))||Bu(y.getAttribute("enctype"))||$o,d=new FormData(y,a),!Pv()){let{name:m,type:S,value:w}=a;if(S==="image"){let T=m?`${m}.`:"";d.append(`${T}x`,"0"),d.append(`${T}y`,"0")}else m&&d.append(m,w)}}else{if(ns(a))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Do,o=null,f=$o,h=a}return d&&f==="text/plain"&&(h=d,d=void 0),{action:o,method:s.toLowerCase(),encType:f,formData:d,body:h}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function _f(a,l){if(a===!1||a===null||typeof a>"u")throw new Error(l)}function nb(a,l,s){let o=typeof a=="string"?new URL(a,typeof window>"u"?"server://singlefetch/":window.location.origin):a;return o.pathname==="/"?o.pathname=`_root.${s}`:l&&Dn(o.pathname,l)==="/"?o.pathname=`${l.replace(/\/$/,"")}/_root.${s}`:o.pathname=`${o.pathname.replace(/\/$/,"")}.${s}`,o}async function ab(a,l){if(a.id in l)return l[a.id];try{let s=await import(a.module);return l[a.id]=s,s}catch(s){return console.error(`Error loading route module \`${a.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function ib(a){return a==null?!1:a.href==null?a.rel==="preload"&&typeof a.imageSrcSet=="string"&&typeof a.imageSizes=="string":typeof a.rel=="string"&&typeof a.href=="string"}async function lb(a,l,s){let o=await Promise.all(a.map(async f=>{let d=l.routes[f.route.id];if(d){let h=await ab(d,s);return h.links?h.links():[]}return[]}));return cb(o.flat(1).filter(ib).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function x1(a,l,s,o,f,d){let h=(g,m)=>s[m]?g.route.id!==s[m].route.id:!0,y=(g,m)=>s[m].pathname!==g.pathname||s[m].route.path?.endsWith("*")&&s[m].params["*"]!==g.params["*"];return d==="assets"?l.filter((g,m)=>h(g,m)||y(g,m)):d==="data"?l.filter((g,m)=>{let S=o.routes[g.route.id];if(!S||!S.hasLoader)return!1;if(h(g,m)||y(g,m))return!0;if(g.route.shouldRevalidate){let w=g.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:s[0]?.params||{},nextUrl:new URL(a,window.origin),nextParams:g.params,defaultShouldRevalidate:!0});if(typeof w=="boolean")return w}return!0}):[]}function rb(a,l,{includeHydrateFallback:s}={}){return ob(a.map(o=>{let f=l.routes[o.route.id];if(!f)return[];let d=[f.module];return f.clientActionModule&&(d=d.concat(f.clientActionModule)),f.clientLoaderModule&&(d=d.concat(f.clientLoaderModule)),s&&f.hydrateFallbackModule&&(d=d.concat(f.hydrateFallbackModule)),f.imports&&(d=d.concat(f.imports)),d}).flat(1))}function ob(a){return[...new Set(a)]}function sb(a){let l={},s=Object.keys(a).sort();for(let o of s)l[o]=a[o];return l}function cb(a,l){let s=new Set;return new Set(l),a.reduce((o,f)=>{let d=JSON.stringify(sb(f));return s.has(d)||(s.add(d),o.push({key:d,link:f})),o},[])}function Km(){let a=v.useContext(Li);return _f(a,"You must render this element inside a <DataRouterContext.Provider> element"),a}function ub(){let a=v.useContext(es);return _f(a,"You must render this element inside a <DataRouterStateContext.Provider> element"),a}var Df=v.createContext(void 0);Df.displayName="FrameworkContext";function Jm(){let a=v.useContext(Df);return _f(a,"You must render this element inside a <HydratedRouter> element"),a}function fb(a,l){let s=v.useContext(Df),[o,f]=v.useState(!1),[d,h]=v.useState(!1),{onFocus:y,onBlur:g,onMouseEnter:m,onMouseLeave:S,onTouchStart:w}=l,T=v.useRef(null);v.useEffect(()=>{if(a==="render"&&h(!0),a==="viewport"){let k=B=>{B.forEach(q=>{h(q.isIntersecting)})},$=new IntersectionObserver(k,{threshold:.5});return T.current&&$.observe(T.current),()=>{$.disconnect()}}},[a]),v.useEffect(()=>{if(o){let k=setTimeout(()=>{h(!0)},100);return()=>{clearTimeout(k)}}},[o]);let z=()=>{f(!0)},A=()=>{f(!1),h(!1)};return s?a!=="intent"?[d,T,{}]:[d,T,{onFocus:Ll(y,z),onBlur:Ll(g,A),onMouseEnter:Ll(m,z),onMouseLeave:Ll(S,A),onTouchStart:Ll(w,z)}]:[!1,T,{}]}function Ll(a,l){return s=>{a&&a(s),s.defaultPrevented||l(s)}}function db({page:a,...l}){let{router:s}=Km(),o=v.useMemo(()=>Bm(s.routes,a,s.basename),[s.routes,a,s.basename]);return o?v.createElement(hb,{page:a,matches:o,...l}):null}function pb(a){let{manifest:l,routeModules:s}=Jm(),[o,f]=v.useState([]);return v.useEffect(()=>{let d=!1;return lb(a,l,s).then(h=>{d||f(h)}),()=>{d=!0}},[a,l,s]),o}function hb({page:a,matches:l,...s}){let o=Ln(),{manifest:f,routeModules:d}=Jm(),{basename:h}=Km(),{loaderData:y,matches:g}=ub(),m=v.useMemo(()=>x1(a,l,g,f,o,"data"),[a,l,g,f,o]),S=v.useMemo(()=>x1(a,l,g,f,o,"assets"),[a,l,g,f,o]),w=v.useMemo(()=>{if(a===o.pathname+o.search+o.hash)return[];let A=new Set,k=!1;if(l.forEach(B=>{let q=f.routes[B.route.id];!q||!q.hasLoader||(!m.some(Y=>Y.route.id===B.route.id)&&B.route.id in y&&d[B.route.id]?.shouldRevalidate||q.hasClientLoader?k=!0:A.add(B.route.id))}),A.size===0)return[];let $=nb(a,h,"data");return k&&A.size>0&&$.searchParams.set("_routes",l.filter(B=>A.has(B.route.id)).map(B=>B.route.id).join(",")),[$.pathname+$.search]},[h,y,o,f,m,l,a,d]),T=v.useMemo(()=>rb(S,f),[S,f]),z=pb(S);return v.createElement(v.Fragment,null,w.map(A=>v.createElement("link",{key:A,rel:"prefetch",as:"fetch",href:A,...s})),T.map(A=>v.createElement("link",{key:A,rel:"modulepreload",href:A,...s})),z.map(({key:A,link:k})=>v.createElement("link",{key:A,nonce:s.nonce,...k})))}function mb(...a){return l=>{a.forEach(s=>{typeof s=="function"?s(l):s!=null&&(s.current=l)})}}var Fm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Fm&&(window.__reactRouterVersion="7.9.4")}catch{}function gb({basename:a,children:l,window:s}){let o=v.useRef();o.current==null&&(o.current=iv({window:s,v5Compat:!0}));let f=o.current,[d,h]=v.useState({action:f.action,location:f.location}),y=v.useCallback(g=>{v.startTransition(()=>h(g))},[h]);return v.useLayoutEffect(()=>f.listen(y),[f,y]),v.createElement(Qv,{basename:a,children:l,location:d.location,navigationType:d.action,navigator:f})}var Wm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ui=v.forwardRef(function({onClick:l,discover:s="render",prefetch:o="none",relative:f,reloadDocument:d,replace:h,state:y,target:g,to:m,preventScrollReset:S,viewTransition:w,...T},z){let{basename:A}=v.useContext(un),k=typeof m=="string"&&Wm.test(m),$,B=!1;if(typeof m=="string"&&k&&($=m,Fm))try{let W=new URL(window.location.href),ce=m.startsWith("//")?new URL(W.protocol+m):new URL(m),de=Dn(ce.pathname,A);ce.origin===W.origin&&de!=null?m=de+ce.search+ce.hash:B=!0}catch{cn(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let q=Ov(m,{relative:f}),[Y,Z,J]=fb(o,T),L=bb(m,{replace:h,state:y,target:g,preventScrollReset:S,relative:f,viewTransition:w});function V(W){l&&l(W),W.defaultPrevented||L(W)}let Q=v.createElement("a",{...T,...J,href:$||q,onClick:B||d?l:V,ref:mb(z,Z),target:g,"data-discover":!k&&s==="render"?"true":void 0});return Y&&!k?v.createElement(v.Fragment,null,Q,v.createElement(db,{page:q})):Q});Ui.displayName="Link";var xb=v.forwardRef(function({"aria-current":l="page",caseSensitive:s=!1,className:o="",end:f=!1,style:d,to:h,viewTransition:y,children:g,...m},S){let w=Fl(h,{relative:m.relative}),T=Ln(),z=v.useContext(es),{navigator:A,basename:k}=v.useContext(un),$=z!=null&&Cb(w)&&y===!0,B=A.encodeLocation?A.encodeLocation(w).pathname:w.pathname,q=T.pathname,Y=z&&z.navigation&&z.navigation.location?z.navigation.location.pathname:null;s||(q=q.toLowerCase(),Y=Y?Y.toLowerCase():null,B=B.toLowerCase()),Y&&k&&(Y=Dn(Y,k)||Y);const Z=B!=="/"&&B.endsWith("/")?B.length-1:B.length;let J=q===B||!f&&q.startsWith(B)&&q.charAt(Z)==="/",L=Y!=null&&(Y===B||!f&&Y.startsWith(B)&&Y.charAt(B.length)==="/"),V={isActive:J,isPending:L,isTransitioning:$},Q=J?l:void 0,W;typeof o=="function"?W=o(V):W=[o,J?"active":null,L?"pending":null,$?"transitioning":null].filter(Boolean).join(" ");let ce=typeof d=="function"?d(V):d;return v.createElement(Ui,{...m,"aria-current":Q,className:W,ref:S,style:ce,to:h,viewTransition:y},typeof g=="function"?g(V):g)});xb.displayName="NavLink";var yb=v.forwardRef(({discover:a="render",fetcherKey:l,navigate:s,reloadDocument:o,replace:f,state:d,method:h=Do,action:y,onSubmit:g,relative:m,preventScrollReset:S,viewTransition:w,...T},z)=>{let A=jb(),k=Eb(y,{relative:m}),$=h.toLowerCase()==="get"?"get":"post",B=typeof y=="string"&&Wm.test(y),q=Y=>{if(g&&g(Y),Y.defaultPrevented)return;Y.preventDefault();let Z=Y.nativeEvent.submitter,J=Z?.getAttribute("formmethod")||h;A(Z||Y.currentTarget,{fetcherKey:l,method:J,navigate:s,replace:f,state:d,relative:m,preventScrollReset:S,viewTransition:w})};return v.createElement("form",{ref:z,method:$,action:k,onSubmit:o?g:q,...T,"data-discover":!B&&a==="render"?"true":void 0})});yb.displayName="Form";function vb(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Im(a){let l=v.useContext(Li);return Xe(l,vb(a)),l}function bb(a,{target:l,replace:s,state:o,preventScrollReset:f,relative:d,viewTransition:h}={}){let y=ts(),g=Ln(),m=Fl(a,{relative:d});return v.useCallback(S=>{if(Iv(S,l)){S.preventDefault();let w=s!==void 0?s:Gl(g)===Gl(m);y(a,{replace:w,state:o,preventScrollReset:f,relative:d,viewTransition:h})}},[g,y,m,s,o,l,a,f,d,h])}var Sb=0,wb=()=>`__${String(++Sb)}__`;function jb(){let{router:a}=Im("useSubmit"),{basename:l}=v.useContext(un),s=qv();return v.useCallback(async(o,f={})=>{let{action:d,method:h,encType:y,formData:g,body:m}=tb(o,l);if(f.navigate===!1){let S=f.fetcherKey||wb();await a.fetch(S,s,f.action||d,{preventScrollReset:f.preventScrollReset,formData:g,body:m,formMethod:f.method||h,formEncType:f.encType||y,flushSync:f.flushSync})}else await a.navigate(f.action||d,{preventScrollReset:f.preventScrollReset,formData:g,body:m,formMethod:f.method||h,formEncType:f.encType||y,replace:f.replace,state:f.state,fromRouteId:s,flushSync:f.flushSync,viewTransition:f.viewTransition})},[a,l,s])}function Eb(a,{relative:l}={}){let{basename:s}=v.useContext(un),o=v.useContext(Bn);Xe(o,"useFormAction must be used inside a RouteContext");let[f]=o.matches.slice(-1),d={...Fl(a||".",{relative:l})},h=Ln();if(a==null){d.search=h.search;let y=new URLSearchParams(d.search),g=y.getAll("index");if(g.some(S=>S==="")){y.delete("index"),g.filter(w=>w).forEach(w=>y.append("index",w));let S=y.toString();d.search=S?`?${S}`:""}}return(!a||a===".")&&f.route.index&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(d.pathname=d.pathname==="/"?s:Nn([s,d.pathname])),Gl(d)}function Cb(a,{relative:l}={}){let s=v.useContext(Gm);Xe(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:o}=Im("useViewTransitionState"),f=Fl(a,{relative:l});if(!s.isTransitioning)return!1;let d=Dn(s.currentLocation.pathname,o)||s.currentLocation.pathname,h=Dn(s.nextLocation.pathname,o)||s.nextLocation.pathname;return Go(f.pathname,h)!=null||Go(f.pathname,d)!=null}var Tb=$m();const Ai=Zl(Tb);var ft=function(){return ft=Object.assign||function(l){for(var s,o=1,f=arguments.length;o<f;o++){s=arguments[o];for(var d in s)Object.prototype.hasOwnProperty.call(s,d)&&(l[d]=s[d])}return l},ft.apply(this,arguments)};function Oi(a,l,s){if(s||arguments.length===2)for(var o=0,f=l.length,d;o<f;o++)(d||!(o in l))&&(d||(d=Array.prototype.slice.call(l,0,o)),d[o]=l[o]);return a.concat(d||Array.prototype.slice.call(l))}var He="-ms-",ql="-moz-",Ae="-webkit-",Pm="comm",as="rule",$f="decl",zb="@import",eg="@keyframes",Rb="@layer",tg=Math.abs,Bf=String.fromCharCode,gf=Object.assign;function Ab(a,l){return at(a,0)^45?(((l<<2^at(a,0))<<2^at(a,1))<<2^at(a,2))<<2^at(a,3):0}function ng(a){return a.trim()}function Mn(a,l){return(a=l.exec(a))?a[0]:a}function ge(a,l,s){return a.replace(l,s)}function Bo(a,l,s){return a.indexOf(l,s)}function at(a,l){return a.charCodeAt(l)|0}function ki(a,l,s){return a.slice(l,s)}function sn(a){return a.length}function ag(a){return a.length}function Hl(a,l){return l.push(a),a}function Mb(a,l){return a.map(l).join("")}function y1(a,l){return a.filter(function(s){return!Mn(s,l)})}var is=1,Ni=1,ig=0,Kt=0,Pe=0,Hi="";function ls(a,l,s,o,f,d,h,y){return{value:a,root:l,parent:s,type:o,props:f,children:d,line:is,column:Ni,length:h,return:"",siblings:y}}function pa(a,l){return gf(ls("",null,null,"",null,null,0,a.siblings),a,{length:-a.length},l)}function Ei(a){for(;a.root;)a=pa(a.root,{children:[a]});Hl(a,a.siblings)}function Ob(){return Pe}function kb(){return Pe=Kt>0?at(Hi,--Kt):0,Ni--,Pe===10&&(Ni=1,is--),Pe}function tn(){return Pe=Kt<ig?at(Hi,Kt++):0,Ni++,Pe===10&&(Ni=1,is++),Pe}function Ba(){return at(Hi,Kt)}function Lo(){return Kt}function rs(a,l){return ki(Hi,a,l)}function xf(a){switch(a){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function Nb(a){return is=Ni=1,ig=sn(Hi=a),Kt=0,[]}function _b(a){return Hi="",a}function Lu(a){return ng(rs(Kt-1,yf(a===91?a+2:a===40?a+1:a)))}function Db(a){for(;(Pe=Ba())&&Pe<33;)tn();return xf(a)>2||xf(Pe)>3?"":" "}function $b(a,l){for(;--l&&tn()&&!(Pe<48||Pe>102||Pe>57&&Pe<65||Pe>70&&Pe<97););return rs(a,Lo()+(l<6&&Ba()==32&&tn()==32))}function yf(a){for(;tn();)switch(Pe){case a:return Kt;case 34:case 39:a!==34&&a!==39&&yf(Pe);break;case 40:a===41&&yf(a);break;case 92:tn();break}return Kt}function Bb(a,l){for(;tn()&&a+Pe!==57;)if(a+Pe===84&&Ba()===47)break;return"/*"+rs(l,Kt-1)+"*"+Bf(a===47?a:tn())}function Lb(a){for(;!xf(Ba());)tn();return rs(a,Kt)}function Ub(a){return _b(Uo("",null,null,null,[""],a=Nb(a),0,[0],a))}function Uo(a,l,s,o,f,d,h,y,g){for(var m=0,S=0,w=h,T=0,z=0,A=0,k=1,$=1,B=1,q=0,Y="",Z=f,J=d,L=o,V=Y;$;)switch(A=q,q=tn()){case 40:if(A!=108&&at(V,w-1)==58){Bo(V+=ge(Lu(q),"&","&\f"),"&\f",tg(m?y[m-1]:0))!=-1&&(B=-1);break}case 34:case 39:case 91:V+=Lu(q);break;case 9:case 10:case 13:case 32:V+=Db(A);break;case 92:V+=$b(Lo()-1,7);continue;case 47:switch(Ba()){case 42:case 47:Hl(Hb(Bb(tn(),Lo()),l,s,g),g);break;default:V+="/"}break;case 123*k:y[m++]=sn(V)*B;case 125*k:case 59:case 0:switch(q){case 0:case 125:$=0;case 59+S:B==-1&&(V=ge(V,/\f/g,"")),z>0&&sn(V)-w&&Hl(z>32?b1(V+";",o,s,w-1,g):b1(ge(V," ","")+";",o,s,w-2,g),g);break;case 59:V+=";";default:if(Hl(L=v1(V,l,s,m,S,f,y,Y,Z=[],J=[],w,d),d),q===123)if(S===0)Uo(V,l,L,L,Z,d,w,y,J);else switch(T===99&&at(V,3)===110?100:T){case 100:case 108:case 109:case 115:Uo(a,L,L,o&&Hl(v1(a,L,L,0,0,f,y,Y,f,Z=[],w,J),J),f,J,w,y,o?Z:J);break;default:Uo(V,L,L,L,[""],J,0,y,J)}}m=S=z=0,k=B=1,Y=V="",w=h;break;case 58:w=1+sn(V),z=A;default:if(k<1){if(q==123)--k;else if(q==125&&k++==0&&kb()==125)continue}switch(V+=Bf(q),q*k){case 38:B=S>0?1:(V+="\f",-1);break;case 44:y[m++]=(sn(V)-1)*B,B=1;break;case 64:Ba()===45&&(V+=Lu(tn())),T=Ba(),S=w=sn(Y=V+=Lb(Lo())),q++;break;case 45:A===45&&sn(V)==2&&(k=0)}}return d}function v1(a,l,s,o,f,d,h,y,g,m,S,w){for(var T=f-1,z=f===0?d:[""],A=ag(z),k=0,$=0,B=0;k<o;++k)for(var q=0,Y=ki(a,T+1,T=tg($=h[k])),Z=a;q<A;++q)(Z=ng($>0?z[q]+" "+Y:ge(Y,/&\f/g,z[q])))&&(g[B++]=Z);return ls(a,l,s,f===0?as:y,g,m,S,w)}function Hb(a,l,s,o){return ls(a,l,s,Pm,Bf(Ob()),ki(a,2,-2),0,o)}function b1(a,l,s,o,f){return ls(a,l,s,$f,ki(a,0,o),ki(a,o+1,-1),o,f)}function lg(a,l,s){switch(Ab(a,l)){case 5103:return Ae+"print-"+a+a;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return Ae+a+a;case 4789:return ql+a+a;case 5349:case 4246:case 4810:case 6968:case 2756:return Ae+a+ql+a+He+a+a;case 5936:switch(at(a,l+11)){case 114:return Ae+a+He+ge(a,/[svh]\w+-[tblr]{2}/,"tb")+a;case 108:return Ae+a+He+ge(a,/[svh]\w+-[tblr]{2}/,"tb-rl")+a;case 45:return Ae+a+He+ge(a,/[svh]\w+-[tblr]{2}/,"lr")+a}case 6828:case 4268:case 2903:return Ae+a+He+a+a;case 6165:return Ae+a+He+"flex-"+a+a;case 5187:return Ae+a+ge(a,/(\w+).+(:[^]+)/,Ae+"box-$1$2"+He+"flex-$1$2")+a;case 5443:return Ae+a+He+"flex-item-"+ge(a,/flex-|-self/g,"")+(Mn(a,/flex-|baseline/)?"":He+"grid-row-"+ge(a,/flex-|-self/g,""))+a;case 4675:return Ae+a+He+"flex-line-pack"+ge(a,/align-content|flex-|-self/g,"")+a;case 5548:return Ae+a+He+ge(a,"shrink","negative")+a;case 5292:return Ae+a+He+ge(a,"basis","preferred-size")+a;case 6060:return Ae+"box-"+ge(a,"-grow","")+Ae+a+He+ge(a,"grow","positive")+a;case 4554:return Ae+ge(a,/([^-])(transform)/g,"$1"+Ae+"$2")+a;case 6187:return ge(ge(ge(a,/(zoom-|grab)/,Ae+"$1"),/(image-set)/,Ae+"$1"),a,"")+a;case 5495:case 3959:return ge(a,/(image-set\([^]*)/,Ae+"$1$`$1");case 4968:return ge(ge(a,/(.+:)(flex-)?(.*)/,Ae+"box-pack:$3"+He+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+Ae+a+a;case 4200:if(!Mn(a,/flex-|baseline/))return He+"grid-column-align"+ki(a,l)+a;break;case 2592:case 3360:return He+ge(a,"template-","")+a;case 4384:case 3616:return s&&s.some(function(o,f){return l=f,Mn(o.props,/grid-\w+-end/)})?~Bo(a+(s=s[l].value),"span",0)?a:He+ge(a,"-start","")+a+He+"grid-row-span:"+(~Bo(s,"span",0)?Mn(s,/\d+/):+Mn(s,/\d+/)-+Mn(a,/\d+/))+";":He+ge(a,"-start","")+a;case 4896:case 4128:return s&&s.some(function(o){return Mn(o.props,/grid-\w+-start/)})?a:He+ge(ge(a,"-end","-span"),"span ","")+a;case 4095:case 3583:case 4068:case 2532:return ge(a,/(.+)-inline(.+)/,Ae+"$1$2")+a;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(sn(a)-1-l>6)switch(at(a,l+1)){case 109:if(at(a,l+4)!==45)break;case 102:return ge(a,/(.+:)(.+)-([^]+)/,"$1"+Ae+"$2-$3$1"+ql+(at(a,l+3)==108?"$3":"$2-$3"))+a;case 115:return~Bo(a,"stretch",0)?lg(ge(a,"stretch","fill-available"),l,s)+a:a}break;case 5152:case 5920:return ge(a,/(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/,function(o,f,d,h,y,g,m){return He+f+":"+d+m+(h?He+f+"-span:"+(y?g:+g-+d)+m:"")+a});case 4949:if(at(a,l+6)===121)return ge(a,":",":"+Ae)+a;break;case 6444:switch(at(a,at(a,14)===45?18:11)){case 120:return ge(a,/(.+:)([^;\s!]+)(;|(\s+)?!.+)?/,"$1"+Ae+(at(a,14)===45?"inline-":"")+"box$3$1"+Ae+"$2$3$1"+He+"$2box$3")+a;case 100:return ge(a,":",":"+He)+a}break;case 5719:case 2647:case 2135:case 3927:case 2391:return ge(a,"scroll-","scroll-snap-")+a}return a}function Xo(a,l){for(var s="",o=0;o<a.length;o++)s+=l(a[o],o,a,l)||"";return s}function Yb(a,l,s,o){switch(a.type){case Rb:if(a.children.length)break;case zb:case $f:return a.return=a.return||a.value;case Pm:return"";case eg:return a.return=a.value+"{"+Xo(a.children,o)+"}";case as:if(!sn(a.value=a.props.join(",")))return""}return sn(s=Xo(a.children,o))?a.return=a.value+"{"+s+"}":""}function qb(a){var l=ag(a);return function(s,o,f,d){for(var h="",y=0;y<l;y++)h+=a[y](s,o,f,d)||"";return h}}function Gb(a){return function(l){l.root||(l=l.return)&&a(l)}}function Xb(a,l,s,o){if(a.length>-1&&!a.return)switch(a.type){case $f:a.return=lg(a.value,a.length,s);return;case eg:return Xo([pa(a,{value:ge(a.value,"@","@"+Ae)})],o);case as:if(a.length)return Mb(s=a.props,function(f){switch(Mn(f,o=/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":Ei(pa(a,{props:[ge(f,/:(read-\w+)/,":"+ql+"$1")]})),Ei(pa(a,{props:[f]})),gf(a,{props:y1(s,o)});break;case"::placeholder":Ei(pa(a,{props:[ge(f,/:(plac\w+)/,":"+Ae+"input-$1")]})),Ei(pa(a,{props:[ge(f,/:(plac\w+)/,":"+ql+"$1")]})),Ei(pa(a,{props:[ge(f,/:(plac\w+)/,He+"input-$1")]})),Ei(pa(a,{props:[f]})),gf(a,{props:y1(s,o)});break}return""})}}var Vb={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},Dt={},_i=typeof process<"u"&&Dt!==void 0&&(Dt.REACT_APP_SC_ATTR||Dt.SC_ATTR)||"data-styled",rg="active",og="data-styled-version",os="6.1.19",Lf=`/*!sc*/
`,Vo=typeof window<"u"&&typeof document<"u",Qb=!!(typeof SC_DISABLE_SPEEDY=="boolean"?SC_DISABLE_SPEEDY:typeof process<"u"&&Dt!==void 0&&Dt.REACT_APP_SC_DISABLE_SPEEDY!==void 0&&Dt.REACT_APP_SC_DISABLE_SPEEDY!==""?Dt.REACT_APP_SC_DISABLE_SPEEDY!=="false"&&Dt.REACT_APP_SC_DISABLE_SPEEDY:typeof process<"u"&&Dt!==void 0&&Dt.SC_DISABLE_SPEEDY!==void 0&&Dt.SC_DISABLE_SPEEDY!==""&&Dt.SC_DISABLE_SPEEDY!=="false"&&Dt.SC_DISABLE_SPEEDY),Zb={},ss=Object.freeze([]),Di=Object.freeze({});function sg(a,l,s){return s===void 0&&(s=Di),a.theme!==s.theme&&a.theme||l||s.theme}var cg=new Set(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","track","u","ul","use","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"]),Kb=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,Jb=/(^-|-$)/g;function S1(a){return a.replace(Kb,"-").replace(Jb,"")}var Fb=/(a)(d)/gi,vo=52,w1=function(a){return String.fromCharCode(a+(a>25?39:97))};function vf(a){var l,s="";for(l=Math.abs(a);l>vo;l=l/vo|0)s=w1(l%vo)+s;return(w1(l%vo)+s).replace(Fb,"$1-$2")}var Uu,ug=5381,Mi=function(a,l){for(var s=l.length;s;)a=33*a^l.charCodeAt(--s);return a},fg=function(a){return Mi(ug,a)};function Uf(a){return vf(fg(a)>>>0)}function Wb(a){return a.displayName||a.name||"Component"}function Hu(a){return typeof a=="string"&&!0}var dg=typeof Symbol=="function"&&Symbol.for,pg=dg?Symbol.for("react.memo"):60115,Ib=dg?Symbol.for("react.forward_ref"):60112,Pb={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},e5={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},hg={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},t5=((Uu={})[Ib]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},Uu[pg]=hg,Uu);function j1(a){return("type"in(l=a)&&l.type.$$typeof)===pg?hg:"$$typeof"in a?t5[a.$$typeof]:Pb;var l}var n5=Object.defineProperty,a5=Object.getOwnPropertyNames,E1=Object.getOwnPropertySymbols,i5=Object.getOwnPropertyDescriptor,l5=Object.getPrototypeOf,C1=Object.prototype;function mg(a,l,s){if(typeof l!="string"){if(C1){var o=l5(l);o&&o!==C1&&mg(a,o,s)}var f=a5(l);E1&&(f=f.concat(E1(l)));for(var d=j1(a),h=j1(l),y=0;y<f.length;++y){var g=f[y];if(!(g in e5||s&&s[g]||h&&g in h||d&&g in d)){var m=i5(l,g);try{n5(a,g,m)}catch{}}}}return a}function $i(a){return typeof a=="function"}function Hf(a){return typeof a=="object"&&"styledComponentId"in a}function $a(a,l){return a&&l?"".concat(a," ").concat(l):a||l||""}function Qo(a,l){if(a.length===0)return"";for(var s=a[0],o=1;o<a.length;o++)s+=a[o];return s}function Xl(a){return a!==null&&typeof a=="object"&&a.constructor.name===Object.name&&!("props"in a&&a.$$typeof)}function bf(a,l,s){if(s===void 0&&(s=!1),!s&&!Xl(a)&&!Array.isArray(a))return l;if(Array.isArray(l))for(var o=0;o<l.length;o++)a[o]=bf(a[o],l[o]);else if(Xl(l))for(var o in l)a[o]=bf(a[o],l[o]);return a}function Yf(a,l){Object.defineProperty(a,"toString",{value:l})}function Wl(a){for(var l=[],s=1;s<arguments.length;s++)l[s-1]=arguments[s];return new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(a," for more information.").concat(l.length>0?" Args: ".concat(l.join(", ")):""))}var r5=(function(){function a(l){this.groupSizes=new Uint32Array(512),this.length=512,this.tag=l}return a.prototype.indexOfGroup=function(l){for(var s=0,o=0;o<l;o++)s+=this.groupSizes[o];return s},a.prototype.insertRules=function(l,s){if(l>=this.groupSizes.length){for(var o=this.groupSizes,f=o.length,d=f;l>=d;)if((d<<=1)<0)throw Wl(16,"".concat(l));this.groupSizes=new Uint32Array(d),this.groupSizes.set(o),this.length=d;for(var h=f;h<d;h++)this.groupSizes[h]=0}for(var y=this.indexOfGroup(l+1),g=(h=0,s.length);h<g;h++)this.tag.insertRule(y,s[h])&&(this.groupSizes[l]++,y++)},a.prototype.clearGroup=function(l){if(l<this.length){var s=this.groupSizes[l],o=this.indexOfGroup(l),f=o+s;this.groupSizes[l]=0;for(var d=o;d<f;d++)this.tag.deleteRule(o)}},a.prototype.getGroup=function(l){var s="";if(l>=this.length||this.groupSizes[l]===0)return s;for(var o=this.groupSizes[l],f=this.indexOfGroup(l),d=f+o,h=f;h<d;h++)s+="".concat(this.tag.getRule(h)).concat(Lf);return s},a})(),Ho=new Map,Zo=new Map,Yo=1,bo=function(a){if(Ho.has(a))return Ho.get(a);for(;Zo.has(Yo);)Yo++;var l=Yo++;return Ho.set(a,l),Zo.set(l,a),l},o5=function(a,l){Yo=l+1,Ho.set(a,l),Zo.set(l,a)},s5="style[".concat(_i,"][").concat(og,'="').concat(os,'"]'),c5=new RegExp("^".concat(_i,'\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),u5=function(a,l,s){for(var o,f=s.split(","),d=0,h=f.length;d<h;d++)(o=f[d])&&a.registerName(l,o)},f5=function(a,l){for(var s,o=((s=l.textContent)!==null&&s!==void 0?s:"").split(Lf),f=[],d=0,h=o.length;d<h;d++){var y=o[d].trim();if(y){var g=y.match(c5);if(g){var m=0|parseInt(g[1],10),S=g[2];m!==0&&(o5(S,m),u5(a,S,g[3]),a.getTag().insertRules(m,f)),f.length=0}else f.push(y)}}},T1=function(a){for(var l=document.querySelectorAll(s5),s=0,o=l.length;s<o;s++){var f=l[s];f&&f.getAttribute(_i)!==rg&&(f5(a,f),f.parentNode&&f.parentNode.removeChild(f))}};function d5(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null}var gg=function(a){var l=document.head,s=a||l,o=document.createElement("style"),f=(function(y){var g=Array.from(y.querySelectorAll("style[".concat(_i,"]")));return g[g.length-1]})(s),d=f!==void 0?f.nextSibling:null;o.setAttribute(_i,rg),o.setAttribute(og,os);var h=d5();return h&&o.setAttribute("nonce",h),s.insertBefore(o,d),o},p5=(function(){function a(l){this.element=gg(l),this.element.appendChild(document.createTextNode("")),this.sheet=(function(s){if(s.sheet)return s.sheet;for(var o=document.styleSheets,f=0,d=o.length;f<d;f++){var h=o[f];if(h.ownerNode===s)return h}throw Wl(17)})(this.element),this.length=0}return a.prototype.insertRule=function(l,s){try{return this.sheet.insertRule(s,l),this.length++,!0}catch{return!1}},a.prototype.deleteRule=function(l){this.sheet.deleteRule(l),this.length--},a.prototype.getRule=function(l){var s=this.sheet.cssRules[l];return s&&s.cssText?s.cssText:""},a})(),h5=(function(){function a(l){this.element=gg(l),this.nodes=this.element.childNodes,this.length=0}return a.prototype.insertRule=function(l,s){if(l<=this.length&&l>=0){var o=document.createTextNode(s);return this.element.insertBefore(o,this.nodes[l]||null),this.length++,!0}return!1},a.prototype.deleteRule=function(l){this.element.removeChild(this.nodes[l]),this.length--},a.prototype.getRule=function(l){return l<this.length?this.nodes[l].textContent:""},a})(),m5=(function(){function a(l){this.rules=[],this.length=0}return a.prototype.insertRule=function(l,s){return l<=this.length&&(this.rules.splice(l,0,s),this.length++,!0)},a.prototype.deleteRule=function(l){this.rules.splice(l,1),this.length--},a.prototype.getRule=function(l){return l<this.length?this.rules[l]:""},a})(),z1=Vo,g5={isServer:!Vo,useCSSOMInjection:!Qb},Ko=(function(){function a(l,s,o){l===void 0&&(l=Di),s===void 0&&(s={});var f=this;this.options=ft(ft({},g5),l),this.gs=s,this.names=new Map(o),this.server=!!l.isServer,!this.server&&Vo&&z1&&(z1=!1,T1(this)),Yf(this,function(){return(function(d){for(var h=d.getTag(),y=h.length,g="",m=function(w){var T=(function(B){return Zo.get(B)})(w);if(T===void 0)return"continue";var z=d.names.get(T),A=h.getGroup(w);if(z===void 0||!z.size||A.length===0)return"continue";var k="".concat(_i,".g").concat(w,'[id="').concat(T,'"]'),$="";z!==void 0&&z.forEach(function(B){B.length>0&&($+="".concat(B,","))}),g+="".concat(A).concat(k,'{content:"').concat($,'"}').concat(Lf)},S=0;S<y;S++)m(S);return g})(f)})}return a.registerId=function(l){return bo(l)},a.prototype.rehydrate=function(){!this.server&&Vo&&T1(this)},a.prototype.reconstructWithOptions=function(l,s){return s===void 0&&(s=!0),new a(ft(ft({},this.options),l),this.gs,s&&this.names||void 0)},a.prototype.allocateGSInstance=function(l){return this.gs[l]=(this.gs[l]||0)+1},a.prototype.getTag=function(){return this.tag||(this.tag=(l=(function(s){var o=s.useCSSOMInjection,f=s.target;return s.isServer?new m5(f):o?new p5(f):new h5(f)})(this.options),new r5(l)));var l},a.prototype.hasNameForId=function(l,s){return this.names.has(l)&&this.names.get(l).has(s)},a.prototype.registerName=function(l,s){if(bo(l),this.names.has(l))this.names.get(l).add(s);else{var o=new Set;o.add(s),this.names.set(l,o)}},a.prototype.insertRules=function(l,s,o){this.registerName(l,s),this.getTag().insertRules(bo(l),o)},a.prototype.clearNames=function(l){this.names.has(l)&&this.names.get(l).clear()},a.prototype.clearRules=function(l){this.getTag().clearGroup(bo(l)),this.clearNames(l)},a.prototype.clearTag=function(){this.tag=void 0},a})(),x5=/&/g,y5=/^\s*\/\/.*$/gm;function xg(a,l){return a.map(function(s){return s.type==="rule"&&(s.value="".concat(l," ").concat(s.value),s.value=s.value.replaceAll(",",",".concat(l," ")),s.props=s.props.map(function(o){return"".concat(l," ").concat(o)})),Array.isArray(s.children)&&s.type!=="@keyframes"&&(s.children=xg(s.children,l)),s})}function v5(a){var l,s,o,f=Di,d=f.options,h=d===void 0?Di:d,y=f.plugins,g=y===void 0?ss:y,m=function(T,z,A){return A.startsWith(s)&&A.endsWith(s)&&A.replaceAll(s,"").length>0?".".concat(l):T},S=g.slice();S.push(function(T){T.type===as&&T.value.includes("&")&&(T.props[0]=T.props[0].replace(x5,s).replace(o,m))}),h.prefix&&S.push(Xb),S.push(Yb);var w=function(T,z,A,k){z===void 0&&(z=""),A===void 0&&(A=""),k===void 0&&(k="&"),l=k,s=z,o=new RegExp("\\".concat(s,"\\b"),"g");var $=T.replace(y5,""),B=Ub(A||z?"".concat(A," ").concat(z," { ").concat($," }"):$);h.namespace&&(B=xg(B,h.namespace));var q=[];return Xo(B,qb(S.concat(Gb(function(Y){return q.push(Y)})))),q};return w.hash=g.length?g.reduce(function(T,z){return z.name||Wl(15),Mi(T,z.name)},ug).toString():"",w}var b5=new Ko,Sf=v5(),yg=ke.createContext({shouldForwardProp:void 0,styleSheet:b5,stylis:Sf});yg.Consumer;ke.createContext(void 0);function wf(){return v.useContext(yg)}var vg=(function(){function a(l,s){var o=this;this.inject=function(f,d){d===void 0&&(d=Sf);var h=o.name+d.hash;f.hasNameForId(o.id,h)||f.insertRules(o.id,h,d(o.rules,h,"@keyframes"))},this.name=l,this.id="sc-keyframes-".concat(l),this.rules=s,Yf(this,function(){throw Wl(12,String(o.name))})}return a.prototype.getName=function(l){return l===void 0&&(l=Sf),this.name+l.hash},a})(),S5=function(a){return a>="A"&&a<="Z"};function R1(a){for(var l="",s=0;s<a.length;s++){var o=a[s];if(s===1&&o==="-"&&a[0]==="-")return a;S5(o)?l+="-"+o.toLowerCase():l+=o}return l.startsWith("ms-")?"-"+l:l}var bg=function(a){return a==null||a===!1||a===""},Sg=function(a){var l,s,o=[];for(var f in a){var d=a[f];a.hasOwnProperty(f)&&!bg(d)&&(Array.isArray(d)&&d.isCss||$i(d)?o.push("".concat(R1(f),":"),d,";"):Xl(d)?o.push.apply(o,Oi(Oi(["".concat(f," {")],Sg(d),!1),["}"],!1)):o.push("".concat(R1(f),": ").concat((l=f,(s=d)==null||typeof s=="boolean"||s===""?"":typeof s!="number"||s===0||l in Vb||l.startsWith("--")?String(s).trim():"".concat(s,"px")),";")))}return o};function ma(a,l,s,o){if(bg(a))return[];if(Hf(a))return[".".concat(a.styledComponentId)];if($i(a)){if(!$i(d=a)||d.prototype&&d.prototype.isReactComponent||!l)return[a];var f=a(l);return ma(f,l,s,o)}var d;return a instanceof vg?s?(a.inject(s,o),[a.getName(o)]):[a]:Xl(a)?Sg(a):Array.isArray(a)?Array.prototype.concat.apply(ss,a.map(function(h){return ma(h,l,s,o)})):[a.toString()]}function wg(a){for(var l=0;l<a.length;l+=1){var s=a[l];if($i(s)&&!Hf(s))return!1}return!0}var w5=fg(os),j5=(function(){function a(l,s,o){this.rules=l,this.staticRulesId="",this.isStatic=(o===void 0||o.isStatic)&&wg(l),this.componentId=s,this.baseHash=Mi(w5,s),this.baseStyle=o,Ko.registerId(s)}return a.prototype.generateAndInjectStyles=function(l,s,o){var f=this.baseStyle?this.baseStyle.generateAndInjectStyles(l,s,o):"";if(this.isStatic&&!o.hash)if(this.staticRulesId&&s.hasNameForId(this.componentId,this.staticRulesId))f=$a(f,this.staticRulesId);else{var d=Qo(ma(this.rules,l,s,o)),h=vf(Mi(this.baseHash,d)>>>0);if(!s.hasNameForId(this.componentId,h)){var y=o(d,".".concat(h),void 0,this.componentId);s.insertRules(this.componentId,h,y)}f=$a(f,h),this.staticRulesId=h}else{for(var g=Mi(this.baseHash,o.hash),m="",S=0;S<this.rules.length;S++){var w=this.rules[S];if(typeof w=="string")m+=w;else if(w){var T=Qo(ma(w,l,s,o));g=Mi(g,T+S),m+=T}}if(m){var z=vf(g>>>0);s.hasNameForId(this.componentId,z)||s.insertRules(this.componentId,z,o(m,".".concat(z),void 0,this.componentId)),f=$a(f,z)}}return f},a})(),qf=ke.createContext(void 0);qf.Consumer;var Yu={};function E5(a,l,s){var o=Hf(a),f=a,d=!Hu(a),h=l.attrs,y=h===void 0?ss:h,g=l.componentId,m=g===void 0?(function(Z,J){var L=typeof Z!="string"?"sc":S1(Z);Yu[L]=(Yu[L]||0)+1;var V="".concat(L,"-").concat(Uf(os+L+Yu[L]));return J?"".concat(J,"-").concat(V):V})(l.displayName,l.parentComponentId):g,S=l.displayName,w=S===void 0?(function(Z){return Hu(Z)?"styled.".concat(Z):"Styled(".concat(Wb(Z),")")})(a):S,T=l.displayName&&l.componentId?"".concat(S1(l.displayName),"-").concat(l.componentId):l.componentId||m,z=o&&f.attrs?f.attrs.concat(y).filter(Boolean):y,A=l.shouldForwardProp;if(o&&f.shouldForwardProp){var k=f.shouldForwardProp;if(l.shouldForwardProp){var $=l.shouldForwardProp;A=function(Z,J){return k(Z,J)&&$(Z,J)}}else A=k}var B=new j5(s,T,o?f.componentStyle:void 0);function q(Z,J){return(function(L,V,Q){var W=L.attrs,ce=L.componentStyle,de=L.defaultProps,Ye=L.foldedComponentIds,ee=L.styledComponentId,ae=L.target,xe=ke.useContext(qf),_=wf(),K=L.shouldForwardProp||_.shouldForwardProp,P=sg(V,xe,de)||Di,te=(function(re,ue,ye){for(var Ge,Ce=ft(ft({},ue),{className:void 0,theme:ye}),Et=0;Et<re.length;Et+=1){var Jt=$i(Ge=re[Et])?Ge(Ce):Ge;for(var pt in Jt)Ce[pt]=pt==="className"?$a(Ce[pt],Jt[pt]):pt==="style"?ft(ft({},Ce[pt]),Jt[pt]):Jt[pt]}return ue.className&&(Ce.className=$a(Ce.className,ue.className)),Ce})(W,V,P),me=te.as||ae,E={};for(var H in te)te[H]===void 0||H[0]==="$"||H==="as"||H==="theme"&&te.theme===P||(H==="forwardedAs"?E.as=te.forwardedAs:K&&!K(H,me)||(E[H]=te[H]));var F=(function(re,ue){var ye=wf(),Ge=re.generateAndInjectStyles(ue,ye.styleSheet,ye.stylis);return Ge})(ce,te),I=$a(Ye,ee);return F&&(I+=" "+F),te.className&&(I+=" "+te.className),E[Hu(me)&&!cg.has(me)?"class":"className"]=I,Q&&(E.ref=Q),v.createElement(me,E)})(Y,Z,J)}q.displayName=w;var Y=ke.forwardRef(q);return Y.attrs=z,Y.componentStyle=B,Y.displayName=w,Y.shouldForwardProp=A,Y.foldedComponentIds=o?$a(f.foldedComponentIds,f.styledComponentId):"",Y.styledComponentId=T,Y.target=o?f.target:a,Object.defineProperty(Y,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(Z){this._foldedDefaultProps=o?(function(J){for(var L=[],V=1;V<arguments.length;V++)L[V-1]=arguments[V];for(var Q=0,W=L;Q<W.length;Q++)bf(J,W[Q],!0);return J})({},f.defaultProps,Z):Z}}),Yf(Y,function(){return".".concat(Y.styledComponentId)}),d&&mg(Y,a,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),Y}function A1(a,l){for(var s=[a[0]],o=0,f=l.length;o<f;o+=1)s.push(l[o],a[o+1]);return s}var M1=function(a){return Object.assign(a,{isCss:!0})};function $n(a){for(var l=[],s=1;s<arguments.length;s++)l[s-1]=arguments[s];if($i(a)||Xl(a))return M1(ma(A1(ss,Oi([a],l,!0))));var o=a;return l.length===0&&o.length===1&&typeof o[0]=="string"?ma(o):M1(ma(A1(o,l)))}function jf(a,l,s){if(s===void 0&&(s=Di),!l)throw Wl(1,l);var o=function(f){for(var d=[],h=1;h<arguments.length;h++)d[h-1]=arguments[h];return a(l,s,$n.apply(void 0,Oi([f],d,!1)))};return o.attrs=function(f){return jf(a,l,ft(ft({},s),{attrs:Array.prototype.concat(s.attrs,f).filter(Boolean)}))},o.withConfig=function(f){return jf(a,l,ft(ft({},s),f))},o}var jg=function(a){return jf(E5,a)},b=jg;cg.forEach(function(a){b[a]=jg(a)});var C5=(function(){function a(l,s){this.rules=l,this.componentId=s,this.isStatic=wg(l),Ko.registerId(this.componentId+1)}return a.prototype.createStyles=function(l,s,o,f){var d=f(Qo(ma(this.rules,s,o,f)),""),h=this.componentId+l;o.insertRules(h,h,d)},a.prototype.removeStyles=function(l,s){s.clearRules(this.componentId+l)},a.prototype.renderStyles=function(l,s,o,f){l>2&&Ko.registerId(this.componentId+l),this.removeStyles(l,o),this.createStyles(l,s,o,f)},a})();function Eg(a){for(var l=[],s=1;s<arguments.length;s++)l[s-1]=arguments[s];var o=$n.apply(void 0,Oi([a],l,!1)),f="sc-global-".concat(Uf(JSON.stringify(o))),d=new C5(o,f),h=function(g){var m=wf(),S=ke.useContext(qf),w=ke.useRef(m.styleSheet.allocateGSInstance(f)).current;return m.styleSheet.server&&y(w,g,m.styleSheet,S,m.stylis),ke.useLayoutEffect(function(){if(!m.styleSheet.server)return y(w,g,m.styleSheet,S,m.stylis),function(){return d.removeStyles(w,m.styleSheet)}},[w,g,m.styleSheet,S,m.stylis]),null};function y(g,m,S,w,T){if(d.isStatic)d.renderStyles(g,Zb,S,T);else{var z=ft(ft({},m),{theme:sg(m,w,h.defaultProps)});d.renderStyles(g,z,S,T)}}return ke.memo(h)}function $t(a){for(var l=[],s=1;s<arguments.length;s++)l[s-1]=arguments[s];var o=Qo($n.apply(void 0,Oi([a],l,!1))),f=Uf(o);return new vg(f,o)}var Cg={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},O1=ke.createContext&&ke.createContext(Cg),T5=["attr","size","title"];function z5(a,l){if(a==null)return{};var s=R5(a,l),o,f;if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(a);for(f=0;f<d.length;f++)o=d[f],!(l.indexOf(o)>=0)&&Object.prototype.propertyIsEnumerable.call(a,o)&&(s[o]=a[o])}return s}function R5(a,l){if(a==null)return{};var s={};for(var o in a)if(Object.prototype.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function Jo(){return Jo=Object.assign?Object.assign.bind():function(a){for(var l=1;l<arguments.length;l++){var s=arguments[l];for(var o in s)Object.prototype.hasOwnProperty.call(s,o)&&(a[o]=s[o])}return a},Jo.apply(this,arguments)}function k1(a,l){var s=Object.keys(a);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(a);l&&(o=o.filter(function(f){return Object.getOwnPropertyDescriptor(a,f).enumerable})),s.push.apply(s,o)}return s}function Fo(a){for(var l=1;l<arguments.length;l++){var s=arguments[l]!=null?arguments[l]:{};l%2?k1(Object(s),!0).forEach(function(o){A5(a,o,s[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(a,Object.getOwnPropertyDescriptors(s)):k1(Object(s)).forEach(function(o){Object.defineProperty(a,o,Object.getOwnPropertyDescriptor(s,o))})}return a}function A5(a,l,s){return l=M5(l),l in a?Object.defineProperty(a,l,{value:s,enumerable:!0,configurable:!0,writable:!0}):a[l]=s,a}function M5(a){var l=O5(a,"string");return typeof l=="symbol"?l:l+""}function O5(a,l){if(typeof a!="object"||!a)return a;var s=a[Symbol.toPrimitive];if(s!==void 0){var o=s.call(a,l);if(typeof o!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(l==="string"?String:Number)(a)}function Tg(a){return a&&a.map((l,s)=>ke.createElement(l.tag,Fo({key:s},l.attr),Tg(l.child)))}function Ee(a){return l=>ke.createElement(k5,Jo({attr:Fo({},a.attr)},l),Tg(a.child))}function k5(a){var l=s=>{var{attr:o,size:f,title:d}=a,h=z5(a,T5),y=f||s.size||"1em",g;return s.className&&(g=s.className),a.className&&(g=(g?g+" ":"")+a.className),ke.createElement("svg",Jo({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},s.attr,o,h,{className:g,style:Fo(Fo({color:a.color||s.color},s.style),a.style),height:y,width:y,xmlns:"http://www.w3.org/2000/svg"}),d&&ke.createElement("title",null,d),a.children)};return O1!==void 0?ke.createElement(O1.Consumer,null,s=>l(s)):l(Cg)}function Gf(a){return Ee({attr:{viewBox:"0 0 1024 1024"},child:[{tag:"path",attr:{d:"M923 283.6a260.04 260.04 0 0 0-56.9-82.8 264.4 264.4 0 0 0-84-55.5A265.34 265.34 0 0 0 679.7 125c-49.3 0-97.4 13.5-139.2 39-10 6.1-19.5 12.8-28.5 20.1-9-7.3-18.5-14-28.5-20.1-41.8-25.5-89.9-39-139.2-39-35.5 0-69.9 6.8-102.4 20.3-31.4 13-59.7 31.7-84 55.5a258.44 258.44 0 0 0-56.9 82.8c-13.9 32.3-21 66.6-21 101.9 0 33.3 6.8 68 20.3 103.3 11.3 29.5 27.5 60.1 48.2 91 32.8 48.9 77.9 99.9 133.9 151.6 92.8 85.7 184.7 144.9 188.6 147.3l23.7 15.2c10.5 6.7 24 6.7 34.5 0l23.7-15.2c3.9-2.5 95.7-61.6 188.6-147.3 56-51.7 101.1-102.7 133.9-151.6 20.7-30.9 37-61.5 48.2-91 13.5-35.3 20.3-70 20.3-103.3.1-35.3-7-69.6-20.9-101.9z"},child:[]}]})(a)}function Xf(a){return Ee({attr:{viewBox:"0 0 1024 1024"},child:[{tag:"path",attr:{d:"M923 283.6a260.04 260.04 0 0 0-56.9-82.8 264.4 264.4 0 0 0-84-55.5A265.34 265.34 0 0 0 679.7 125c-49.3 0-97.4 13.5-139.2 39-10 6.1-19.5 12.8-28.5 20.1-9-7.3-18.5-14-28.5-20.1-41.8-25.5-89.9-39-139.2-39-35.5 0-69.9 6.8-102.4 20.3-31.4 13-59.7 31.7-84 55.5a258.44 258.44 0 0 0-56.9 82.8c-13.9 32.3-21 66.6-21 101.9 0 33.3 6.8 68 20.3 103.3 11.3 29.5 27.5 60.1 48.2 91 32.8 48.9 77.9 99.9 133.9 151.6 92.8 85.7 184.7 144.9 188.6 147.3l23.7 15.2c10.5 6.7 24 6.7 34.5 0l23.7-15.2c3.9-2.5 95.7-61.6 188.6-147.3 56-51.7 101.1-102.7 133.9-151.6 20.7-30.9 37-61.5 48.2-91 13.5-35.3 20.3-70 20.3-103.3.1-35.3-7-69.6-20.9-101.9zM512 814.8S156 586.7 156 385.5C156 283.6 240.3 201 344.3 201c73.1 0 136.5 40.8 167.7 100.4C543.2 241.8 606.6 201 679.7 201c104 0 188.3 82.6 188.3 184.5 0 201.2-356 429.3-356 429.3z"},child:[]}]})(a)}function Vf(a){return Ee({attr:{fill:"currentColor",viewBox:"0 0 16 16"},child:[{tag:"path",attr:{d:"M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2"},child:[]}]})(a)}function Qf(a){return Ee({attr:{fill:"currentColor",viewBox:"0 0 16 16"},child:[{tag:"path",attr:{d:"M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"},child:[]}]})(a)}function Zf(a){return Ee({attr:{fill:"currentColor",viewBox:"0 0 16 16"},child:[{tag:"path",attr:{d:"M2.678 11.894a1 1 0 0 1 .287.801 11 11 0 0 1-.398 2c1.395-.323 2.247-.697 2.634-.893a1 1 0 0 1 .71-.074A8 8 0 0 0 8 14c3.996 0 7-2.807 7-6s-3.004-6-7-6-7 2.808-7 6c0 1.468.617 2.83 1.678 3.894m-.493 3.905a22 22 0 0 1-.713.129c-.2.032-.352-.176-.273-.362a10 10 0 0 0 .244-.637l.003-.01c.248-.72.45-1.548.524-2.319C.743 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7-3.582 7-8 7a9 9 0 0 1-2.347-.306c-.52.263-1.639.742-3.468 1.105"},child:[]}]})(a)}function zg(a){return Ee({attr:{fill:"currentColor",viewBox:"0 0 16 16"},child:[{tag:"path",attr:{d:"M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3"},child:[]}]})(a)}function N5(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"circle",attr:{cx:"12",cy:"8",r:"7"},child:[]},{tag:"polyline",attr:{points:"8.21 13.89 7 23 12 20 17 23 15.79 13.88"},child:[]}]})(a)}function Rg(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{d:"M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"},child:[]},{tag:"path",attr:{d:"M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"},child:[]}]})(a)}function _5(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"polyline",attr:{points:"18 15 12 9 6 15"},child:[]}]})(a)}function D5(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},child:[]}]})(a)}function Ag(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{d:"M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"},child:[]},{tag:"polyline",attr:{points:"9 22 9 12 15 12 15 22"},child:[]}]})(a)}function $5(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"line",attr:{x1:"3",y1:"12",x2:"21",y2:"12"},child:[]},{tag:"line",attr:{x1:"3",y1:"6",x2:"21",y2:"6"},child:[]},{tag:"line",attr:{x1:"3",y1:"18",x2:"21",y2:"18"},child:[]}]})(a)}function Kf(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"line",attr:{x1:"22",y1:"2",x2:"11",y2:"13"},child:[]},{tag:"polygon",attr:{points:"22 2 15 22 11 13 2 9 22 2"},child:[]}]})(a)}function B5(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"polygon",attr:{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"},child:[]}]})(a)}function Mg(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"},child:[]},{tag:"circle",attr:{cx:"12",cy:"7",r:"4"},child:[]}]})(a)}function L5(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"line",attr:{x1:"18",y1:"6",x2:"6",y2:"18"},child:[]},{tag:"line",attr:{x1:"6",y1:"6",x2:"18",y2:"18"},child:[]}]})(a)}function N1(a){return Ee({attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"polygon",attr:{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2"},child:[]}]})(a)}const U5="/instalearn/assets/Slide11-BQ1quwNm.mp4",H5="/instalearn/assets/test-BrOnAr5c.png",Y5="/instalearn/assets/teacherProfilePic-DPrjIuTX.png",q5="/instalearn/assets/Slide1-CH0r16yo.png",G5="/instalearn/assets/Slide3-B6C07YuO.png",X5="/instalearn/assets/Slide5-BsOulZPi.png",V5="/instalearn/assets/Slide6-8dQDHdn3.png",Q5="/instalearn/assets/Slide1-CH0r16yo.png",Z5="/instalearn/assets/Slide10-BP0-oJ-v.gif",K5="/instalearn/assets/Slide11-BQ1quwNm.mp4",So={},_1={videoClip1:U5},J5={test:H5},Il={teacherProfilePic:Y5},An={Slide1:q5,Slide3:G5,Slide5:X5,Slide6:V5,Slide7:Q5,Slide10:Z5,Slide11:K5};function F5(a){return Ee({attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32",d:"M304 384v-24c0-29 31.54-56.43 52-76 28.84-27.57 44-64.61 44-108 0-80-63.73-144-144-144a143.6 143.6 0 0 0-144 144c0 41.84 15.81 81.39 44 108 20.35 19.21 52 46.7 52 76v24m16 96h64m-80-48h96m-48-48V256"},child:[]},{tag:"path",attr:{fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"32",d:"M294 240s-21.51 16-38 16-38-16-38-16"},child:[]}]})(a)}const W5=b.article`
  width: 100%;
  max-width: 680px;
  margin: 0 auto;
  background: #fff;
...
`,p3=b.div`
  display: grid;
  gap: 8px;
`,h3=b.button.withConfig({shouldForwardProp:a=>a!=="$state"})`
  text-align: left;
  font-size: 13px;
...
`,kg=b.button`
  ...
  cursor: pointer;
  font-size: 12px;
`;async function g3(a){const s=await(await fetch(a,{mode:"cors"})).blob(),o=s.type||"image/jpeg",f=await s.arrayBuffer(),d=new Uint8Array(f);let h="";for(let g=0;g<d.byteLength;g++)h+=String.fromCharCode(d[g]);return{base64:btoa(h),mime:o}}function x3({title:a,description:l,username:s}){return`
...
- Caption: "${l}"
- Author: "${s}"
`.trim()}async function y3(a){const{title:l,description:s,username:o,imageUrl:f}=a,d="AIzaSyDYGHcNYuuk43rrYSBVBIQGegzOGVtjGrw",{base64:h,mime:y}=await g3(f),m={contents:[{parts:[{text:x3({title:l,description:s,username:o})},{inline_data:{mime_type:y,data:h}}]}],generationConfig:{temperature:.6,topK:32,topP:.9,maxOutputTokens:1200,response_mime_type:"application/json"}},S="https://generativelanguage.googleapis.com/v1beta",w=["gemini-2.5-flash","gemini-2.0-flash"];let T;for(const z of w)try{const A=`${S}/models/${z}:generateContent?key=${encodeURIComponent(d)}`,k=await fetch(A,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(m)});if(!k.ok)throw new Error(`Gemini error (${k.status}): ${await k.text()}`);const B=(await k.json())?.candidates?.[0]?.content?.parts?.[0]?.text;if(!B)throw new Error("Empty response from Gemini");let q;try{q=JSON.parse(B)}catch{const L=String(B).replace(/^```json\s*/i,"").replace(/^```\s*/i,"").replace(/```$/i,"").trim();q=JSON.parse(L)}const Y=Array.isArray(q.bullets)?q.bullets.slice(0,5):[],Z=Array.isArray(q.mcqs)?q.mcqs.slice(0,5):[];if(!Y.length||!Z.length)throw new Error("Malformed AI content");const J=Z.map(L=>({question:String(L.question||"").slice(0,140),options:Array.isArray(L.options)&&L.options.length?L.options.slice(0,5):["Not present"],correctIndex:Number.isInteger(L.correctIndex)?L.correctIndex:0,explanation:L.explanation?String(L.explanation).slice(0,140):void 0}));return{bullets:Y,mcqs:J}}catch(A){T=A}throw T||new Error("Gemini request failed")}function v3({avatarSrc:a=Il.teacherProfilePic,title:l,description:s,imgSrc:o,username:f,postUrl:d,onLikeChange:h,onBookmarkChange:y,onShare:g}){const[m,S]=v.useState(!1),[w,T]=v.useState(!1),[z,A]=v.useState(!1),[k,$]=v.useState(!1),[B,q]=v.useState(null),[Y,Z]=v.useState(null),[J,L]=v.useState(0);v.useEffect(()=>{const te=Y?.mcqs?.length||0;te!==0&&L(me=>Math.max(0,Math.min(me,te-1)))},[Y?.mcqs?.length]);const V=m?"Unlike":"Like",Q=w?"Remove bookmark":"Bookmark",W=()=>{const te=!m;S(te),h&&h(te)},ce=()=>{const te=!w;T(te),y&&y(te)},de=v.useMemo(()=>({title:l,text:`${f} on Infographics — ${l}`,url:d}),[l,f,d]),Ye=async()=>{try{navigator.share?await navigator.share(de):navigator.clipboard&&de.url&&(await navigator.clipboard.writeText(de.url),alert("Link copied to clipboard")),g&&g(de)}catch(te){console.error("Share failed:",te)}},ee=async()=>{$(!0),q(null);try{const te=await y3({title:l,description:s,username:f,imageUrl:o});Z(te),L(0)}catch(te){console.error(te),q(te?.message||"Failed to generate content")}finally{$(!1)}},ae=()=>{const te=!z;A(te),te&&!Y&&!k&&ee()},xe=Y?.mcqs?.length||0,_=xe?Y.mcqs[J]:null,K=J===xe-1,P=()=>L(te=>Math.min(te+1,xe-1));return u.jsxs(W5,{role:"article","aria-label":`${l} instagram-style post`,children:[u.jsxs(I5,{children:[u.jsxs(P5,{children:[u.jsx(e3,{src:a,alt:"avatar"}),u.jsxs(t3,{children:[u.jsx(n3,{children:l}),u.jsx(a3,{children:s})]})]}),u.jsx(i3,{"aria-label":z?"Close learn mode":"Open learn mode",title:z?"Close learn mode":"Learn more & quiz",onClick:ae,children:u.jsx(F5,{size:18})})]}),z?u.jsxs(c3,{"aria-live":"polite",children:[u.jsxs(D1,{children:[u.jsx($1,{children:"Know more (5 quick points)"}),k?u.jsxs("div",{style:{display:"grid",gap:8},children:[u.jsx(on,{}),u.jsx(on,{}),u.jsx(on,{}),u.jsx(on,{}),u.jsx(on,{})]}):B?u.jsxs(B1,{children:[u.jsx("span",{style:{flex:1,minWidth:0},children:B}),u.jsx(L1,{onClick:ee,"aria-label":"Retry generating content",children:"Retry"})]}):u.jsx(u3,{children:Y?.bullets?.map((te,me)=>u.jsx("li",{children:te},me))})]}),u.jsxs(D1,{children:[u.jsxs(Og,{children:[u.jsx($1,{style:{margin:0},children:"Test your knowledge"}),xe?u.jsxs(qo,{children:[J+1," / ",xe]}):null]}),k?u.jsxs("div",{style:{display:"grid",gap:10},children:[u.jsx(on,{h:16}),u.jsx(on,{h:40}),u.jsx(on,{h:40}),u.jsx(on,{h:40}),u.jsx(on,{h:40})]}):B?u.jsxs(B1,{children:[u.jsx("span",{style:{flex:1,minWidth:0},children:"Can’t load questions."}),u.jsx(L1,{onClick:ee,children:"Retry"})]}):_?u.jsx(b3,{mcq:_,index:J+1,total:xe,isLast:K,onNext:K?void 0:P,onFinish:K?()=>A(!1):void 0},J):null,!k&&!B&&_&&!K?u.jsx("div",{style:{marginTop:6},children:u.jsx(qo,{children:"Tip: You can change your choice before tapping Next."})}):null]}),u.jsxs(m3,{children:[u.jsx(qo,{children:"AI stays within the infographic; short, clear answers only."}),u.jsx(kg,{onClick:()=>A(!1),"aria-label":"Back to image",title:"Back to image",children:"Back to image"})]})]}):u.jsx(l3,{children:u.jsx(r3,{src:o,alt:l})}),u.jsxs(o3,{children:[u.jsxs(s3,{children:[u.jsx(wo,{onClick:W,"aria-label":V,title:V,children:m?u.jsx(Gf,{size:22}):u.jsx(Xf,{size:22})}),u.jsx(wo,{"aria-label":"Comment",title:"Comment",children:u.jsx(Zf,{size:20})}),u.jsx(wo,{onClick:Ye,"aria-label":"Share",title:"Share",children:u.jsx(Kf,{size:20})})]}),u.jsx(wo,{onClick:ce,"aria-label":Q,title:Q,children:w?u.jsx(Vf,{size:20}):u.jsx(Qf,{size:20})})]})]})}function b3({mcq:a,index:l,total:s,isLast:o,onNext:f,onFinish:d}){const[h,y]=v.useState(null),g=m=>h===null?"idle":m===a.correctIndex?"correct":m===h&&h!==a.correctIndex?"wrong":"idle";return u.jsxs(f3,{"aria-label":`Question ${l}`,children:[u.jsxs(d3,{children:[l,". ",a.question]}),u.jsx(p3,{children:a.options.map((m,S)=>u.jsx(h3,{onClick:()=>y(S),$state:g(S),"aria-pressed":h===S,"aria-label":`Option ${S+1}`,children:m},S))}),h!==null&&u.jsxs("div",{style:{display:"grid",gap:8},children:[u.jsxs(qo,{children:[h===a.correctIndex?"✅ Correct.":"❌ Not quite.",a.explanation?` — ${a.explanation}`:""]}),o?u.jsxs(Og,{children:[u.jsx(U1,{onClick:d,"aria-label":"Finish quiz",children:"Finish"}),u.jsx(kg,{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"Back to top"})]}):u.jsxs(U1,{onClick:f,"aria-label":"Next question",disabled:h===null,children:["Next question (",l+1,"/",s,")"]})]})]})}const S3=b.div``,w3=b.div`
  display: flex;
  overflow-x: auto;
  padding: 24px 0;
...
`,Ng=`
  ...
  margin-left: 20px;
`,E3=b.img`${Ng}`,C3=b.video`${Ng}`,T3=b.div`
  position: fixed;
  inset: 0;
...
`,M3=b.img`${_g}`,O3=b.video`${_g}`,k3=b.button`
  position: absolute;
  top: 24px;
  right: 24px;
...
`,B3=b.video`
  ...
  border-radius: 8px;
  display: block;
`,H1=(a,l,s)=>Math.max(l,Math.min(s,a));function L3(a){const l=(a.type||"img").toLowerCase(),s=a.src||a.imgSrc||a.videoClipSrc,o=a.poster||a.thumb||a.thumbnail,f=a.name||a.title||"";return{type:l,src:s,poster:o,name:f,id:a.id}}class U3 extends ke.Component{state={hasError:!1};static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(l,s){console.error("Carousel error:",l,s)}render(){return this.state.hasError?u.jsx("div",{style:{color:"#fff",padding:16,textAlign:"center"},children:"Something went wrong while rendering the carousel."}):this.props.children}}function H3({items:a=[],className:l}){const s=v.useRef(null),o=v.useRef(!1),f=v.useRef(0),d=v.useRef(0),h=v.useRef(0),[y,g]=v.useState(!1),[m,S]=v.useState(0),[w,T]=v.useState(!0),z=v.useRef(null),A=v.useMemo(()=>(a||[]).map(L3).filter(ee=>!!ee.src),[a]),k=v.useRef([]);k.current.length!==A.length&&(k.current=A.map((ee,ae)=>k.current[ae]??ke.createRef()));const $=typeof window<"u"&&typeof document<"u";v.useEffect(()=>{if(!$)return;const ee=document.body.style.overflow;return y&&(document.body.style.overflow="hidden"),()=>{document.body.style.overflow=ee||""}},[y,$]),v.useEffect(()=>{y&&(k.current[m]?.current?.scrollIntoView({block:"nearest",inline:"center",behavior:"auto"}),T(!0))},[y,m]),v.useEffect(()=>{if(!y||!$)return;const ee=ae=>{ae.key==="Escape"&&g(!1),ae.key==="ArrowRight"&&Y(m+1),ae.key==="ArrowLeft"&&Y(m-1),ae.key.toLowerCase()==="h"&&T(xe=>!xe)};return window.addEventListener("keydown",ee),()=>window.removeEventListener("keydown",ee)},[y,m,$]);const B=v.useMemo(()=>{if(typeof window>"u"||!z.current)return 0;const ee=window.getComputedStyle(z.current),ae=parseFloat(ee.gap)||0;return(z.current.clientWidth||0)+ae},[y]),q=()=>{if(!z.current||B===0)return;const{scrollLeft:ee}=z.current,ae=Math.round(ee/B),xe=H1(ae,0,A.length-1);xe!==m&&S(xe)},Y=ee=>{const ae=H1(ee,0,Math.max(0,A.length-1));if(S(ae),!z.current)return;const xe=B*ae;z.current.scrollTo({left:xe,behavior:"smooth"})},Z=ee=>{const ae=Number(ee.target.value);Y(ae)},L={"--filled":`${A.length>1?m/(A.length-1)*100:0}%`},V=ee=>{if(ee.pointerType==="mouse"&&s.current){o.current=!0,h.current=0,f.current=ee.clientX,d.current=s.current.scrollLeft||0;try{s.current.setPointerCapture?.(ee.pointerId)}catch{console.log("error")}}},Q=ee=>{if(ee.pointerType!=="mouse"||!o.current||!s.current)return;const ae=ee.clientX-f.current;h.current=Math.max(h.current,Math.abs(ae)),s.current.scrollLeft=d.current-ae},W=()=>{o.current=!1},ce=6,de=ee=>{h.current>ce||(S(ee),T(!0),g(!0))},Ye=ee=>{const ae=ee.target,xe=ae.tagName&&ae.tagName.toLowerCase(),_=xe==="img"||xe==="video",K=ae.closest?.('[data-interactive="true"]');_||K||T(P=>!P)};return v.useEffect(()=>{if(!y)return;(z.current?.querySelectorAll("video[data-slide-video='true']")||[]).forEach((ae,xe)=>{xe===m?(ae.muted=!0,ae.play().catch(()=>{})):(ae.pause(),ae.currentTime=0)})},[y,m]),!A||A.length===0?null:u.jsxs(S3,{className:l,children:[u.jsx(w3,{ref:s,onPointerDown:V,onPointerMove:Q,onPointerUp:W,onPointerLeave:W,children:A.map((ee,ae)=>u.jsx(j3,{onClick:()=>de(ae),children:ee.type==="video"?u.jsx(C3,{src:ee.src,poster:ee.poster,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-label":ee.name||`Video ${ae+1}`}):u.jsx(E3,{src:ee.src,alt:ee.name??`Item ${ae+1}`,draggable:!1})},ee.id??ae))}),y&&u.jsx(T3,{role:"dialog","aria-modal":"true","aria-label":"Media lightbox",children:u.jsxs(z3,{onClick:Ye,children:[u.jsxs(q3,{$show:w,children:[m+1," / ",A.length]}),u.jsx(k3,{$show:w,onClick:()=>g(!1),"aria-label":"Close","data-interactive":"true",children:u.jsx(L5,{})}),u.jsx(R3,{ref:z,onScroll:q,children:A.map((ee,ae)=>u.jsx(A3,{ref:k.current[ae],children:ee.type==="video"?u.jsx(O3,{"data-slide-video":"true",src:ee.src,poster:ee.poster,controls:!0,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto","aria-label":ee.name??`Video ${ae+1}`}):u.jsx(M3,{src:ee.src,alt:ee.name??`Image ${ae+1}`})},ee.id??ae))}),u.jsx(N3,{$show:w,"data-interactive":"true",children:u.jsx(_3,{min:0,max:Math.max(0,A.length-1),step:1,value:m,onChange:Z,style:L,"aria-label":"Media scrubber"})}),u.jsx(D3,{$show:w,"aria-label":"Thumbnails","data-interactive":"true",children:A.map((ee,ae)=>u.jsx(Dg,{$active:ae===m,onClick:()=>Y(ae),"aria-label":`Go to item ${ae+1}`,children:ee.type==="video"?u.jsx(B3,{src:ee.src,poster:ee.poster,muted:!0,loop:!0,playsInline:!0,preload:"metadata"}):u.jsx($3,{src:ee.src,alt:ee.name??`Thumbnail ${ae+1}`})},ee.id??ae))})]})})]})}function Y3(a){return u.jsx(U3,{children:u.jsx(H3,{...a})})}const q3=b.div`
  position: absolute;
  top: 24px;
  left: 24px;
...
`,a4=(a=1)=>({display:"-webkit-box",WebkitBoxOrient:"vertical",overflow:"hidden",WebkitLineClamp:a});function i4({expanded:a=!1,lines:l=1,children:s,innerRef:o}){const f={fontSize:"13px",color:"#334155",margin:0,whiteSpace:"pre-wrap",...a?{}:a4(l)};return u.jsx("p",{style:f,ref:o,children:s})}function l4({avatarSrc:a=Il.teacherProfilePic,data:l,onLikeChange:s,onBookmarkChange:o,onShare:f}){const{title:d="Carousel Title",description:h="",detailedDescription:y="",carouselMetaData:g=[]}=l||{},[m,S]=v.useState(!1),[w,T]=v.useState(!1),[z,A]=v.useState(!1),[k,$]=v.useState(!1),B=v.useRef(null);v.useEffect(()=>{const Q=B.current;if(Q){if(z){$(!0);return}requestAnimationFrame(()=>{if(!Q)return;const W=Q.scrollHeight-Q.clientHeight>1;$(W)})}},[y,z]);const q=m?"Unlike post":"Like post",Y=w?"Remove bookmark":"Bookmark",Z=()=>{const Q=!m;S(Q),s&&s(Q)},J=()=>{const Q=!w;T(Q),o&&o(Q)},L=v.useMemo(()=>({title:d,text:`${d}`,url:typeof window<"u"?window.location.href:""}),[d]),V=async()=>{try{navigator.share?await navigator.share(L):navigator.clipboard&&(await navigator.clipboard.writeText(L.url),alert("Link copied to clipboard")),f&&f(L)}catch(Q){console.error("Share failed:",Q)}};return!g||g.length===0?null:u.jsxs(X3,{role:"article","aria-label":`${d} – Instagram multi-image post`,children:[u.jsxs(K3,{children:[u.jsxs(J3,{children:[u.jsxs(F3,{children:[u.jsx(W3,{src:a,alt:"avatar"}),u.jsxs(I3,{children:[u.jsx(P3,{children:d}),u.jsx(t4,{children:h})]})]}),u.jsx(Z3,{"aria-label":"Post menu",title:"More",children:u.jsx(zg,{size:18})})]}),y?u.jsxs(e4,{children:[u.jsx(i4,{expanded:z,lines:1,innerRef:B,children:y}),(k||z)&&u.jsx(n4,{type:"button","aria-expanded":z,onClick:()=>A(Q=>!Q),children:z?u.jsx(_5,{size:14}):"more"})]}):null]}),u.jsx(G3,{}),u.jsx(Y3,{items:g,duration:3e3}),u.jsxs(V3,{children:[u.jsxs(Q3,{children:[u.jsx(jo,{onClick:Z,"aria-label":q,title:q,children:m?u.jsx(Gf,{size:22}):u.jsx(Xf,{size:22})}),u.jsx(jo,{"aria-label":"Comment",title:"Comment",children:u.jsx(Zf,{size:20})}),u.jsx(jo,{onClick:V,"aria-label":"Share",title:"Share",children:u.jsx(Kf,{size:20})})]}),u.jsx(jo,{onClick:J,"aria-label":Y,title:Y,children:w?u.jsx(Vf,{size:20}):u.jsx(Qf,{size:20})})]})]})}const r4=b.article`
  width: 100%;
  max-width: 1000px;
  margin: 20px auto;
  border-radius: 12px;
...
`;function _4({currentItem:a,isOpen:l,slideIndex:s,setSlideIndex:o,onClose:f,duration:d=3e3}){const h=a?.slides?.length||0,{resetTimer:y,getProgressValue:g}=b4({isOpen:l,activeIndex:s,setActiveIndex:o,total:h,onClose:f,duration:d}),m=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,[,S]=v.useState(0);v.useEffect(()=>{if(!l||m)return;let A;const k=()=>{S($=>$+1),A=requestAnimationFrame(k)};return A=requestAnimationFrame(k),()=>cancelAnimationFrame(A)},[l,m]);const w=v.useCallback(()=>{a&&(s<h-1?(o(A=>A+1),y()):f())},[a,s,h,y,f,o]),T=v.useCallback(()=>{a&&(s>0?(o(A=>A-1),y()):f())},[a,s,y,f,o]);v.useEffect(()=>{const A=k=>{l&&(k.key==="Escape"&&f(),k.key==="ArrowRight"&&w(),k.key==="ArrowLeft"&&T())};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[l,w,T,f]),v.useEffect(()=>(l?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[l]);const z=A=>A<s?1:A>s?0:g();return!l||!a?null:u.jsx(S4,{onClick:f,"aria-label":"Story overlay",children:u.jsx(w4,{onClick:A=>A.stopPropagation(),children:u.jsxs(j4,{children:[u.jsx(E4,{"aria-label":"Story progress",children:a.slides.map((A,k)=>u.jsx(C4,{"aria-label":`Progress track ${k+1}`,children:u.jsx(T4,{style:{width:`${z(k)*100}%`}})},k))}),u.jsxs(z4,{children:[u.jsx(R4,{src:a.img,alt:a.name}),u.jsxs(A4,{children:[u.jsx(M4,{children:a.name}),u.jsx(O4,{children:"Chapter highlight"})]}),u.jsx(k4,{"aria-label":"Close story",onClick:f,title:"Close",children:u.jsx(v4,{})})]}),a.slides.map((A,k)=>u.jsx(N4,{src:A,alt:`Slide ${k+1}`,$active:k===s,draggable:!1},k)),u.jsx(Y1,{$side:"left",onClick:T,"aria-label":"Previous slide"}),u.jsx(Y1,{$side:"right",onClick:w,"aria-label":"Next slide"})]})})})}const D4=b.div``,$4=b.div`
...
`;function G4({items:a,duration:l=3e3,onOpen:s,onClose:o,className:f}){const d=v.useRef(null),h=v.useRef(!1),y=v.useRef(0),g=v.useRef(0),[m,S]=v.useState(a||[]),[w,T]=v.useState(null),[z,A]=v.useState(0),k=m.find(L=>L.id===w)||null,$=!!w,B=L=>{A(0),T(L),S(V=>V.map(Q=>Q.id===L?{...Q,hasNew:!1}:Q)),s&&s(L)},q=()=>{T(null),o&&o()},Y=L=>{h.current=!0,y.current=L.clientX,g.current=d.current?.scrollLeft||0,L.target.setPointerCapture?.(L.pointerId)},Z=L=>{if(!h.current||!d.current)return;const V=L.clientX-y.current;d.current.scrollLeft=g.current-V},J=()=>{h.current=!1};return u.jsxs(D4,{className:f,children:[u.jsx($4,{children:u.jsx(B4,{ref:d,onPointerDown:Y,onPointerMove:Z,onPointerUp:J,onPointerLeave:J,"aria-label":"Stories scroller",children:m.map(L=>u.jsxs(L4,{onClick:()=>B(L.id),"aria-label":`Open story ${L.name}`,title:L.name,children:[u.jsx(U4,{$hasNew:L.hasNew,children:u.jsx(H4,{children:u.jsx(Y4,{src:L.img,alt:L.name,draggable:!1})})}),u.jsx(q4,{children:L.name})]},L.id))})}),u.jsx(_4,{currentItem:k,isOpen:$,slideIndex:z,setSlideIndex:A,onClose:q,duration:l})]})}const X4=[{id:1,type:"infografic",title:"Sense of Collective Identity - Overview",description:"An overview of how shared history, culture, and values shape collective identity in society.",detailedDescription:"Collective identity is the shared sense of belonging among individuals who associate themselves with a larger group or community. It is shaped by shared language, culture, traditions, and values that connect people to a collective purpose. Understanding this helps explain how societies maintain unity and continuity over time.",imgSrc:An.Slide1},{id:2,type:"carousel",title:"Understanding Collective Identity",description:"Exploring the roots and importance of collective identity in social cohesion.",detailedDescription:"This section examines how collective identity emerges from shared experiences, beliefs, and cultural narratives. It plays a crucial role in fostering social solidarity, promoting cooperation, and helping individuals find meaning through group affiliation.",carouselMetaData:[{id:1,type:"img",src:An.Slide3},{id:2,type:"gif",src:An.Slide10},{id:3,type:"video",src:An.Slide11},{id:4,type:"img",src:An.Slide6}]},{id:3,type:"carousel",title:"Symbols and Shared Culture",description:"How flags, festivals, and traditions represent unity and belonging.",detailedDescription:"Symbols such as national flags, anthems, and cultural rituals embody the essence of collective identity. These shared symbols reinforce emotional ties, transmit values, and sustain collective memory.",carouselMetaData:[{id:1,type:"img",src:An.Slide7},{id:2,type:"gif",src:An.Slide10},{id:3,type:"video",src:An.Slide11}]},{id:5,type:"videoClip",title:"Collective Identity in Action",description:"A short video summarizing real-world examples of collective identity shaping societies.",detailedDescription:"This video highlights real-world scenarios where collective identity has influenced social and political movements.",videoClipSrc:_1.videoClip1},{id:6,type:"infografic",title:"Evolution of Collective Identity",description:"Tracing the historical development of group identity across civilizations.",detailedDescription:"Collective identity has evolved alongside human societies — from tribal affiliations and religious communities to modern national and digital identities.",imgSrc:An.Slide5},{id:7,type:"videoClip",title:"Evolution of Collective Identity",description:"Tracing the historical development of group identity across civilizations.",detailedDescription:"Collective identity has evolved alongside human societies — from tribal affiliations and religious communities to modern national and digital identities.",videoClipSrc:_1.videoClip1}],V4=b.div`
  ...
  background: radial-gradient(
    ...
    #f8fafc;
`;function Q4(){return v.useEffect(()=>{window.scrollTo({top:0,left:0,behavior:"auto"})},[]),u.jsxs(u.Fragment,{children:[u.jsx(G4,{items:y4,duration:3e3,onOpen:a=>console.log("opened:",a),onClose:()=>console.log("closed")}),u.jsx(V4,{children:u.jsx("div",{className:"d-flex gap-3 flex-column align-items-center mt-3",children:X4.map(a=>u.jsx("div",{style:{width:"100%"},children:a.type==="infografic"?u.jsx(v3,{title:a.title,description:a.description,imgSrc:a.imgSrc,badge:a.badge}):a.type==="carousel"?u.jsx(l4,{data:a}):a.type==="videoClip"?u.jsx(x4,{data:a}):null},a.id))})})]})}/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Z4=a=>a.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),K4=a=>a.replace(/^([A-Z])|[\s-_]+(\w)/g,(l,s,o)=>o?o.toUpperCase():s.toLowerCase()),q1=a=>{const l=K4(a);return l.charAt(0).toUpperCase()+l.slice(1)},$g=(...a)=>a.filter((l,s,o)=>!!l&&l.trim()!==""&&o.indexOf(l)===s).join(" ").trim(),J4=a=>{for(const l in a)if(l.startsWith("aria-")||l==="role"||l==="title")return!0};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W4=v.forwardRef(({color:a="currentColor",size:l=24,strokeWidth:s=2,absoluteStrokeWidth:o,className:f="",children:d,iconNode:h,...y},g)=>v.createElement("svg",{ref:g,...F4,width:l,height:l,stroke:a,strokeWidth:o?Number(s)*24/Number(l):s,className:$g("lucide",f),...!d&&!J4(y)&&{"aria-hidden":"true"},...y},[...h.map(([m,S])=>v.createElement(m,S)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dt=(a,l)=>{const s=v.forwardRef(({className:o,...f},d)=>v.createElement(W4,{ref:d,iconNode:l,className:$g(`lucide-${Z4(q1(a))}`,`lucide-${a}`,o),...f}));return s.displayName=q1(a),s};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I4=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]],P4=dt("arrow-right",I4);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const n6=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],Wo=dt("book-open",n6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a6=[["path",{d:"m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z",key:"1fy3hk"}]],i6=dt("bookmark",a6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l6=[["rect",{width:"16",height:"20",x:"4",y:"2",rx:"2",key:"1nb95v"}],["line",{x1:"8",x2:"16",y1:"6",y2:"6",key:"x4nwl0"}],["line",{x1:"16",x2:"16",y1:"14",y2:"18",key:"wjye3r"}],["path",{d:"M16 10h.01",key:"1m94wz"}],["path",{d:"M12 10h.01",key:"1nrarc"}],["path",{d:"M8 10h.01",key:"19clt8"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M8 14h.01",key:"6423bh"}],["path",{d:"M12 18h.01",key:"mhygvu"}],["path",{d:"M8 18h.01",key:"lrp35t"}]],r6=dt("calculator",l6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const o6=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],Bg=dt("check",o6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const s6=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],Jf=dt("chevron-left",s6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c6=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Lg=dt("chevron-right",c6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const d6=[["path",{d:"M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2",key:"18mbvz"}],["path",{d:"M6.453 15h11.094",key:"3shlmq"}],["path",{d:"M8.5 2h7",key:"csnxdl"}]],G1=dt("flask-conical",d6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const m6=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]],X1=dt("globe",m6);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S6=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],qu=dt("x",S6),w6=b.div`
  padding: 35px;
  text-align: center;
  display: grid;
  gap: 16px;
...
`;function R6({onStart:a}){return u.jsxs(w6,{children:[u.jsx(j6,{children:u.jsx(h6,{size:40,color:"#1f2937"})}),u.jsxs(E6,{children:[u.jsx(C6,{children:"Welcome to Pi learn"}),u.jsx(T6,{children:"Your personalized learning journey starts here. Connect with expert teachers and unlock your full potential."})]}),u.jsxs(z6,{onClick:a,"aria-label":"Get started",children:["Get Started ",u.jsx(P4,{size:18})]})]})}const A6=b.div`
padding: 35px;
position: relative;
overflow: visible;
`,M6=b.button`
...
`;function H6({options:a,value:l,onChange:s,onNext:o}){const d=ke.useRef(null),h=g=>{const m=a.indexOf(g);if(m===-1)return;const S=d.current.clientHeight/2-48/2;d.current.scrollTo({top:S+m*48,behavior:"smooth"}),s(g),o&&o()},y={height:`calc(50% - ${48/2}px)`};return u.jsx(_6,{children:u.jsxs(D6,{ref:d,children:[u.jsx($6,{}),u.jsxs(B6,{children:[u.jsx(V1,{$height:y.height}),a.map((g,m)=>u.jsx(L6,{$height:48,$delay:`${m*.02}s`,$isSelected:g===l,onClick:()=>h(g),children:g},g)),u.jsx(V1,{$height:y.height})]})]})})}function Y6({grades:a,selectedGrade:l,onSelect:s,onBack:o,onNext:f}){const d=Object.keys(a);return ke.useEffect(()=>{!l&&d.length>0&&s(d[0])},[l,d,s]),u.jsxs(A6,{children:[u.jsx(M6,{onClick:o,"aria-label":"Go back",children:u.jsx(Jf,{size:24})}),u.jsxs(O6,{children:[u.jsx(k6,{children:"Choose your Grade"}),u.jsx(N6,{children:"Swipe or tap to select a grade."})]}),u.jsx(H6,{options:d,value:l||d[0],onChange:s,onNext:f})]})}const q6={English:Wo,Mathematics:r6,Science:G1,Physics:t6,Chemistry:G1,Biology:X1,"Social Studies":X1,Hindi:v6,"Computer Science":f6},G6=b.div`
padding: 3px;
position: relative;
overflow: visible;
`,X6=b.button`
...
`;function P6({grades:a,selectedGrade:l,selectedSubject:s,onSelectSubject:o,onBack:f,onNext:d}){const h=l?Object.keys(a[l].subjects):[];return u.jsxs(G6,{children:[u.jsx(X6,{onClick:f,"aria-label":"Go back",children:u.jsx(Jf,{size:24})}),u.jsxs(V6,{children:[u.jsx(Q6,{children:"Pick a Subject"}),u.jsx(Z6,{children:l?`You chose ${l}. Now select a subject.`:"Choose a grade first."})]}),u.jsx(K6,{children:h.map((y,g)=>{const m=q6[y]||Wo,S=s===y;return u.jsxs(J6,{$isSelected:S,$delay:`${g*.03}s`,"aria-pressed":S,onClick:()=>o(y),children:[u.jsxs(F6,{children:[u.jsx(I6,{children:u.jsx(m,{size:18})}),u.jsx(W6,{children:y})]}),u.jsx(Lg,{size:18,onClick:d,disabled:!s})]},y)})})]})}const e8=b.div`
  padding: 3px;
  position: relative;
  overflow: visible;
`,t8=b.button`
...
`,v8=b.div`
  ...
  padding: 16px;
  background: ${en.bg};
  animation: ${g8} 0.42s ease-out both;
`,b8=b.div`
  width: 100%;
  max-width: 720px;
`,S8=b.div`
  ...
  animation: ${y8} .18s ease-out both;
`,w8=b.div`
  display: flex;
  gap: 6px;
  justify-content: center;
  margin-bottom: 12px;
  animation: ${x8} 0.4s ease-out both;
`,j8=b.div`
  height: 8px;
  width: 12px;
  border-radius: 999px;
...
`,P1=b.div`
  ...
  align-items: center;
  justify-content: center;
  animation: ${Pl?"none":Yg} 0.15s ease-out;
`,em=b.div`
  position: fixed;
  top: 50%;
  left: 50%;
...
`,sm=b(Vl)`
  padding: 16px;
  animation: ${Pl?"none":Yg} 0.3s ease-out;
`,V8=b.div`
  display: grid;
  grid-template-columns: 1fr;
  gap: 10px;
...
`,Mo=b.div`
  ...
  margin-bottom: 10px;
  opacity: 0.3;
  animation: ${Pl?"none":O8} 3s ease-in-out infinite;
`,Oo=b.h3`
  color: ${le.text};
...
`,Qu=b.div`
  ...
  border-radius: 50%;
  background: rgba(255, 255, 255, 0.1);
  animation: ${oS} 20s infinite ease-in-out;
...
`,vS=b.div`
  ...
  border-radius: 10px;
  animation: ${uS} 3s ease-in-out infinite;
`,bS=b.div`
  display: grid;
...
`;function cm(){const[a,l]=v.useState(!1),s=()=>{l(!0),setTimeout(()=>{l(!1)},2e3)};return u.jsxs(fS,{children:[u.jsxs(dS,{children:[u.jsx(Qu,{}),u.jsx(Qu,{}),u.jsx(Qu,{})]}),u.jsxs(pS,{children:[u.jsx(hS,{children:u.jsx(mS,{children:"🚧"})}),u.jsx(gS,{children:"Building Something Amazing"}),u.jsx(xS,{children:"We're working hard to bring you an incredible new feature. Stay tuned!"}),u.jsx(yS,{children:u.jsx(vS,{})}),u.jsxs(bS,{children:[u.jsxs(Zu,{children:[u.jsx(Ku,{children:"⚡"}),u.jsx(Ju,{children:"Lightning Fast"})]}),u.jsxs(Zu,{children:[u.jsx(Ku,{children:"🎨"}),u.jsx(Ju,{children:"Beautiful Design"})]}),u.jsxs(Zu,{children:[u.jsx(Ku,{children:"🔒"}),u.jsx(Ju,{children:"Secure & Private"})]})]}),u.jsx(SS,{onClick:s,$notified:a,children:a?"✓ You'll be notified!":"Notify Me When Ready"})]})]})}var Fu={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var um;function wS(){return um||(um=1,(function(a){(function(){var l={}.hasOwnProperty;function s(){for(var d="",h=0;h<arguments.length;h++){var y=arguments[h];y&&(d=f(d,o(y)))}return d}function o(d){if(typeof d=="string"||typeof d=="number")return d;if(typeof d!="object")return"";if(Array.isArray(d))return s.apply(null,d);if(d.toString!==Object.prototype.toString&&!d.toString.toString().includes("[native code]"))return d.toString();var h="";for(var y in d)l.call(d,y)&&d[y]&&(h=f(h,y));return h}function f(d,h){return h?d?d+" "+h:d+h:d}a.exports?(s.default=s,a.exports=s):window.classNames=s})()})(Fu)),Fu.exports}var jS=wS();const it=Zl(jS);function Cf(){return Cf=Object.assign?Object.assign.bind():function(a){for(var l=1;l<arguments.length;l++){var s=arguments[l];for(var o in s)({}).hasOwnProperty.call(s,o)&&(a[o]=s[o])}return a},Cf.apply(null,arguments)}function qg(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)!==-1)continue;s[o]=a[o]}return s}function fm(a){return"default"+a.charAt(0).toUpperCase()+a.substr(1)}function ES(a){var l=CS(a,"string");return typeof l=="symbol"?l:String(l)}function CS(a,l){if(typeof a!="object"||a===null)return a;var s=a[Symbol.toPrimitive];if(s!==void 0){var o=s.call(a,l);if(typeof o!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(a)}function TS(a,l,s){var o=v.useRef(a!==void 0),f=v.useState(l),d=f[0],h=f[1],y=a!==void 0,g=o.current;return o.current=y,!y&&g&&d!==l&&h(l),[y?a:d,v.useCallback(function(m){for(var S=arguments.length,w=new Array(S>1?S-1:0),T=1;T<S;T++)w[T-1]=arguments[T];s&&s.apply(void 0,[m].concat(w)),h(m)},[s])]}function Gg(a,l){return Object.keys(l).reduce(function(s,o){var f,d=s,h=d[fm(o)],y=d[o],g=qg(d,[fm(o),o].map(ES)),m=l[o],S=TS(y,h,a[m]),w=S[0],T=S[1];return Cf({},g,(f={},f[o]=w,f[m]=T,f))},a)}function Tf(a,l){return Tf=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(s,o){return s.__proto__=o,s},Tf(a,l)}function zS(a,l){a.prototype=Object.create(l.prototype),a.prototype.constructor=a,Tf(a,l)}const RS=["xxl","xl","lg","md","sm","xs"],AS="xs",Xg=v.createContext({prefixes:{},breakpoints:RS,minBreakpoint:AS}),{Consumer:V9,Provider:Q9}=Xg;function jt(a,l){const{prefixes:s}=v.useContext(Xg);return a||s[l]||l}function Ff(a){return a&&a.ownerDocument||document}function MS(a){var l=Ff(a);return l&&l.defaultView||window}function OS(a,l){return MS(a).getComputedStyle(a,l)}var kS=/([A-Z])/g;function NS(a){return a.replace(kS,"-$1").toLowerCase()}var _S=/^ms-/;function _o(a){return NS(a).replace(_S,"-ms-")}var DS=/^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i;function $S(a){return!!(a&&DS.test(a))}function _n(a,l){var s="",o="";if(typeof l=="string")return a.style.getPropertyValue(_o(l))||OS(a).getPropertyValue(_o(l));Object.keys(l).forEach(function(f){var d=l[f];!d&&d!==0?a.style.removeProperty(_o(f)):$S(f)?o+=f+"("+d+") ":s+=_o(f)+": "+d+";"}),o&&(s+="transform: "+o+";"),a.style.cssText+=";"+s}var Wu={exports:{}},Iu,dm;function BS(){if(dm)return Iu;dm=1;var a="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return Iu=a,Iu}var Pu,pm;function LS(){if(pm)return Pu;pm=1;var a=BS();function l(){}function s(){}return s.resetWarningCache=l,Pu=function(){function o(h,y,g,m,S,w){if(w!==a){var T=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw T.name="Invariant Violation",T}}o.isRequired=o;function f(){return o}var d={array:o,bigint:o,bool:o,func:o,number:o,object:o,string:o,symbol:o,any:o,arrayOf:f,element:o,elementType:o,instanceOf:f,node:o,objectOf:f,oneOf:f,oneOfType:f,shape:f,exact:f,checkPropTypes:s,resetWarningCache:l};return d.PropTypes=d,d},Pu}var hm;function US(){return hm||(hm=1,Wu.exports=LS()()),Wu.exports}var HS=US();const ef=Zl(HS),mm={disabled:!1},Vg=ke.createContext(null);var YS=function(l){return l.scrollTop},Yl="unmounted",ha="exited",Pt="entering",On="entered",Ql="exiting",Un=(function(a){zS(l,a);function l(o,f){var d;d=a.call(this,o,f)||this;var h=f,y=h&&!h.isMounting?o.enter:o.appear,g;return d.appearStatus=null,o.in?y?(g=ha,d.appearStatus=Pt):g=On:o.unmountOnExit||o.mountOnEnter?g=Yl:g=ha,d.state={status:g},d.nextCallback=null,d}l.getDerivedStateFromProps=function(f,d){var h=f.in;return h&&d.status===Yl?{status:ha}:null};var s=l.prototype;return s.componentDidMount=function(){this.updateStatus(!0,this.appearStatus)},s.componentDidUpdate=function(f){var d=null;if(f!==this.props){var h=this.state.status;this.props.in?h!==Pt&&h!==On&&(d=Pt):(h===Pt||h===On)&&(d=Ql)}this.updateStatus(!1,d)},s.componentWillUnmount=function(){this.cancelNextCallback()},s.getTimeouts=function(){var f=this.props.timeout,d,h,y;return d=h=y=f,f!=null&&typeof f!="number"&&(d=f.exit,h=f.enter,y=f.appear!==void 0?f.appear:h),{exit:d,enter:h,appear:y}},s.updateStatus=function(f,d){if(f===void 0&&(f=!1),d!==null)if(this.cancelNextCallback(),d===Pt){if(this.props.unmountOnExit||this.props.mountOnEnter){var h=this.props.nodeRef?this.props.nodeRef.current:Ai.findDOMNode(this);h&&YS(h)}this.performEnter(f)}else this.performExit();else this.props.unmountOnExit&&this.state.status===ha&&this.setState({status:Yl})},s.performEnter=function(f){var d=this,h=this.props.enter,y=this.context?this.context.isMounting:f,g=this.props.nodeRef?[y]:[Ai.findDOMNode(this),y],m=g[0],S=g[1],w=this.getTimeouts(),T=y?w.appear:w.enter;if(!f&&!h||mm.disabled){this.safeSetState({status:On},function(){d.props.onEntered(m)});return}this.props.onEnter(m,S),this.safeSetState({status:Pt},function(){d.props.onEntering(m,S),d.onTransitionEnd(T,function(){d.safeSetState({status:On},function(){d.props.onEntered(m,S)})})})},s.performExit=function(){var f=this,d=this.props.exit,h=this.getTimeouts(),y=this.props.nodeRef?void 0:Ai.findDOMNode(this);if(!d||mm.disabled){this.safeSetState({status:ha},function(){f.props.onExited(y)});return}this.props.onExit(y),this.safeSetState({status:Ql},function(){f.props.onExiting(y),f.onTransitionEnd(h.exit,function(){f.safeSetState({status:ha},function(){f.props.onExited(y)})})})},s.cancelNextCallback=function(){this.nextCallback!==null&&(this.nextCallback.cancel(),this.nextCallback=null)},s.safeSetState=function(f,d){d=this.setNextCallback(d),this.setState(f,d)},s.setNextCallback=function(f){var d=this,h=!0;return this.nextCallback=function(y){h&&(h=!1,d.nextCallback=null,f(y))},this.nextCallback.cancel=function(){h=!1},this.nextCallback},s.onTransitionEnd=function(f,d){this.setNextCallback(d);var h=this.props.nodeRef?this.props.nodeRef.current:Ai.findDOMNode(this),y=f==null&&!this.props.addEndListener;if(!h||y){setTimeout(this.nextCallback,0);return}if(this.props.addEndListener){var g=this.props.nodeRef?[this.nextCallback]:[h,this.nextCallback],m=g[0],S=g[1];this.props.addEndListener(m,S)}f!=null&&setTimeout(this.nextCallback,f)},s.render=function(){var f=this.state.status;if(f===Yl)return null;var d=this.props,h=d.children;d.in,d.mountOnEnter,d.unmountOnExit,d.appear,d.enter,d.exit,d.timeout,d.addEndListener,d.onEnter,d.onEntering,d.onEntered,d.onExit,d.onExiting,d.onExited,d.nodeRef;var y=qg(d,["children","in","mountOnEnter","unmountOnExit","appear","enter","exit","timeout","addEndListener","onEnter","onEntering","onEntered","onExit","onExiting","onExited","nodeRef"]);return ke.createElement(Vg.Provider,{value:null},typeof h=="function"?h(f,y):ke.cloneElement(ke.Children.only(h),y))},l})(ke.Component);Un.contextType=Vg;Un.propTypes={};function Ti(){}Un.defaultProps={in:!1,mountOnEnter:!1,unmountOnExit:!1,appear:!1,enter:!0,exit:!0,onEnter:Ti,onEntering:Ti,onEntered:Ti,onExit:Ti,onExiting:Ti,onExited:Ti};Un.UNMOUNTED=Yl;Un.EXITED=ha;Un.ENTERING=Pt;Un.ENTERED=On;Un.EXITING=Ql;function qS(a){return a.code==="Escape"||a.keyCode===27}function GS(){const a=v.version.split(".");return{major:+a[0],minor:+a[1],patch:+a[2]}}function Yi(a){if(!a||typeof a=="function")return null;const{major:l}=GS();return l>=19?a.props.ref:a.ref}const us=!!(typeof window<"u"&&window.document&&window.document.createElement);var zf=!1,Rf=!1;try{var tf={get passive(){return zf=!0},get once(){return Rf=zf=!0}};us&&(window.addEventListener("test",tf,tf),window.removeEventListener("test",tf,!0))}catch{}function XS(a,l,s,o){if(o&&typeof o!="boolean"&&!Rf){var f=o.once,d=o.capture,h=s;!Rf&&f&&(h=s.__once||function y(g){this.removeEventListener(l,y,d),s.call(this,g)},s.__once=h),a.addEventListener(l,h,zf?o:d)}a.addEventListener(l,s,o)}function VS(a,l,s,o){var f=o&&typeof o!="boolean"?o.capture:o;a.removeEventListener(l,s,f),s.__once&&a.removeEventListener(l,s.__once,f)}function Io(a,l,s,o){return XS(a,l,s,o),function(){VS(a,l,s,o)}}function QS(a,l,s,o){if(o===void 0&&(o=!0),a){var f=document.createEvent("HTMLEvents");f.initEvent(l,s,o),a.dispatchEvent(f)}}function ZS(a){var l=_n(a,"transitionDuration")||"",s=l.indexOf("ms")===-1?1e3:1;return parseFloat(l)*s}function KS(a,l,s){s===void 0&&(s=5);var o=!1,f=setTimeout(function(){o||QS(a,"transitionend",!0)},l+s),d=Io(a,"transitionend",function(){o=!0},{once:!0});return function(){clearTimeout(f),d()}}function JS(a,l,s,o){s==null&&(s=ZS(a)||0);var f=KS(a,s,o),d=Io(a,"transitionend",l);return function(){f(),d()}}function gm(a,l){const s=_n(a,l)||"",o=s.indexOf("ms")===-1?1e3:1;return parseFloat(s)*o}function Wf(a,l){const s=gm(a,"transitionDuration"),o=gm(a,"transitionDelay"),f=JS(a,d=>{d.target===a&&(f(),l(d))},s+o)}function Ul(...a){return a.filter(l=>l!=null).reduce((l,s)=>{if(typeof s!="function")throw new Error("Invalid Argument Type, must only provide functions, undefined, or null.");return l===null?s:function(...f){l.apply(this,f),s.apply(this,f)}},null)}function Qg(a){a.offsetHeight}const xm=a=>!a||typeof a=="function"?a:l=>{a.current=l};function FS(a,l){const s=xm(a),o=xm(l);return f=>{s&&s(f),o&&o(f)}}function WS(a,l){return v.useMemo(()=>FS(a,l),[a,l])}function IS(a){return a&&"setState"in a?Ai.findDOMNode(a):a??null}const fs=ke.forwardRef(({onEnter:a,onEntering:l,onEntered:s,onExit:o,onExiting:f,onExited:d,addEndListener:h,children:y,childRef:g,...m},S)=>{const w=v.useRef(null),T=WS(w,g),z=L=>{T(IS(L))},A=L=>V=>{L&&w.current&&L(w.current,V)},k=v.useCallback(A(a),[a]),$=v.useCallback(A(l),[l]),B=v.useCallback(A(s),[s]),q=v.useCallback(A(o),[o]),Y=v.useCallback(A(f),[f]),Z=v.useCallback(A(d),[d]),J=v.useCallback(A(h),[h]);return u.jsx(Un,{ref:S,...m,onEnter:k,onEntered:B,onEntering:$,onExit:q,onExited:Z,onExiting:Y,addEndListener:J,nodeRef:w,children:typeof y=="function"?(L,V)=>y(L,{...V,ref:z}):ke.cloneElement(y,{ref:z})})});fs.displayName="TransitionWrapper";const PS={height:["marginTop","marginBottom"],width:["marginLeft","marginRight"]};function ew(a,l){const s=`offset${a[0].toUpperCase()}${a.slice(1)}`,o=l[s],f=PS[a];return o+parseInt(_n(l,f[0]),10)+parseInt(_n(l,f[1]),10)}const tw={[ha]:"collapse",[Ql]:"collapsing",[Pt]:"collapsing",[On]:"collapse show"},Zg=ke.forwardRef(({onEnter:a,onEntering:l,onEntered:s,onExit:o,onExiting:f,className:d,children:h,dimension:y="height",in:g=!1,timeout:m=300,mountOnEnter:S=!1,unmountOnExit:w=!1,appear:T=!1,getDimensionValue:z=ew,...A},k)=>{const $=typeof y=="function"?y():y,B=v.useMemo(()=>Ul(L=>{L.style[$]="0"},a),[$,a]),q=v.useMemo(()=>Ul(L=>{const V=`scroll${$[0].toUpperCase()}${$.slice(1)}`;L.style[$]=`${L[V]}px`},l),[$,l]),Y=v.useMemo(()=>Ul(L=>{L.style[$]=null},s),[$,s]),Z=v.useMemo(()=>Ul(L=>{L.style[$]=`${z($,L)}px`,Qg(L)},o),[o,z,$]),J=v.useMemo(()=>Ul(L=>{L.style[$]=null},f),[$,f]);return u.jsx(fs,{ref:k,addEndListener:Wf,...A,"aria-expanded":A.role?g:null,onEnter:B,onEntering:q,onEntered:Y,onExit:Z,onExiting:J,childRef:Yi(h),in:g,timeout:m,mountOnEnter:S,unmountOnExit:w,appear:T,children:(L,V)=>ke.cloneElement(h,{...V,className:it(d,h.props.className,tw[L],$==="width"&&"collapse-horizontal")})})});Zg.displayName="Collapse";function nw(a){const l=v.useRef(a);return v.useEffect(()=>{l.current=a},[a]),l}function ds(a){const l=nw(a);return v.useCallback(function(...s){return l.current&&l.current(...s)},[l])}const aw=(a=>v.forwardRef((l,s)=>u.jsx("div",{...l,ref:s,className:it(l.className,a)})));function iw(a){const l=v.useRef(a);return v.useEffect(()=>{l.current=a},[a]),l}function kn(a){const l=iw(a);return v.useCallback(function(...s){return l.current&&l.current(...s)},[l])}function lw(){const a=v.useRef(!0),l=v.useRef(()=>a.current);return v.useEffect(()=>(a.current=!0,()=>{a.current=!1}),[]),l.current}function rw(a){const l=v.useRef(null);return v.useEffect(()=>{l.current=a}),l.current}const ow=typeof global<"u"&&global.navigator&&global.navigator.product==="ReactNative",sw=typeof document<"u",ym=sw||ow?v.useLayoutEffect:v.useEffect,cw=["as","disabled"];function uw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function fw(a){return!a||a.trim()==="#"}function Kg({tagName:a,disabled:l,href:s,target:o,rel:f,role:d,onClick:h,tabIndex:y=0,type:g}){a||(s!=null||o!=null||f!=null?a="a":a="button");const m={tagName:a};if(a==="button")return[{type:g||"button",disabled:l},m];const S=T=>{if((l||a==="a"&&fw(s))&&T.preventDefault(),l){T.stopPropagation();return}h?.(T)},w=T=>{T.key===" "&&(T.preventDefault(),S(T))};return a==="a"&&(s||(s="#"),l&&(s=void 0)),[{role:d??"button",disabled:void 0,tabIndex:l?void 0:y,href:s,target:a==="a"?o:void 0,"aria-disabled":l||void 0,rel:a==="a"?f:void 0,onClick:S,onKeyDown:w},m]}const Jg=v.forwardRef((a,l)=>{let{as:s,disabled:o}=a,f=uw(a,cw);const[d,{tagName:h}]=Kg(Object.assign({tagName:s,disabled:o},f));return u.jsx(h,Object.assign({},f,d,{ref:l}))});Jg.displayName="Button";const dw=["onKeyDown"];function pw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function hw(a){return!a||a.trim()==="#"}const Fg=v.forwardRef((a,l)=>{let{onKeyDown:s}=a,o=pw(a,dw);const[f]=Kg(Object.assign({tagName:"a"},o)),d=kn(h=>{f.onKeyDown(h),s?.(h)});return hw(o.href)||o.role==="button"?u.jsx("a",Object.assign({ref:l},o,f,{onKeyDown:d})):u.jsx("a",Object.assign({ref:l},o,{onKeyDown:s}))});Fg.displayName="Anchor";const mw={[Pt]:"show",[On]:"show"},Wg=v.forwardRef(({className:a,children:l,transitionClasses:s={},onEnter:o,...f},d)=>{const h={in:!1,timeout:300,mountOnEnter:!1,unmountOnExit:!1,appear:!1,...f},y=v.useCallback((g,m)=>{Qg(g),o?.(g,m)},[o]);return u.jsx(fs,{ref:d,addEndListener:Wf,...h,onEnter:y,childRef:Yi(l),children:(g,m)=>v.cloneElement(l,{...m,className:it("fade",a,l.props.className,mw[g],s[g])})})});Wg.displayName="Fade";const gw={"aria-label":ef.string,onClick:ef.func,variant:ef.oneOf(["white"])},If=v.forwardRef(({className:a,variant:l,"aria-label":s="Close",...o},f)=>u.jsx("button",{ref:f,type:"button",className:it("btn-close",l&&`btn-close-${l}`,a),"aria-label":s,...o}));If.displayName="CloseButton";If.propTypes=gw;const Ig=v.createContext(null);Ig.displayName="CardHeaderContext";const Pg=v.forwardRef(({bsPrefix:a,fluid:l=!1,as:s="div",className:o,...f},d)=>{const h=jt(a,"container"),y=typeof l=="string"?`-${l}`:"-fluid";return u.jsx(s,{ref:d,...f,className:it(o,l?`${h}${y}`:h)})});Pg.displayName="Container";var xw=Function.prototype.bind.call(Function.prototype.call,[].slice);function Da(a,l){return xw(a.querySelectorAll(l))}function yw(){const[,a]=v.useReducer(l=>l+1,0);return a}function vm(a,l){if(a.contains)return a.contains(l);if(a.compareDocumentPosition)return a===l||!!(a.compareDocumentPosition(l)&16)}const Po=v.createContext(null),Pf=(a,l=null)=>a!=null?String(a):l||null,ed=v.createContext(null);ed.displayName="NavContext";const vw="data-rr-ui-",bw="rrUi";function ps(a){return`${vw}${a}`}function Sw(a){return`${bw}${a}`}const e2=v.createContext(us?window:void 0);e2.Provider;function td(){return v.useContext(e2)}const ww=typeof global<"u"&&global.navigator&&global.navigator.product==="ReactNative",jw=typeof document<"u",Ew=jw||ww?v.useLayoutEffect:v.useEffect,qi=v.createContext(null);qi.displayName="NavbarContext";const bm=a=>!a||typeof a=="function"?a:l=>{a.current=l};function Cw(a,l){const s=bm(a),o=bm(l);return f=>{s&&s(f),o&&o(f)}}function hs(a,l){return v.useMemo(()=>Cw(a,l),[a,l])}const t2=v.createContext(null),Tw=["as","active","eventKey"];function zw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function n2({key:a,onClick:l,active:s,id:o,role:f,disabled:d}){const h=v.useContext(Po),y=v.useContext(ed),g=v.useContext(t2);let m=s;const S={role:f};if(y){!f&&y.role==="tablist"&&(S.role="tab");const w=y.getControllerId(a??null),T=y.getControlledId(a??null);S[ps("event-key")]=a,S.id=w||o,m=s==null&&a!=null?y.activeKey===a:s,(m||!(g!=null&&g.unmountOnExit)&&!(g!=null&&g.mountOnEnter))&&(S["aria-controls"]=T)}return S.role==="tab"&&(S["aria-selected"]=m,m||(S.tabIndex=-1),d&&(S.tabIndex=-1,S["aria-disabled"]=!0)),S.onClick=kn(w=>{d||(l?.(w),a!=null&&h&&!w.isPropagationStopped()&&h(a,w))}),[S,{isActive:m}]}const a2=v.forwardRef((a,l)=>{let{as:s=Jg,active:o,eventKey:f}=a,d=zw(a,Tw);const[h,y]=n2(Object.assign({key:Pf(f,d.href),active:o},d));return h[ps("active")]=y.isActive,u.jsx(s,Object.assign({},d,h,{ref:l}))});a2.displayName="NavItem";const Rw=["as","onSelect","activeKey","role","onKeyDown"];function Aw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}const Sm=()=>{},wm=ps("event-key"),i2=v.forwardRef((a,l)=>{let{as:s="div",onSelect:o,activeKey:f,role:d,onKeyDown:h}=a,y=Aw(a,Rw);const g=yw(),m=v.useRef(!1),S=v.useContext(Po),w=v.useContext(t2);let T,z;w&&(d=d||"tablist",f=w.activeKey,T=w.getControlledId,z=w.getControllerId);const A=v.useRef(null),k=Y=>{const Z=A.current;if(!Z)return null;const J=Da(Z,`[${wm}]:not([aria-disabled=true])`),L=Z.querySelector("[aria-selected=true]");if(!L||L!==document.activeElement)return null;const V=J.indexOf(L);if(V===-1)return null;let Q=V+Y;return Q>=J.length&&(Q=0),Q<0&&(Q=J.length-1),J[Q]},$=(Y,Z)=>{Y!=null&&(o?.(Y,Z),S?.(Y,Z))},B=Y=>{if(h?.(Y),!w)return;let Z;switch(Y.key){case"ArrowLeft":case"ArrowUp":Z=k(-1);break;case"ArrowRight":case"ArrowDown":Z=k(1);break;default:return}Z&&(Y.preventDefault(),$(Z.dataset[Sw("EventKey")]||null,Y),m.current=!0,g())};v.useEffect(()=>{if(A.current&&m.current){const Y=A.current.querySelector(`[${wm}][aria-selected=true]`);Y?.focus()}m.current=!1});const q=hs(l,A);return u.jsx(Po.Provider,{value:$,children:u.jsx(ed.Provider,{value:{role:d,activeKey:Pf(f),getControlledId:T||Sm,getControllerId:z||Sm},children:u.jsx(s,Object.assign({},y,{onKeyDown:B,ref:q,role:d}))})})});i2.displayName="Nav";const Mw=Object.assign(i2,{Item:a2});function nf(a){a===void 0&&(a=Ff());try{var l=a.activeElement;return!l||!l.nodeName?null:l}catch{return a.body}}function Ow(a){const l=v.useRef(a);return l.current=a,l}function kw(a){const l=Ow(a);v.useEffect(()=>()=>l.current(),[])}function Nw(a=document){const l=a.defaultView;return Math.abs(l.innerWidth-a.documentElement.clientWidth)}const jm=ps("modal-open");class nd{constructor({ownerDocument:l,handleContainerOverflow:s=!0,isRTL:o=!1}={}){this.handleContainerOverflow=s,this.isRTL=o,this.modals=[],this.ownerDocument=l}getScrollbarWidth(){return Nw(this.ownerDocument)}getElement(){return(this.ownerDocument||document).body}setModalAttributes(l){}removeModalAttributes(l){}setContainerStyle(l){const s={overflow:"hidden"},o=this.isRTL?"paddingLeft":"paddingRight",f=this.getElement();l.style={overflow:f.style.overflow,[o]:f.style[o]},l.scrollBarWidth&&(s[o]=`${parseInt(_n(f,o)||"0",10)+l.scrollBarWidth}px`),f.setAttribute(jm,""),_n(f,s)}reset(){[...this.modals].forEach(l=>this.remove(l))}removeContainerStyle(l){const s=this.getElement();s.removeAttribute(jm),Object.assign(s.style,l.style)}add(l){let s=this.modals.indexOf(l);return s!==-1||(s=this.modals.length,this.modals.push(l),this.setModalAttributes(l),s!==0)||(this.state={scrollBarWidth:this.getScrollbarWidth(),style:{}},this.handleContainerOverflow&&this.setContainerStyle(this.state)),s}remove(l){const s=this.modals.indexOf(l);s!==-1&&(this.modals.splice(s,1),!this.modals.length&&this.handleContainerOverflow&&this.removeContainerStyle(this.state),this.removeModalAttributes(l))}isTopModal(l){return!!this.modals.length&&this.modals[this.modals.length-1]===l}}const af=(a,l)=>us?a==null?(l||Ff()).body:(typeof a=="function"&&(a=a()),a&&"current"in a&&(a=a.current),a&&("nodeType"in a||a.getBoundingClientRect)?a:null):null;function _w(a,l){const s=td(),[o,f]=v.useState(()=>af(a,s?.document));if(!o){const d=af(a);d&&f(d)}return v.useEffect(()=>{},[l,o]),v.useEffect(()=>{const d=af(a);d!==o&&f(d)},[a,o]),o}function Dw({children:a,in:l,onExited:s,mountOnEnter:o,unmountOnExit:f}){const d=v.useRef(null),h=v.useRef(l),y=kn(s);v.useEffect(()=>{l?h.current=!0:y(d.current)},[l,y]);const g=hs(d,Yi(a)),m=v.cloneElement(a,{ref:g});return l?m:f||!h.current&&o?null:m}const $w=["onEnter","onEntering","onEntered","onExit","onExiting","onExited","addEndListener","children"];function Bw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}function Lw(a){let{onEnter:l,onEntering:s,onEntered:o,onExit:f,onExiting:d,onExited:h,addEndListener:y,children:g}=a,m=Bw(a,$w);const S=v.useRef(null),w=hs(S,Yi(g)),T=Z=>J=>{Z&&S.current&&Z(S.current,J)},z=v.useCallback(T(l),[l]),A=v.useCallback(T(s),[s]),k=v.useCallback(T(o),[o]),$=v.useCallback(T(f),[f]),B=v.useCallback(T(d),[d]),q=v.useCallback(T(h),[h]),Y=v.useCallback(T(y),[y]);return Object.assign({},m,{nodeRef:S},l&&{onEnter:z},s&&{onEntering:A},o&&{onEntered:k},f&&{onExit:$},d&&{onExiting:B},h&&{onExited:q},y&&{addEndListener:Y},{children:typeof g=="function"?(Z,J)=>g(Z,Object.assign({},J,{ref:w})):v.cloneElement(g,{ref:w})})}const Uw=["component"];function Hw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}const Yw=v.forwardRef((a,l)=>{let{component:s}=a,o=Hw(a,Uw);const f=Lw(o);return u.jsx(s,Object.assign({ref:l},f))});function qw({in:a,onTransition:l}){const s=v.useRef(null),o=v.useRef(!0),f=kn(l);return ym(()=>{if(!s.current)return;let d=!1;return f({in:a,element:s.current,initial:o.current,isStale:()=>d}),()=>{d=!0}},[a,f]),ym(()=>(o.current=!1,()=>{o.current=!0}),[]),s}function Gw({children:a,in:l,onExited:s,onEntered:o,transition:f}){const[d,h]=v.useState(!l);l&&d&&h(!1);const y=qw({in:!!l,onTransition:m=>{const S=()=>{m.isStale()||(m.in?o?.(m.element,m.initial):(h(!0),s?.(m.element)))};Promise.resolve(f(m)).then(S,w=>{throw m.in||h(!0),w})}}),g=hs(y,Yi(a));return d&&!l?null:v.cloneElement(a,{ref:g})}function Em(a,l,s){return a?u.jsx(Yw,Object.assign({},s,{component:a})):l?u.jsx(Gw,Object.assign({},s,{transition:l})):u.jsx(Dw,Object.assign({},s))}const Xw=["show","role","className","style","children","backdrop","keyboard","onBackdropClick","onEscapeKeyDown","transition","runTransition","backdropTransition","runBackdropTransition","autoFocus","enforceFocus","restoreFocus","restoreFocusOptions","renderDialog","renderBackdrop","manager","container","onShow","onHide","onExit","onExited","onExiting","onEnter","onEntering","onEntered"];function Vw(a,l){if(a==null)return{};var s={};for(var o in a)if({}.hasOwnProperty.call(a,o)){if(l.indexOf(o)>=0)continue;s[o]=a[o]}return s}let lf;function Qw(a){return lf||(lf=new nd({ownerDocument:a?.document})),lf}function Zw(a){const l=td(),s=a||Qw(l),o=v.useRef({dialog:null,backdrop:null});return Object.assign(o.current,{add:()=>s.add(o.current),remove:()=>s.remove(o.current),isTopModal:()=>s.isTopModal(o.current),setDialogRef:v.useCallback(f=>{o.current.dialog=f},[]),setBackdropRef:v.useCallback(f=>{o.current.backdrop=f},[])})}const l2=v.forwardRef((a,l)=>{let{show:s=!1,role:o="dialog",className:f,style:d,children:h,backdrop:y=!0,keyboard:g=!0,onBackdropClick:m,onEscapeKeyDown:S,transition:w,runTransition:T,backdropTransition:z,runBackdropTransition:A,autoFocus:k=!0,enforceFocus:$=!0,restoreFocus:B=!0,restoreFocusOptions:q,renderDialog:Y,renderBackdrop:Z=Be=>u.jsx("div",Object.assign({},Be)),manager:J,container:L,onShow:V,onHide:Q=()=>{},onExit:W,onExited:ce,onExiting:de,onEnter:Ye,onEntering:ee,onEntered:ae}=a,xe=Vw(a,Xw);const _=td(),K=_w(L),P=Zw(J),te=lw(),me=rw(s),[E,H]=v.useState(!s),F=v.useRef(null);v.useImperativeHandle(l,()=>P,[P]),us&&!me&&s&&(F.current=nf(_?.document)),s&&E&&H(!1);const I=kn(()=>{if(P.add(),Et.current=Io(document,"keydown",Ge),Ce.current=Io(document,"focus",()=>setTimeout(ue),!0),V&&V(),k){var Be,Ua;const Gi=nf((Be=(Ua=P.dialog)==null?void 0:Ua.ownerDocument)!=null?Be:_?.document);P.dialog&&Gi&&!vm(P.dialog,Gi)&&(F.current=Gi,P.dialog.focus())}}),re=kn(()=>{if(P.remove(),Et.current==null||Et.current(),Ce.current==null||Ce.current(),B){var Be;(Be=F.current)==null||Be.focus==null||Be.focus(q),F.current=null}});v.useEffect(()=>{!s||!K||I()},[s,K,I]),v.useEffect(()=>{E&&re()},[E,re]),kw(()=>{re()});const ue=kn(()=>{if(!$||!te()||!P.isTopModal())return;const Be=nf(_?.document);P.dialog&&Be&&!vm(P.dialog,Be)&&P.dialog.focus()}),ye=kn(Be=>{Be.target===Be.currentTarget&&(m?.(Be),y===!0&&Q())}),Ge=kn(Be=>{g&&qS(Be)&&P.isTopModal()&&(S?.(Be),Be.defaultPrevented||Q())}),Ce=v.useRef(),Et=v.useRef(),Jt=(...Be)=>{H(!0),ce?.(...Be)};if(!K)return null;const pt=Object.assign({role:o,ref:P.setDialogRef,"aria-modal":o==="dialog"?!0:void 0},xe,{style:d,className:f,tabIndex:-1});let La=Y?Y(pt):u.jsx("div",Object.assign({},pt,{children:v.cloneElement(h,{role:"document"})}));La=Em(w,T,{unmountOnExit:!0,mountOnEnter:!0,appear:!0,in:!!s,onExit:W,onExiting:de,onExited:Jt,onEnter:Ye,onEntering:ee,onEntered:ae,children:La});let Bt=null;return y&&(Bt=Z({ref:P.setBackdropRef,onClick:ye}),Bt=Em(z,A,{in:!!s,appear:!0,mountOnEnter:!0,unmountOnExit:!0,children:Bt})),u.jsx(u.Fragment,{children:Ai.createPortal(u.jsxs(u.Fragment,{children:[Bt,La]}),K)})});l2.displayName="Modal";const Kw=Object.assign(l2,{Manager:nd});function Jw(a,l){return a.classList?a.classList.contains(l):(" "+(a.className.baseVal||a.className)+" ").indexOf(" "+l+" ")!==-1}function Fw(a,l){a.classList?a.classList.add(l):Jw(a,l)||(typeof a.className=="string"?a.className=a.className+" "+l:a.setAttribute("class",(a.className&&a.className.baseVal||"")+" "+l))}function Cm(a,l){return a.replace(new RegExp("(^|\\s)"+l+"(?:\\s|$)","g"),"$1").replace(/\s+/g," ").replace(/^\s*|\s*$/g,"")}function Ww(a,l){a.classList?a.classList.remove(l):typeof a.className=="string"?a.className=Cm(a.className,l):a.setAttribute("class",Cm(a.className&&a.className.baseVal||"",l))}const zi={FIXED_CONTENT:".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",STICKY_CONTENT:".sticky-top",NAVBAR_TOGGLER:".navbar-toggler"};class r2 extends nd{adjustAndStore(l,s,o){const f=s.style[l];s.dataset[l]=f,_n(s,{[l]:`${parseFloat(_n(s,l))+o}px`})}restore(l,s){const o=s.dataset[l];o!==void 0&&(delete s.dataset[l],_n(s,{[l]:o}))}setContainerStyle(l){super.setContainerStyle(l);const s=this.getElement();if(Fw(s,"modal-open"),!l.scrollBarWidth)return;const o=this.isRTL?"paddingLeft":"paddingRight",f=this.isRTL?"marginLeft":"marginRight";Da(s,zi.FIXED_CONTENT).forEach(d=>this.adjustAndStore(o,d,l.scrollBarWidth)),Da(s,zi.STICKY_CONTENT).forEach(d=>this.adjustAndStore(f,d,-l.scrollBarWidth)),Da(s,zi.NAVBAR_TOGGLER).forEach(d=>this.adjustAndStore(f,d,l.scrollBarWidth))}removeContainerStyle(l){super.removeContainerStyle(l);const s=this.getElement();Ww(s,"modal-open");const o=this.isRTL?"paddingLeft":"paddingRight",f=this.isRTL?"marginLeft":"marginRight";Da(s,zi.FIXED_CONTENT).forEach(d=>this.restore(o,d)),Da(s,zi.STICKY_CONTENT).forEach(d=>this.restore(f,d)),Da(s,zi.NAVBAR_TOGGLER).forEach(d=>this.restore(f,d))}}let rf;function Iw(a){return rf||(rf=new r2(a)),rf}const o2=v.createContext({onHide(){}}),s2=v.forwardRef(({closeLabel:a="Close",closeVariant:l,closeButton:s=!1,onHide:o,children:f,...d},h)=>{const y=v.useContext(o2),g=ds(()=>{y?.onHide(),o?.()});return u.jsxs("div",{ref:h,...d,children:[f,s&&u.jsx(If,{"aria-label":a,variant:l,onClick:g})]})});s2.displayName="AbstractModalHeader";const c2=v.forwardRef(({className:a,bsPrefix:l,as:s="div",...o},f)=>(l=jt(l,"nav-item"),u.jsx(s,{ref:f,className:it(a,l),...o})));c2.displayName="NavItem";const u2=v.forwardRef(({bsPrefix:a,className:l,as:s=Fg,active:o,eventKey:f,disabled:d=!1,...h},y)=>{a=jt(a,"nav-link");const[g,m]=n2({key:Pf(f,h.href),active:o,disabled:d,...h});return u.jsx(s,{...h,...g,ref:y,disabled:d,className:it(l,a,d&&"disabled",m.isActive&&"active")})});u2.displayName="NavLink";const f2=v.forwardRef((a,l)=>{const{as:s="div",bsPrefix:o,variant:f,fill:d=!1,justify:h=!1,navbar:y,navbarScroll:g,className:m,activeKey:S,...w}=Gg(a,{activeKey:"onSelect"}),T=jt(o,"nav");let z,A,k=!1;const $=v.useContext(qi),B=v.useContext(Ig);return $?(z=$.bsPrefix,k=y??!0):B&&({cardHeaderBsPrefix:A}=B),u.jsx(Mw,{as:s,ref:l,activeKey:S,className:it(m,{[T]:!k,[`${z}-nav`]:k,[`${z}-nav-scroll`]:k&&g,[`${A}-${f}`]:!!A,[`${T}-${f}`]:!!f,[`${T}-fill`]:d,[`${T}-justified`]:h}),...w})});f2.displayName="Nav";const Pw=Object.assign(f2,{Item:c2,Link:u2}),d2=v.forwardRef(({bsPrefix:a,className:l,as:s,...o},f)=>{a=jt(a,"navbar-brand");const d=s||(o.href?"a":"span");return u.jsx(d,{...o,ref:f,className:it(l,a)})});d2.displayName="NavbarBrand";const p2=v.forwardRef(({children:a,bsPrefix:l,...s},o)=>{l=jt(l,"navbar-collapse");const f=v.useContext(qi);return u.jsx(Zg,{in:!!(f&&f.expanded),...s,children:u.jsx("div",{ref:o,className:l,children:a})})});p2.displayName="NavbarCollapse";const h2=v.forwardRef(({bsPrefix:a,className:l,children:s,label:o="Toggle navigation",as:f="button",onClick:d,...h},y)=>{a=jt(a,"navbar-toggler");const{onToggle:g,expanded:m}=v.useContext(qi)||{},S=ds(w=>{d&&d(w),g&&g()});return f==="button"&&(h.type="button"),u.jsx(f,{...h,ref:y,onClick:S,"aria-label":o,className:it(l,a,!m&&"collapsed"),children:s||u.jsx("span",{className:`${a}-icon`})})});h2.displayName="NavbarToggle";const Af=new WeakMap,Tm=(a,l)=>{if(!a||!l)return;const s=Af.get(l)||new Map;Af.set(l,s);let o=s.get(a);return o||(o=l.matchMedia(a),o.refCount=0,s.set(o.media,o)),o};function e7(a,l=typeof window>"u"?void 0:window){const s=Tm(a,l),[o,f]=v.useState(()=>s?s.matches:!1);return Ew(()=>{let d=Tm(a,l);if(!d)return f(!1);let h=Af.get(l);const y=()=>{f(d.matches)};return d.refCount++,d.addListener(y),y(),()=>{d.removeListener(y),d.refCount--,d.refCount<=0&&h?.delete(d.media),d=void 0}},[a]),o}function t7(a){const l=Object.keys(a);function s(y,g){return y===g?g:y?`${y} and ${g}`:g}function o(y){return l[Math.min(l.indexOf(y)+1,l.length-1)]}function f(y){const g=o(y);let m=a[g];return typeof m=="number"?m=`${m-.2}px`:m=`calc(${m} - 0.2px)`,`(max-width: ${m})`}function d(y){let g=a[y];return typeof g=="number"&&(g=`${g}px`),`(min-width: ${g})`}function h(y,g,m){let S;typeof y=="object"?(S=y,m=g,g=!0):(g=g||!0,S={[y]:g});let w=v.useMemo(()=>Object.entries(S).reduce((T,[z,A])=>((A==="up"||A===!0)&&(T=s(T,d(z))),(A==="down"||A===!0)&&(T=s(T,f(z))),T),""),[JSON.stringify(S)]);return e7(w,m)}return h}const n7=t7({xs:0,sm:576,md:768,lg:992,xl:1200,xxl:1400}),m2=v.forwardRef(({className:a,bsPrefix:l,as:s="div",...o},f)=>(l=jt(l,"offcanvas-body"),u.jsx(s,{ref:f,className:it(a,l),...o})));m2.displayName="OffcanvasBody";const a7={[Pt]:"show",[On]:"show"},g2=v.forwardRef(({bsPrefix:a,className:l,children:s,in:o=!1,mountOnEnter:f=!1,unmountOnExit:d=!1,appear:h=!1,...y},g)=>(a=jt(a,"offcanvas"),u.jsx(fs,{ref:g,addEndListener:Wf,in:o,mountOnEnter:f,unmountOnExit:d,appear:h,...y,childRef:Yi(s),children:(m,S)=>v.cloneElement(s,{...S,className:it(l,s.props.className,(m===Pt||m===Ql)&&`${a}-toggling`,a7[m])})})));g2.displayName="OffcanvasToggling";const x2=v.forwardRef(({bsPrefix:a,className:l,closeLabel:s="Close",closeButton:o=!1,...f},d)=>(a=jt(a,"offcanvas-header"),u.jsx(s2,{ref:d,...f,className:it(l,a),closeLabel:s,closeButton:o})));x2.displayName="OffcanvasHeader";const i7=aw("h5"),y2=v.forwardRef(({className:a,bsPrefix:l,as:s=i7,...o},f)=>(l=jt(l,"offcanvas-title"),u.jsx(s,{ref:f,className:it(a,l),...o})));y2.displayName="OffcanvasTitle";function l7(a){return u.jsx(g2,{...a})}function r7(a){return u.jsx(Wg,{...a})}const v2=v.forwardRef(({bsPrefix:a,className:l,children:s,"aria-labelledby":o,placement:f="start",responsive:d,show:h=!1,backdrop:y=!0,keyboard:g=!0,scroll:m=!1,onEscapeKeyDown:S,onShow:w,onHide:T,container:z,autoFocus:A=!0,enforceFocus:k=!0,restoreFocus:$=!0,restoreFocusOptions:B,onEntered:q,onExit:Y,onExiting:Z,onEnter:J,onEntering:L,onExited:V,backdropClassName:Q,manager:W,renderStaticNode:ce=!1,...de},Ye)=>{const ee=v.useRef();a=jt(a,"offcanvas");const[ae,xe]=v.useState(!1),_=ds(T),K=n7(d||"xs","up");v.useEffect(()=>{xe(d?h&&!K:h)},[h,d,K]);const P=v.useMemo(()=>({onHide:_}),[_]);function te(){return W||(m?(ee.current||(ee.current=new r2({handleContainerOverflow:!1})),ee.current):Iw())}const me=(I,...re)=>{I&&(I.style.visibility="visible"),J?.(I,...re)},E=(I,...re)=>{I&&(I.style.visibility=""),V?.(...re)},H=v.useCallback(I=>u.jsx("div",{...I,className:it(`${a}-backdrop`,Q)}),[Q,a]),F=I=>u.jsx("div",{...I,...de,className:it(l,d?`${a}-${d}`:a,`${a}-${f}`),"aria-labelledby":o,children:s});return u.jsxs(u.Fragment,{children:[!ae&&(d||ce)&&F({}),u.jsx(o2.Provider,{value:P,children:u.jsx(Kw,{show:ae,ref:Ye,backdrop:y,container:z,keyboard:g,autoFocus:A,enforceFocus:k&&!m,restoreFocus:$,restoreFocusOptions:B,onEscapeKeyDown:S,onShow:w,onHide:_,onEnter:me,onEntering:L,onEntered:q,onExit:Y,onExiting:Z,onExited:E,manager:te(),transition:l7,backdropTransition:r7,renderBackdrop:H,renderDialog:F})})]})});v2.displayName="Offcanvas";const o7=Object.assign(v2,{Body:m2,Header:x2,Title:y2}),b2=v.forwardRef(({onHide:a,...l},s)=>{const o=v.useContext(qi),f=ds(()=>{o==null||o.onToggle==null||o.onToggle(),a?.()});return u.jsx(o7,{ref:s,show:!!(o!=null&&o.expanded),...l,renderStaticNode:!0,onHide:f})});b2.displayName="NavbarOffcanvas";const S2=v.forwardRef(({className:a,bsPrefix:l,as:s="span",...o},f)=>(l=jt(l,"navbar-text"),u.jsx(s,{ref:f,className:it(a,l),...o})));S2.displayName="NavbarText";const w2=v.forwardRef((a,l)=>{const{bsPrefix:s,expand:o=!0,variant:f="light",bg:d,fixed:h,sticky:y,className:g,as:m="nav",expanded:S,onToggle:w,onSelect:T,collapseOnSelect:z=!1,...A}=Gg(a,{expanded:"onToggle"}),k=jt(s,"navbar"),$=v.useCallback((...Y)=>{T?.(...Y),z&&S&&w?.(!1)},[T,z,S,w]);A.role===void 0&&m!=="nav"&&(A.role="navigation");let B=`${k}-expand`;typeof o=="string"&&(B=`${B}-${o}`);const q=v.useMemo(()=>({onToggle:()=>w?.(!S),bsPrefix:k,expanded:!!S,expand:o}),[k,S,o,w]);return u.jsx(qi.Provider,{value:q,children:u.jsx(Po.Provider,{value:$,children:u.jsx(m,{ref:l,...A,className:it(g,k,o&&B,f&&`${k}-${f}`,d&&`bg-${d}`,y&&`sticky-${y}`,h&&`fixed-${h}`)})})})});w2.displayName="Navbar";const s7=Object.assign(w2,{Brand:d2,Collapse:p2,Offcanvas:b2,Text:S2,Toggle:h2});function c7(a){return Ee({attr:{viewBox:"0 0 15 15",fill:"none"},child:[{tag:"path",attr:{fillRule:"evenodd",clipRule:"evenodd",d:"M1.5 3C1.22386 3 1 3.22386 1 3.5C1 3.77614 1.22386 4 1.5 4H13.5C13.7761 4 14 3.77614 14 3.5C14 3.22386 13.7761 3 13.5 3H1.5ZM1 7.5C1 7.22386 1.22386 7 1.5 7H13.5C13.7761 7 14 7.22386 14 7.5C14 7.77614 13.7761 8 13.5 8H1.5C1.22386 8 1 7.77614 1 7.5ZM1 11.5C1 11.2239 1.22386 11 1.5 11H13.5C13.7761 11 14 11.2239 14 11.5C14 11.7761 13.7761 12 13.5 12H1.5C1.22386 12 1 11.7761 1 11.5Z",fill:"currentColor"},child:[]}]})(a)}function j2(a){return Ee({attr:{viewBox:"0 0 256 256",fill:"currentColor"},child:[{tag:"path",attr:{d:"M236,172a40,40,0,0,1-80,0V76H100V200a12,12,0,0,1-24,0V76H72a36,36,0,0,0-36,36,12,12,0,0,1-24,0A60.07,60.07,0,0,1,72,52H224a12,12,0,0,1,0,24H180v96a16,16,0,0,0,32,0,12,12,0,0,1,24,0Z"},child:[]}]})(a)}const u7=b(s7)`
...
`,y7=b.div`
  ...
  line-height: 1;
`;function v7(){const a=()=>{console.log("Toggled theme")};return u.jsx("div",{className:"topbar-wrapper",children:u.jsx(u7,{className:"shadow-sm d-lg-none",children:u.jsx(Pg,{fluid:!0,className:"px-3",children:u.jsxs(f7,{children:[u.jsx(d7,{children:u.jsxs(g7,{to:"/instalearn/","aria-label":"Go to home",children:[u.jsx("div",{children:u.jsx(x7,{"aria-hidden":"true"})}),u.jsx(y7,{children:"Learn"})]})}),u.jsx(p7,{}),u.jsx(h7,{children:u.jsx(m7,{type:"button",onClick:a,"aria-label":"Toggle",children:u.jsx(c7,{size:20})})})]})})})})}const b7=$t`
...
`,T7=$n`
  ...
  &::before {
    ...
    animation: ${b7} 4s linear infinite;
...
`;function R7(){const{pathname:a}=Ln(),l=[{to:"/instalearn/",icon:u.jsx(Ag,{}),label:"Home"},{to:"/instalearn/teacher",icon:u.jsx(cs,{}),label:"Teacher"},{to:"/instalearn/library",icon:u.jsx(Rg,{}),label:"Library",hasNotification:!0},{to:"/instalearn/notifications",icon:u.jsx(D5,{}),label:"Notifications"},{to:"/instalearn/profile",icon:u.jsx(Mg,{}),label:"Profile"}];return u.jsxs(S7,{children:[u.jsxs(w7,{to:"/instalearn/",children:[u.jsx("div",{children:u.jsx(j7,{"aria-hidden":"true"})}),u.jsx(E7,{children:"Learn"})]}),u.jsxs(C7,{children:[l.slice(0,-1).map(s=>u.jsxs(of,{to:s.to,$active:a===s.to,children:[u.jsx(sf,{children:s.icon}),u.jsx(cf,{children:s.label}),s.hasNotification]},s.to)),u.jsxs(of,{to:l[l.length-1].to,$active:a===l[l.length-1].to,children:[u.jsx(sf,{children:l[l.length-1].icon}),u.jsx(cf,{children:l[l.length-1].label})]})]}),u.jsx(z7,{children:u.jsxs(of,{to:"/instalearn/more",$active:a==="/instalearn/more",children:[u.jsx(sf,{children:u.jsx($5,{})}),u.jsx(cf,{children:"More"})]})})]})}const A7=b.div`
  width: 100%;
  height: 100%;
  padding: 24px 16px;
  overflow-y: auto;
...
`;const Z7=({sidebarWidth:a=360})=>{const l={username:"demo_user",name:"Demo User",initials:"DU"},s=[{icon:N1,gradient:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)",title:"New Feature: Dark Mode",description:"Enable dark mode for a better night-time experience.",badge:"New",badgeBg:"linear-gradient(135deg, #667eea, #764ba2)"},{icon:B5,gradient:"linear-gradient(135deg, #f093fb 0%, #f5576c 100%)",title:"Product Tip: Quick Search",description:"Use the search bar to find items faster.",badge:"Tip",badgeBg:"linear-gradient(135deg, #f093fb, #f5576c)"},{icon:N5,gradient:"linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)",title:"Update: Version 2.0",description:"Check out the latest improvements and bug fixes.",badge:"Update",badgeBg:"linear-gradient(135deg, #4facfe, #00f2fe)"}];return u.jsxs(A7,{children:[u.jsx(M7,{children:u.jsxs(E2,{$width:a,children:[u.jsxs(O7,{children:[u.jsx(k7,{$width:a,children:l.initials}),u.jsx(N7,{$width:a})]}),u.jsxs(_7,{$width:a,children:[u.jsx(D7,{$width:a,children:l.username}),u.jsx($7,{$width:a,children:l.name})]})]})}),u.jsxs(B7,{children:[u.jsxs(L7,{$width:a,$iconColor:"#667eea",children:[u.jsx(N1,{}),u.jsx("span",{children:"Highlights"})]}),u.jsx(U7,{$width:a,children:"See All"})]}),u.jsx(H7,{$width:a,children:s.map((o,f)=>{const d=o.icon;return u.jsxs(C2,{$width:a,$glowColor:o.gradient,children:[u.jsx(Q7,{$width:a,$bg:o.badgeBg,children:o.badge}),u.jsxs(q7,{$width:a,children:[u.jsx(Y7,{$width:a,$gradient:o.gradient,children:u.jsx(d,{})}),u.jsxs(G7,{children:[u.jsx(X7,{$width:a,children:o.title}),u.jsx(V7,{$width:a,children:o.description})]})]})]},f)})})]})};function K7(){const{pathname:a}=Ln(),l=[["/instalearn/",u.jsx(Ag,{})],["/instalearn/teacher",u.jsx(cs,{})],["/instalearn/library",u.jsx(Rg,{})],["/instalearn/profile",u.jsx(Mg,{})]];return u.jsxs(u.Fragment,{children:[u.jsx("style",{children:`
        @keyframes shine {
          0% { background-position: 0% 50%; }
          50% { background-position: 100% 50%; }
          100% { background-position: 0% 50%; }
      ...
      `}),u.jsx(Pw,{className:"bottom-nav fixed-bottom d-flex justify-content-around py-2 d-lg-none",children:l.map(([s,o])=>u.jsx(Ui,{to:s,className:`nav-link fs-4 text-white ${a===s?"active":""}`,children:o},s))})]})}const uf="studentProfile",mt=Hg,J7=b.div`
  max-width: 1120px;
  margin: 0 auto;
  background: #fff;
  min-height: 100vh;
...
`,P7=b.div` position: relative; `,e9=b.img`
...
`,s9=b.div`
  ...
  @media (min-width: 768px) { font-size: 1rem; }
`,c9=b.div` display: flex; gap: 0.5rem; margin-bottom: 1.5rem; `,u9=b.button`
...
`,p9=b.div` position: relative; display: inline-block; `,h9=b.div`
...
`,C9=b.div` display: flex; border-top: 1px solid #e5e7eb; `,Rm=b.button`
...
`,km=b.h3` margin: 0; font-size: 1rem; font-weight: 700; color: #111827; `,Nm=b.button` border: 1px solid #e5e7eb; background: #fff; border-radius: 8px; padding: 0.25rem; `,M9=b.div`
...
`,N9=b.div` padding: 1rem 1.25rem; display: grid; gap: 0.75rem; `,ff=b.div` display: grid; gap: 0.25rem; `,df=b.label` font-size: 0.85rem; color: #374151; `,pf=b.input`
...
`,_9=b.div` display:flex; justify-content:flex-end; gap:0.5rem; padding:0.75rem 1.25rem 1rem; `;function D9(){v.useEffect(()=>{window.scrollTo({top:0,left:0,behavior:"auto"})},[]);const a=ts(),[l,s]=v.useState(!1),[o,f]=v.useState("basic"),[d,h]=v.useState(!1),[y,g]=v.useState(!1),[m,S]=v.useState(!1),[w,T]=v.useState(!1),[z,A]=v.useState({name:"",email:"",avatar:""}),k=3,$=3,B=`joined:${mt?.id||mt?.name}`;v.useEffect(()=>{const W=localStorage.getItem(B)==="true";g(W);const ce=localStorage.getItem(uf);if(ce){const de=JSON.parse(ce);A({name:de.name||"",email:de.email||"",avatar:de.avatar||""})}},[]),v.useEffect(()=>{localStorage.setItem(B,y?"true":"false")},[y,B]),v.useEffect(()=>{if(!m)return;const W=ce=>{const de=ce.target;de.closest&&(de.closest('[aria-haspopup="menu"]')||de.closest('[role="menu"]'))||S(!1)};return document.addEventListener("click",W),()=>document.removeEventListener("click",W)},[m]);const q=W=>{if(!y&&W>=k){s(!0);return}W===0&&a("/instalearn/library")},Y=()=>{y||s(!0)},Z=async()=>{h(!0),await new Promise(W=>setTimeout(W,1200)),h(!1),s(!1),T(!0)},J=()=>{const W={name:z.name?.trim(),email:z.email?.trim(),avatar:z.avatar?.trim(),createdAt:new Date().toISOString(),plan:o,isPro:!0};if(!W.name||!W.email){alert("Please fill Name and Email to continue.");return}localStorage.setItem(uf,JSON.stringify(W)),g(!0),T(!1)},L=()=>{localStorage.removeItem(B),localStorage.removeItem(uf),g(!1),S(!1)},V=[{key:"basic",name:"Basic",price:"₹0",desc:"Demo access: 3 lessons"},{key:"pro",name:"Pro",price:"₹99",desc:"Monthly: full library"},{key:"team",name:"Team",price:"₹1,99",desc:"Up to 10 students"}],Q=y;return u.jsxs(J7,{children:[u.jsxs(F7,{children:[u.jsxs(W7,{children:[u.jsxs(I7,{children:[u.jsxs(P7,{children:[u.jsx(e9,{src:mt.avatar,alt:mt.name}),!y&&u.jsxs(t9,{"aria-hidden":"true",title:"Pro library locked",children:[u.jsx(Co,{size:12})," LOCKED"]})]}),u.jsxs(n9,{children:[u.jsxs(Ri,{children:[mt.concepts," ",u.jsx("span",{children:"concepts"})]}),u.jsxs(Ri,{children:[mt.students," ",u.jsx("span",{children:"students"})]}),u.jsxs(Ri,{children:[mt.learns," ",u.jsx("span",{children:"learns"})]})]})]}),u.jsxs(i9,{children:[u.jsxs(a9,{children:[u.jsxs(Ri,{children:[mt.concepts," ",u.jsx("span",{children:"concepts"})]}),u.jsxs(Ri,{children:[mt.students," ",u.jsx("span",{children:"students"})]}),u.jsxs(Ri,{children:[mt.learns," ",u.jsx("span",{children:"learns"})]})]}),u.jsx(l9,{children:mt.name}),u.jsx(r9,{children:mt.subject}),u.jsx(o9,{children:mt.bio}),u.jsxs(s9,{children:["🎓 ",mt.experience," years experience"]}),u.jsxs(c9,{children:[u.jsx(u9,{onClick:()=>a("/user/profile"),children:"Follow"}),u.jsx(f9,{onClick:Y,disabled:d,"data-joined":y,"aria-pressed":y,"aria-label":y?"Joined":"Join",title:y?"You're in!":"Join this teacher",children:y?u.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:8},children:[u.jsx(Bg,{size:18})," Joined"]}):d?"Processing…":"Join"}),u.jsxs(p9,{children:[u.jsx(d9,{"aria-haspopup":"menu","aria-expanded":m,"aria-label":"More options",onClick:()=>S(W=>!W),title:"More options",children:"▼"}),m&&u.jsxs(h9,{role:"menu",children:[y&&u.jsxs(zm,{role:"menuitem","data-danger":"true",onClick:L,title:"Cancel your membership",children:[u.jsx(qu,{size:16})," Cancel membership"]}),u.jsx(zm,{role:"menuitem",onClick:()=>S(!1),children:"Close"})]})]})]}),u.jsxs(m9,{hidden:Q,role:"note","aria-live":"polite",children:[u.jsxs(g9,{children:[u.jsx(Co,{size:18})," Pro library locked — get full access to all concepts & posts."]}),u.jsx(x9,{onClick:()=>s(!0),"aria-label":"Unlock full library",children:"Unlock"})]})]})]}),u.jsx(y9,{children:u.jsx(v9,{children:mt.bookList.map((W,ce)=>{const de=!y&&ce>=k;return u.jsxs(b9,{onClick:()=>q(ce),"aria-disabled":de,title:de?"Join to unlock":`Open ${W.title}`,children:[u.jsxs(w9,{$locked:de,children:[u.jsx(j9,{children:u.jsx(Wo,{size:24})}),!y&&de&&u.jsxs(S9,{"aria-hidden":"true",children:[u.jsx(Co,{size:14,style:{marginRight:6}})," Locked"]})]}),u.jsx(E9,{children:W.title})]},ce)})})})]}),u.jsxs(C9,{children:[u.jsx(Rm,{$active:!0,children:u.jsx(x6,{size:20})}),u.jsx(Rm,{children:u.jsx(i6,{size:20})})]}),u.jsx(T9,{"aria-label":"Teacher posts",children:Array(9).fill(null).map((W,ce)=>{const de=!y&&ce>=$;return u.jsxs(z9,{$locked:de,"aria-hidden":!1,children:[u.jsx(Wo,{size:24}),de&&u.jsxs(R9,{children:[u.jsx(Co,{size:16,style:{marginRight:6}})," Join to view"]})]},ce)})}),u.jsx(A9,{hidden:y,onClick:()=>s(!0),"aria-label":"Unlock all posts",children:"Unlock entire library"}),l&&u.jsx(Am,{role:"dialog","aria-modal":"true","aria-labelledby":"pricing-title",children:u.jsxs(Mm,{children:[u.jsxs(Om,{children:[u.jsx(km,{id:"pricing-title",children:"Choose your plan"}),u.jsx(Nm,{onClick:()=>s(!1),"aria-label":"Close pricing",children:u.jsx(qu,{size:18})})]}),u.jsx(M9,{children:V.map(W=>u.jsxs(O9,{onClick:()=>f(W.key),$active:o===W.key,"aria-pressed":o===W.key,children:[u.jsx("h4",{children:W.name}),u.jsx("strong",{children:W.price}),u.jsx("p",{children:W.desc})]},W.key))}),u.jsxs(k9,{children:[u.jsx(Dm,{onClick:()=>s(!1),children:"Not now"}),u.jsx(_m,{onClick:Z,disabled:d,children:d?"Processing payment…":"Demo Pay"})]})]})}),w&&u.jsx(Am,{role:"dialog","aria-modal":"true","aria-labelledby":"profile-form-title",children:u.jsxs(Mm,{children:[u.jsxs(Om,{children:[u.jsx(km,{id:"profile-form-title",children:"Create your student profile"}),u.jsx(Nm,{onClick:()=>T(!1),"aria-label":"Close profile form",children:u.jsx(qu,{size:18})})]}),u.jsxs(N9,{children:[u.jsxs(ff,{children:[u.jsx(df,{htmlFor:"pf-name",children:"Full Name"}),u.jsx(pf,{id:"pf-name",value:z.name,onChange:W=>A(ce=>({...ce,name:W.target.value})),placeholder:"e.g., Priya Sharma"})]}),u.jsxs(ff,{children:[u.jsx(df,{htmlFor:"pf-email",children:"Email"}),u.jsx(pf,{id:"pf-email",type:"email",value:z.email,onChange:W=>A(ce=>({...ce,email:W.target.value})),placeholder:"you@example.com"})]}),u.jsxs(ff,{children:[u.jsx(df,{htmlFor:"pf-avatar",children:"Avatar initials (optional)"}),u.jsx(pf,{id:"pf-avatar",value:z.avatar,onChange:W=>A(ce=>({...ce,avatar:W.target.value})),placeholder:"PS"})]})]}),u.jsxs(_9,{children:[u.jsx(Dm,{onClick:()=>T(!1),children:"Cancel"}),u.jsx(_m,{onClick:J,children:"Save & Finish"})]})]})})]})}const $9=b.div`
  display: flex;
  min-height: 100vh;
...
`;function X9(){const[a,l]=v.useState(360),[s,o]=v.useState(!1),f=v.useRef(null),d=350,h=600,y=g=>{g.preventDefault(),o(!0),f.current={startX:g.clientX,startWidth:a}};return v.useEffect(()=>{const g=(w,T,z)=>Math.min(Math.max(w,T),z),m=w=>{if(!s||!f.current)return;const{startX:T,startWidth:z}=f.current,A=T-w.clientX,k=g(z+A,d,h);l(k)},S=()=>{s&&(o(!1),f.current=null)};return s&&(document.addEventListener("mousemove",m),document.addEventListener("mouseup",S),document.body.style.cursor="ew-resize",document.body.style.userSelect="none"),()=>{document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",S),document.body.style.cursor="",document.body.style.userSelect=""}},[s]),u.jsxs($9,{children:[u.jsx(B9,{children:u.jsx(R7,{})}),u.jsxs(L9,{children:[u.jsxs(U9,{$sidebarWidth:a,$isResizing:s,children:[u.jsx(q9,{children:u.jsx(v7,{})}),u.jsxs(Zv,{children:[u.jsx(_a,{path:"/instalearn",element:u.jsx(E8,{})}),u.jsx(_a,{path:"/instalearn/teacher",element:u.jsx(D9,{})}),u.jsx(_a,{path:"/instalearn/library",element:u.jsx(Q4,{})}),u.jsx(_a,{path:"/instalearn/notifications",element:u.jsx(cm,{})}),u.jsx(_a,{path:"/instalearn/more",element:u.jsx(cm,{})}),u.jsx(_a,{path:"/instalearn/profile",element:u.jsx(rS,{})})]})]}),u.jsxs(H9,{$width:a,$isResizing:s,children:[u.jsx(Y9,{className:s?"active":"",onMouseDown:y,"aria-label":"Resize sidebar"}),u.jsx(Z7,{})]})]}),u.jsx(G9,{children:u.jsx(K7,{})})]})}av.createRoot(document.getElementById("root")).render(u.jsx(gb,{children:u.jsx(X9,{})}));
